...
public class WarnaTableKasirRalan extends DefaultTableCellRenderer {
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column){
        ...
        if(!table.getValueAt(row,20).toString().equals("0") && !table.getValueAt(row,20).toString().equals("00:00:00")){
            component.setBackground(new Color(174,105,68));
        ...
        if(!table.getValueAt(row,21).toString().isEmpty() && column >= 11){
            component.setBackground(new Color(190, 235, 235));
            component.setForeground(new Color(50,50,50));
        }
        return component;
    }
