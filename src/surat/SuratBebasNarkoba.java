...
public final class SuratBebasNarkoba extends javax.swing.JDialog {
    ...
    private DlgJnsPerawatanLab laborat=new DlgJnsPerawatanLab(null,false);
    private int i=0;
    private String tgl,finger="",no_ijn_praktek="";
    ...
    public SuratBebasNarkoba(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "KD Lab","Pemeriksaan Lab","Petugas Lab"
        ...
        Keperluan.setDocument(new batasInput(200).getKata(Keperluan));         
        ...
        laborat.addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {}
            @Override
            public void windowClosing(WindowEvent e) {}
            @Override
            public void windowClosed(WindowEvent e) {
                if(laborat.getTable().getSelectedRow()!= -1){
                    KdLab.setText(laborat.getTable().getValueAt(laborat.getTable().getSelectedRow(),1).toString());
                    TLab.setText(laborat.getTable().getValueAt(laborat.getTable().getSelectedRow(),2).toString());
                    
                    if(Sequel.cariIsi("select no_rawat from periksa_lab where no_rawat='"+TNoRw.getText()+"' and kd_jenis_prw=?", KdLab.getText()).equals("")){
                        JOptionPane.showMessageDialog(null, "Tidak ada pemeriksaan narkoba "+TLab.getText()+", Silahkan pilih ulang!");
                        KdLab.setText("");
                        TLab.setText("");
                    }
                }   
    ...
    private void initComponents() {
        ...
        MnCetakSuratSKBN.setText("Cetak SKBN MCU");
        ...
        MnCetakSuratSKBN1.setEnabled(false);
        ...
        MnCetakSuratSKBN2.setEnabled(false);
        ...
        MnCetakSuratSKBN3.setEnabled(false);
        ...
        TanggalSurat.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "12-06-2025" }));
        ...
        jLabel23.setBounds(0, 100, 70, 23);

        KdLab.setEditable(false);
        KdLab.setHighlighter(null);
        KdLab.setName("KdLab"); // NOI18N
        FormInput.add(KdLab);
        KdLab.setBounds(74, 100, 99, 23);

        TLab.setEditable(false);
        TLab.setHighlighter(null);
        ...
        FormInput.add(btnLab);
        btnLab.setBounds(382, 100, 28, 23);
        ...
        if(NoSurat.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("surat_skbn","?,?,?,?,?,?,?","No.Surat SKBN",7,new String[]{
                ...
                tabMode.addRow(new String[]{
                    ...
                    KdDok.getText(),TDokter.getText(),Keperluan.getText(),KdLab.getText()
                });
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(NoSurat.getText().trim().equals("")){
            ...
            if(tbObat.getSelectedRow()!= -1){
                if(Sequel.mengedittf("surat_skbn","no_surat=?","no_surat=?,no_rawat=?,tanggalsurat=?,kategori=?,kd_dokter=?,keperluan=?,kd_jenis_prw=?",8,new String[]{
                    NoSurat.getText(),TNoRw.getText(),Valid.SetTgl(TanggalSurat.getSelectedItem()+""),Kategori.getSelectedItem().toString(),KdDok.getText(),Keperluan.getText(),KdLab.getText(),
                    ...
                    tbObat.setValueAt(KdLab.getText(),tbObat.getSelectedRow(),9);
                    tbObat.setValueAt(TLab.getText(),tbObat.getSelectedRow(),10);
                    emptTeks();
                }
            }
        }
    ...
    private void MnCetakSuratSKBNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratSKBNActionPerformed
       if(TPasien.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                ...
                no_ijn_praktek=Sequel.cariIsi("select no_ijn_praktek from dokter where kd_dokter=?",KdDok.getText());
                param.put("finger","Dikeluarkan di "+akses.getnamars()+", Kabupaten/Kota "+akses.getkabupatenrs()+"\nDitandatangani secara elektronik oleh "+TDokter.getText()+"\nID "+(finger.equals("")?KdDok.getText()+" ("+no_ijn_praktek+") ":finger)+"\n"+TanggalSurat.getSelectedItem());
                param.put("logo",Sequel.cariGambar("select setting.logo from setting"));
                param.put("bgimage", System.getProperty("user.dir") + File.separator + "report" + File.separator + "logo.png");
                param.put("amphetamine", Sequel.cariIsi("SELECT detail_periksa_lab.nilai FROM detail_periksa_lab INNER JOIN template_laboratorium ON template_laboratorium.kd_jenis_prw = detail_periksa_lab.kd_jenis_prw "+
                        "AND template_laboratorium.id_template = detail_periksa_lab.id_template WHERE detail_periksa_lab.no_rawat = '"+TNoRw.getText()+"' "+
                        "AND detail_periksa_lab.kd_jenis_prw = '"+KdLab.getText()+"' AND template_laboratorium.Pemeriksaan LIKE 'amphetamine'"));
                param.put("benzodiazepine", Sequel.cariIsi("SELECT detail_periksa_lab.nilai FROM detail_periksa_lab INNER JOIN template_laboratorium ON template_laboratorium.kd_jenis_prw = detail_periksa_lab.kd_jenis_prw "+
                        "AND template_laboratorium.id_template = detail_periksa_lab.id_template WHERE detail_periksa_lab.no_rawat = '"+TNoRw.getText()+"' "+
                        "AND detail_periksa_lab.kd_jenis_prw = '"+KdLab.getText()+"' AND template_laboratorium.Pemeriksaan LIKE 'benzodiazepine'"));
                param.put("morphine", Sequel.cariIsi("SELECT detail_periksa_lab.nilai FROM detail_periksa_lab INNER JOIN template_laboratorium ON template_laboratorium.kd_jenis_prw = detail_periksa_lab.kd_jenis_prw "+
                        "AND template_laboratorium.id_template = detail_periksa_lab.id_template WHERE detail_periksa_lab.no_rawat = '"+TNoRw.getText()+"' "+
                        "AND detail_periksa_lab.kd_jenis_prw = '"+KdLab.getText()+"' AND template_laboratorium.Pemeriksaan LIKE 'morphine'"));
                param.put("cocaine", Sequel.cariIsi("SELECT detail_periksa_lab.nilai FROM detail_periksa_lab INNER JOIN template_laboratorium ON template_laboratorium.kd_jenis_prw = detail_periksa_lab.kd_jenis_prw "+
                        "AND template_laboratorium.id_template = detail_periksa_lab.id_template WHERE detail_periksa_lab.no_rawat = '"+TNoRw.getText()+"' "+
                        "AND detail_periksa_lab.kd_jenis_prw = '"+KdLab.getText()+"' AND template_laboratorium.Pemeriksaan LIKE 'cocaine'"));
                param.put("methamphetamine", Sequel.cariIsi("SELECT detail_periksa_lab.nilai FROM detail_periksa_lab INNER JOIN template_laboratorium ON template_laboratorium.kd_jenis_prw = detail_periksa_lab.kd_jenis_prw "+
                        "AND template_laboratorium.id_template = detail_periksa_lab.id_template WHERE detail_periksa_lab.no_rawat = '"+TNoRw.getText()+"' "+
                        "AND detail_periksa_lab.kd_jenis_prw = '"+KdLab.getText()+"' AND template_laboratorium.Pemeriksaan LIKE 'methamphetamine'"));
                param.put("thc", Sequel.cariIsi("SELECT detail_periksa_lab.nilai FROM detail_periksa_lab INNER JOIN template_laboratorium ON template_laboratorium.kd_jenis_prw = detail_periksa_lab.kd_jenis_prw "+
                        "AND template_laboratorium.id_template = detail_periksa_lab.id_template WHERE detail_periksa_lab.no_rawat = '"+TNoRw.getText()+"' "+
                        "AND detail_periksa_lab.kd_jenis_prw = '"+KdLab.getText()+"' AND template_laboratorium.Pemeriksaan LIKE 'thc'"));
                Valid.MyReportqry("rptBebasNarkoba1.jasper","report","::[ Surat SKBN MCU ]::",
                              " select surat_skbn.tanggalsurat,surat_skbn.no_rawat,pasien.tgl_lahir,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur)as umur," +
                              " pasien.tmp_lahir, pasien.nm_pasien, pasien.jk,pasien.alamat, pasien.no_ktp, surat_skbn.kd_dokter ,dokter.nm_dokter, dokter.no_ijn_praktek," +
                              " periksa_lab.tgl_periksa, periksa_lab.jam, pegawai.nama, surat_skbn.keperluan"+
                              " from surat_skbn inner join reg_periksa on surat_skbn.no_rawat=reg_periksa.no_rawat" +
                              " inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis" +
                              " inner join dokter on surat_skbn.kd_dokter=dokter.kd_dokter" +
                              " inner join jns_perawatan_lab on surat_skbn.kd_jenis_prw=jns_perawatan_lab.kd_jenis_prw " +
                              " inner join periksa_lab on surat_skbn.no_rawat=periksa_lab.no_rawat " +
                              " inner join pegawai on periksa_lab.nip=pegawai.nik " +
                              " where surat_skbn.no_rawat='"+TNoRw.getText()+"' and surat_skbn.kd_jenis_prw='"+KdLab.getText()+"' ",param);
                this.setCursor(Cursor.getDefaultCursor());
       }
    ...
    private void KeperluanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KeperluanKeyPressed
         Valid.pindah(evt,btnDokter,btnLab);
    ...
    private void btnLabActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLabActionPerformed
        laborat.isCek();
        laborat.setCariPerawatan("narkoba");
        laborat.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
        laborat.setLocationRelativeTo(internalFrame1);
        laborat.setVisible(true);
    ...
    */
        ...
        try{
            ...
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                     "select surat_skbn.no_surat,surat_skbn.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien, "+
                     "surat_skbn.tanggalsurat,surat_skbn.kategori,surat_skbn.kd_dokter,dokter.nm_dokter,surat_skbn.keperluan, "+
                     "surat_skbn.kd_jenis_prw, jns_perawatan_lab.nm_perawatan, pegawai.nama "+                   
                     "from surat_skbn inner join reg_periksa on surat_skbn.no_rawat=reg_periksa.no_rawat "+
                     "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                     "inner join dokter on surat_skbn.kd_dokter=dokter.kd_dokter "+
                     "inner join jns_perawatan_lab on surat_skbn.kd_jenis_prw=jns_perawatan_lab.kd_jenis_prw "+
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            KdLab.setText(tbObat.getValueAt(tbObat.getSelectedRow(),9).toString());
            TLab.setText(tbObat.getValueAt(tbObat.getSelectedRow(),10).toString());
        }
    }
