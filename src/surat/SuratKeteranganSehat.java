...
public final class SuratKeteranganSehat extends javax.swing.JDialog {
    ...
    private int i=0;
    private String tgl,finger="",kodedokter="",namadokter="",noijinpraktek="";
    ...
    public SuratKeteranganSehat(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Tensi","Suhu","Keperluan","Kesimpulan","Atas Permintaan"
        }){
        ...
        AtasPermintaan.setDocument(new batasInput(200).getKata(AtasPermintaan));
    ...
    private void initComponents() {
        ...
        AtasPermintaan = new widget.TextBox();
        ...
        MnCetakSuratSehat.setText("-");
        MnCetakSuratSehat.setActionCommand("-");
        ...
        MnCetakSuratSehat1.setText("Cetak Surat Sehat");
        ...
        jLabel3.setText("Atas Permintaan :");
        jLabel3.setName("jLabel3"); // NOI18N
        FormInput.add(jLabel3);
        jLabel3.setBounds(235, 70, 120, 23);
        ...
        FormInput.add(Bb);
        Bb.setBounds(265, 40, 50, 23);

        jLabel14.setText("BB :");
        jLabel14.setName("jLabel14"); // NOI18N
        FormInput.add(jLabel14);
        jLabel14.setBounds(240, 40, 20, 23);

        jLabel15.setText("TB :");
        jLabel15.setName("jLabel15"); // NOI18N
        FormInput.add(jLabel15);
        jLabel15.setBounds(348, 40, 20, 23);
        ...
        jLabel17.setBounds(430, 40, 20, 23);

        jLabel18.setText("Tensi :");
        jLabel18.setName("jLabel18"); // NOI18N
        FormInput.add(jLabel18);
        jLabel18.setBounds(453, 40, 40, 23);
        ...
        FormInput.add(Tensi);
        Tensi.setBounds(495, 40, 70, 23);

        jLabel20.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel20.setText("mmHg");
        jLabel20.setName("jLabel20"); // NOI18N
        FormInput.add(jLabel20);
        jLabel20.setBounds(570, 40, 40, 23);

        jLabel22.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel22.setText("°C");
        jLabel22.setName("jLabel22"); // NOI18N
        FormInput.add(jLabel22);
        jLabel22.setBounds(705, 40, 12, 23);
        ...
        FormInput.add(Suhu);
        Suhu.setBounds(653, 40, 50, 23);

        jLabel23.setText("Suhu :");
        jLabel23.setName("jLabel23"); // NOI18N
        FormInput.add(jLabel23);
        jLabel23.setBounds(610, 40, 40, 23);
        ...
        TanggalSurat.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "09-06-2025" }));
        ...
        jLabel8.setBounds(0, 70, 75, 23);

        AtasPermintaan.setName("AtasPermintaan"); // NOI18N
        AtasPermintaan.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                AtasPermintaanKeyPressed(evt);
            }
        });
        FormInput.add(AtasPermintaan);
        AtasPermintaan.setBounds(360, 70, 160, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(NoSurat.getText().trim().equals("")){
        ...
        }else if(AtasPermintaan.getText().trim().equals("")){
            Valid.textKosong(AtasPermintaan,"Atas Permintaan");
            ...
            if(Sequel.menyimpantf("surat_keterangan_sehat","?,?,?,?,?,?,?,?,?,?","No.Surat",10,new String[]{
                    ...
                    Keperluan.getText().trim(),CmbKesimpulan.getSelectedItem()+"",AtasPermintaan.getText().trim()
                })==true){
                tabMode.addRow(new String[]{
                    NoSurat.getText(),TNoRw.getText(),TNoRM.getText(),TPasien.getText(),Valid.SetTgl(TanggalSurat.getSelectedItem()+""),Bb.getText(),Tb.getText(),Tensi.getText(),Suhu.getText(),Keperluan.getText().trim(),CmbKesimpulan.getSelectedItem().toString(),AtasPermintaan.getText().trim()
                });
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(NoSurat.getText().trim().equals("")){
            ...
            if(tbObat.getSelectedRow()!= -1){
                if(Sequel.mengedittf("surat_keterangan_sehat","no_surat=?","no_surat=?,no_rawat=?,tanggalsurat=?,berat=?,tinggi=?,tensi=?,suhu=?,ataspermintaan=?,keperluan=?,kesimpulan=?",11,new String[]{
                    NoSurat.getText(),TNoRw.getText(),Valid.SetTgl(TanggalSurat.getSelectedItem()+""),Bb.getText(),Tb.getText(),Tensi.getText(),Suhu.getText(),AtasPermintaan.getText().trim(),
                    ...
                    tbObat.setValueAt(Keperluan.getText(),tbObat.getSelectedRow(),9);
                    tbObat.setValueAt(CmbKesimpulan.getSelectedItem().toString(),tbObat.getSelectedRow(),10);
                    tbObat.setValueAt(AtasPermintaan.getText(),tbObat.getSelectedRow(),11);
                    emptTeks();
                }
            }
        }
    ...
    if(TPasien.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                ...
                kodedokter=Sequel.cariIsi("select reg_periksa.kd_dokter from reg_periksa where reg_periksa.no_rawat=?",TNoRw.getText());
                namadokter=Sequel.cariIsi("select dokter.nm_dokter from dokter where dokter.kd_dokter=?",kodedokter);
                noijinpraktek=Sequel.cariIsi("select dokter.no_ijn_praktek from dokter where dokter.kd_dokter=?",kodedokter);
                finger=Sequel.cariIsi("select sha1(sidikjari.sidikjari) from sidikjari inner join pegawai on pegawai.id=sidikjari.id where pegawai.nik=?",kodedokter);
                param.put("finger","Dikeluarkan di "+akses.getnamars()+", Kabupaten/Kota "+akses.getkabupatenrs()+"\nDitandatangani secara elektronik oleh "+namadokter+"\nID "+(finger.equals("")?kodedokter+" ("+noijinpraktek+") ":finger)+"\n"+Sequel.cariIsi("select DATE_FORMAT(reg_periksa.tgl_registrasi,'%d-%m-%Y') from reg_periksa where reg_periksa.no_rawat=?",TNoRw.getText()));  
                Valid.MyReportqry("rptSuratKeteranganSehat2.jasper","report","::[ Surat Keterangan Sehat ]::",
                              " select surat_keterangan_sehat.no_surat,surat_keterangan_sehat.tanggalsurat,surat_keterangan_sehat.berat,surat_keterangan_sehat.tinggi,surat_keterangan_sehat.tensi,surat_keterangan_sehat.suhu, "+
                              " surat_keterangan_sehat.ataspermintaan,surat_keterangan_sehat.keperluan,surat_keterangan_sehat.kesimpulan,dokter.nm_dokter,dokter.no_ijn_praktek,pasien.jk,DATE_FORMAT(pasien.tgl_lahir,'%d-%m-%Y')as tgl_lahir,reg_periksa.kd_dokter, " +
                              " pasien.nm_pasien,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur)as umur,pasien.alamat,pasien.pekerjaan" +
                              " from surat_keterangan_sehat inner join reg_periksa inner join pasien inner join dokter inner join kelurahan inner join kecamatan inner join kabupaten" +
                              " on reg_periksa.no_rkm_medis=pasien.no_rkm_medis and reg_periksa.kd_dokter=dokter.kd_dokter and pasien.kd_kel=kelurahan.kd_kel and "+
                              " pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kab=kabupaten.kd_kab and reg_periksa.no_rawat=surat_keterangan_sehat.no_rawat "+
                              " where reg_periksa.no_rawat='"+TNoRw.getText()+"' ",param);
    ...
    private void CmbKesimpulanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_CmbKesimpulanKeyPressed
        Valid.pindah(evt,AtasPermintaan,BtnSimpan);
    }//GEN-LAST:event_CmbKesimpulanKeyPressed

    private void AtasPermintaanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_AtasPermintaanKeyPressed
        Valid.pindah(evt,Keperluan,CmbKesimpulan);
    }//GEN-LAST:event_AtasPermintaanKeyPressed
    ...
    */
    ...
    private widget.TextBox AtasPermintaan;
        ...
        try{
            ...
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                     ...
                     "surat_keterangan_sehat.keperluan,surat_keterangan_sehat.kesimpulan,surat_keterangan_sehat.ataspermintaan from surat_keterangan_sehat inner join reg_periksa on surat_keterangan_sehat.no_rawat=reg_periksa.no_rawat "+
                     "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            CmbKesimpulan.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),10).toString());
            AtasPermintaan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),11).toString());
        }
    }
    ...
    private void isForm(){
        ...
        if(!TNoRw.getText().equals("")){
            ...
            //System.out.println("Notif : Berhasil Tarik TTV!");
        }
    }
