...
public final class DlgRl38 extends javax.swing.JDialog {
    ...
    private int ttl_lk=0;
    private int ttl_pr=0;
    ...
    public DlgRl38(java.awt.Frame parent, boolean modal) {
        ...
        Object[] rowRwJlDr={"No.","Jenis Kegiatan","Jml Laki-laki","Jml Perempuan","Jumlah"};
        ...
        try {            
            pstindakan=koneksi.prepareStatement("select jns_perawatan_lab.nm_perawatan,SUM(CASE WHEN pasien.jk = 'L' THEN 1 ELSE 0 END) AS jml_l, SUM(CASE WHEN pasien.jk = 'P' THEN 1 ELSE 0 END) AS jml_p,count(jns_perawatan_lab.nm_perawatan) as jumlah,jns_perawatan_lab.kd_jenis_prw from periksa_lab "+
                    ...
                    "where periksa_lab.tgl_periksa between ? and ? and jns_perawatan_lab.nm_perawatan like ? group by jns_perawatan_lab.kd_jenis_prw order by jns_perawatan_lab.nm_perawatan asc");
            pstindakan2=koneksi.prepareStatement("select template_laboratorium.Pemeriksaan,SUM(CASE WHEN pasien.jk = 'L' THEN 1 ELSE 0 END) AS jml_l, SUM(CASE WHEN pasien.jk = 'P' THEN 1 ELSE 0 END) AS jml_p, " +
                    "count( detail_periksa_lab.no_rawat ) AS jumlah from detail_periksa_lab "+
        ...
        try{   
            ...
            while(rstindakan.next()){
                tabMode.addRow(new Object[]{
                    i,rstindakan.getString("nm_perawatan"),rstindakan.getInt("jml_l"),rstindakan.getInt("jml_p"),rstindakan.getInt("jumlah")
                });
                ...
                pstindakan2.setString(4,rstindakan.getString("kd_jenis_prw"));
                rstindakan2=pstindakan2.executeQuery();
                a=1;
                while(rstindakan2.next()){
                    tabMode.addRow(new Object[]{
                        i+"."+a,rstindakan2.getString("Pemeriksaan"),rstindakan2.getInt("jml_l"),rstindakan2.getInt("jml_p"),rstindakan2.getInt("jumlah")
                    });
                    ttl_lk=ttl_lk+rstindakan2.getInt("jml_l");
                    ttl_pr=ttl_pr+rstindakan2.getInt("jml_p");
                    ttl=ttl+rstindakan2.getInt("jumlah");
                    a++;                    
                }
                ttl_lk=ttl_lk+rstindakan.getInt("jml_l");
                ttl_pr=ttl_pr+rstindakan.getInt("jml_p");
