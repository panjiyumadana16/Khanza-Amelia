...
public final class DlgKunjunganRanap extends javax.swing.JDialog {
    ...
    public DlgKunjunganRanap(java.awt.Frame parent, boolean modal) {
        ...
        setSize(885,674);
        tabMode=new DefaultTableModel(null,new String[]{"No.","Lama","Baru","Nama Pasien","L","P","Alamat","Kode","Diagnosa","Ruang","Stts.Pulang","Tgl.Masuk","Tgl.Pulang","Lama Inap","DPJP"}){
        ...
        tabMode2=new DefaultTableModel(null,new String[]{"No.","Lama","Baru","Nama Pasien","L","P","Alamat","Kode","Diagnosa","Ruang","Stts.Pulang","Tgl.Masuk","Tgl.Pulang","Lama Inap","DPJP"}){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
        ...
        tabMode3=new DefaultTableModel(null,new String[]{"No.","Lama","Baru","Nama Pasien","L","P","Alamat","Kode","Diagnosa","Ruang","Tgl.Masuk","Lama Inap","DPJP"}){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
    ...
    private void initComponents() {
        ...
        tbBangsal3.setComponentPopupMenu(jPopupMenu1);
        ...
        TabRawat.addTab("Sisa / Belum Pulang", Scroll3);
            ...
            if(tabMode.getRowCount()==0){
                ...
                for(int r=0;r<tabMode.getRowCount();r++){ 
                    if(!tbBangsal.getValueAt(r,0).toString().contains(">>")){
                        try {
                            String tgl_keluar = "";
                            Object tgl_klr_obj = tabMode.getValueAt(r, 12);  // Get the value at the specific row and column
                            if (tgl_klr_obj != null) {
                                tgl_keluar = tgl_klr_obj.toString();
                            }
                    ...
                    if(!tbBangsal2.getValueAt(r,0).toString().contains(">>")){
                        try{
                            Sequel.menyimpan("temporary","'"+r+"','"+
                                        ...
                                        tabMode2.getValueAt(r,14).toString()+ "','','','','','','','','','','','','','','','','','','','','','','"+akses.getalamatip()+"'","Rekap Nota Pembayaran");
                        } catch (Exception e) {
                        }  
                    }                    
                }
    ...
    */
    ...
    public void tampil(){        
        try{   
            ...
            ps=koneksi.prepareStatement(
                    ...
                    "kamar_inap.kd_kamar,bangsal.nm_bangsal,concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab)as almt_pj,kamar_inap.stts_pulang,kamar_inap.tgl_masuk,dokter.nm_dokter, kamar_inap.tgl_keluar, kamar_inap.lama as lama_inap "+
                ...
                while(rs.next()){
                    ...
                    if(dokterdpjp.toLowerCase().contains(nmdokter.getText().toLowerCase())){
                        ...
                        tabMode.addRow(new Object[]{
                            i,setlama,setbaru,rs.getString("nm_pasien"),umurlk,umurpr,rs.getString("almt_pj"),kddiagnosa,diagnosa,rs.getString("kd_kamar")+" "+rs.getString("nm_bangsal"),rs.getString("stts_pulang"),rs.getString("tgl_masuk"),rs.getString("tgl_keluar"),rs.getString("lama_inap"),dokterdpjp
                        });                
                        i++;
                    }
    ...
    public void tampil2(){        
        try{   
            ...
            ps=koneksi.prepareStatement(
                    "select reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.no_rkm_medis,pasien.nm_pasien,pasien.alamat,pasien.jk,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur) as umur,pasien.tgl_daftar,reg_periksa.stts_daftar,"+
                    "kamar_inap.kd_kamar,bangsal.nm_bangsal,concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab)as almt_pj,kamar_inap.stts_pulang,kamar_inap.tgl_keluar,kamar_inap.tgl_masuk,kamar_inap.lama as lama_inap,dokter.nm_dokter "+
                    "from reg_periksa inner join pasien inner join kamar_inap inner join kamar inner join bangsal inner join dokter inner join penjab " +
    ...
    public void tampil3(){        
        try{   
            ...
            ps=koneksi.prepareStatement(
                    ...
                    "kamar_inap.kd_kamar=kamar.kd_kamar and kamar.kd_bangsal=bangsal.kd_bangsal and reg_periksa.kd_pj=penjab.kd_pj and pasien.kd_kab=kabupaten.kd_kab "+
                    "and reg_periksa.kd_dokter=dokter.kd_dokter and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kel=kelurahan.kd_kel where "+
                    "reg_periksa.stts_daftar like '%"+status+"%' and kamar_inap.stts_pulang='-' and bangsal.nm_bangsal like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and dokter.nm_dokter like ? or " +                    
                    "reg_periksa.stts_daftar like '%"+status+"%' and kamar_inap.stts_pulang='-' and bangsal.nm_bangsal like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and pasien.alamat like ? or "+
                    "reg_periksa.stts_daftar like '%"+status+"%' and kamar_inap.stts_pulang='-' and bangsal.nm_bangsal like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and pasien.nm_pasien like ? or "+
                    "reg_periksa.stts_daftar like '%"+status+"%' and kamar_inap.stts_pulang='-' and bangsal.nm_bangsal like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and reg_periksa.no_rkm_medis like ? or "+
                    "reg_periksa.stts_daftar like '%"+status+"%' and kamar_inap.stts_pulang='-' and bangsal.nm_bangsal like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and kamar_inap.kd_kamar like ? "+
                    "group by reg_periksa.no_rawat order by kamar_inap.tgl_keluar");
            try {
                ps.setString(1,"%"+nmkamar.getText().trim()+"%");
                ps.setString(2,"%"+nmpenjab.getText().trim()+"%");
                ...
                ps.setString(8,"%"+nmpenjab.getText().trim()+"%");
                ...
                ps.setString(23,"%"+nmkelurahan.getText().trim()+"%");
                ps.setString(24,"%"+TCari.getText().trim()+"%");
                ps.setString(25,"%"+nmkamar.getText().trim()+"%");
                ps.setString(26,"%"+nmpenjab.getText().trim()+"%");
                ps.setString(27,"%"+nmkabupaten.getText().trim()+"%");
                ps.setString(28,"%"+nmkecamatan.getText().trim()+"%");
                ps.setString(29,"%"+nmkelurahan.getText().trim()+"%");
                ...
                while(rs.next()){
                    ...
                    if(dokterdpjp.toLowerCase().contains(nmdokter.getText().toLowerCase())){
                        ...
                        tabMode3.addRow(new Object[]{
                            i,setlama,setbaru,rs.getString("nm_pasien"),umurlk,umurpr,rs.getString("almt_pj"),kddiagnosa,diagnosa,rs.getString("kd_kamar")+" "+rs.getString("nm_bangsal"),rs.getString("tgl_masuk"),rs.getString("lama_inap"),dokterdpjp
                        });                
                        i++;
                    }
                }
