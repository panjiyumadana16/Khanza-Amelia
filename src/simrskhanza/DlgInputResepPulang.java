...
public final class DlgInputResepPulang extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnTelaah.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/file-edit-16x16.png"))); // NOI18N
...
private void JeniskelasKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_JeniskelasKeyPressed
    ...
    private void BtnTelaahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnTelaahActionPerformed
        if(TNoRw.getText().equals("")){
            ...
            telaah.isCek();
            telaah.emptTeks();
            telaah.setNoRm(TNoResep.getText(),TNoRw.getText(),hariini);
    ...
    */
    ...
    public void setNoRm(String norwt,String norm,String pasien,String penyakit, String tanggal, String jam) {    
        ...
        kelas.setText(Sequel.cariIsi(
                ...
                "where reg_periksa.no_rawat=? OR stts_pulang='Rencana Pulang' OR stts_pulang='Kasir' OR stts_pulang='-' order by STR_TO_DATE(concat(kamar_inap.tgl_masuk,' ',jam_masuk),'%Y-%m-%d %H:%i:%s') desc limit 1",norwt));
