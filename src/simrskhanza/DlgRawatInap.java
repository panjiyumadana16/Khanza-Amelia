...
public final class DlgRawatInap extends javax.swing.JDialog {
    ...
    private PreparedStatement ps,ps2,ps3,ps4,ps5,psrekening,ps6,pspemeriksaanls;
    ...
    private void initComponents() {
        ...
        BtnKlasifikasiRobson = new widget.Button();
        ...
        cmbKesadaran.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Compos Mentis", "Apatis", "Delirium", "Somnolen", "Sopor", "Semi Koma", "Koma" }));
        ...
        BtnKlasifikasiRobson.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnKlasifikasiRobson.setText("Klasifikasi Robson");
        BtnKlasifikasiRobson.setFocusPainted(false);
        BtnKlasifikasiRobson.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnKlasifikasiRobson.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnKlasifikasiRobson.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnKlasifikasiRobson.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnKlasifikasiRobson.setName("BtnKlasifikasiRobson"); // NOI18N
        BtnKlasifikasiRobson.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnKlasifikasiRobson.setRoundRect(false);
        BtnKlasifikasiRobson.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnKlasifikasiRobsonActionPerformed(evt);
            }
        });
        FormMenu.add(BtnKlasifikasiRobson);
                        ...
                        if(KdPeg.getText().trim().equals("")||TPegawai.getText().trim().equals("")){
                            ...
                            if(akses.getkode().equals("Admin Utama")){
                                ...
                                if(akses.getkode().equals(KdPeg.getText())){
                                    ...
                                    }else if(TBerat.getText().trim().equals("")){
                                        Valid.textKosong(TBerat,"Berat");
                                    }else if(TTensi.getText().trim().equals("")){
                                        Valid.textKosong(TTensi,"Tensi");
                                    }else if(TRespirasi.getText().trim().equals("")){
                                        Valid.textKosong(TRespirasi,"Respirasi");
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    private void BtnKlasifikasiRobsonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKlasifikasiRobsonActionPerformed
        if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMKlasifikasiRobson form=new RMKlasifikasiRobson(null,false);
            form.isCek();
            form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            form.setLocationRelativeTo(internalFrame1);
            form.setVisible(true);
    ...
    */
    ...
    private widget.Button BtnKlasifikasiRobson;
        ...
        ActionListener taskPerformer = new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(ChkJln.isSelected()==true){
                    nilai_tgl = formattedDate;
                    nilai_jam = now.getHours();
                    nilai_menit = now.getMinutes();
                    nilai_detik = now.getSeconds();
                }else if(ChkJln.isSelected()==false){
                    nilai_tgl = DTPTgl.getSelectedItem().toString();
                ...
                DTPTgl.setSelectedItem(nilai_tgl);
    ...
    private void setTTVTerakhir(String no_rawat){
        if(koneksiDB.TTVOTOMATIS().equals("yes")){
            TSuhu.setText(Sequel.cariIsi("select pemeriksaan_ranap.suhu_tubuh from pemeriksaan_ranap where pemeriksaan_ranap.no_rawat=? order by pemeriksaan_ranap.tgl_perawatan desc ,pemeriksaan_ranap.jam_rawat desc limit 1"
                    , no_rawat)); 
            TTensi.setText(Sequel.cariIsi("select pemeriksaan_ranap.tensi from pemeriksaan_ranap where pemeriksaan_ranap.no_rawat=? order by pemeriksaan_ranap.tgl_perawatan desc ,pemeriksaan_ranap.jam_rawat desc limit 1"
                    , no_rawat)); 
            TNadi.setText(Sequel.cariIsi("select pemeriksaan_ranap.nadi from pemeriksaan_ranap where pemeriksaan_ranap.no_rawat=? order by pemeriksaan_ranap.tgl_perawatan desc ,pemeriksaan_ranap.jam_rawat desc limit 1"
                    , no_rawat)); 
            TRespirasi.setText(Sequel.cariIsi("select pemeriksaan_ranap.respirasi from pemeriksaan_ranap where pemeriksaan_ranap.no_rawat=? order by pemeriksaan_ranap.tgl_perawatan desc ,pemeriksaan_ranap.jam_rawat desc limit 1"
                    , no_rawat)); 
            TTinggi.setText(Sequel.cariIsi("select pemeriksaan_ranap.tinggi from pemeriksaan_ranap where pemeriksaan_ranap.no_rawat=? order by pemeriksaan_ranap.tgl_perawatan desc ,pemeriksaan_ranap.jam_rawat desc limit 1"
                    , no_rawat)); 
            TBerat.setText(Sequel.cariIsi("select pemeriksaan_ranap.berat from pemeriksaan_ranap where pemeriksaan_ranap.no_rawat=? order by pemeriksaan_ranap.tgl_perawatan desc ,pemeriksaan_ranap.jam_rawat desc limit 1"
                    , no_rawat));  
            SpO2.setText(Sequel.cariIsi("select pemeriksaan_ranap.spo2 from pemeriksaan_ranap where pemeriksaan_ranap.no_rawat=? order by pemeriksaan_ranap.tgl_perawatan desc ,pemeriksaan_ranap.jam_rawat desc limit 1"
                    , no_rawat));  
            TGCS.setText(Sequel.cariIsi("select pemeriksaan_ranap.gcs from pemeriksaan_ranap where pemeriksaan_ranap.no_rawat=? order by pemeriksaan_ranap.tgl_perawatan desc ,pemeriksaan_ranap.jam_rawat desc limit 1"
                    , no_rawat)); 
            cmbKesadaran.setSelectedItem(Sequel.cariIsi("select pemeriksaan_ranap.kesadaran from pemeriksaan_ranap where pemeriksaan_ranap.no_rawat=? order by pemeriksaan_ranap.tgl_perawatan desc ,pemeriksaan_ranap.jam_rawat desc limit 1"
                    , no_rawat)); 
            TAlergi.setText(Sequel.cariIsi("select pemeriksaan_ranap.alergi from pemeriksaan_ranap where pemeriksaan_ranap.no_rawat=? order by pemeriksaan_ranap.tgl_perawatan desc ,pemeriksaan_ranap.jam_rawat desc limit 1"
                    , no_rawat));
        }
    }
    ...
    private void getDataPemeriksaan() {
        if(tbPemeriksaan.getSelectedRow()!= -1){
            ...
            if(reply == JOptionPane.YES_OPTION && koneksiDB.TTVOTOMATIS().equals("yes")){
                setTTVTerakhir(TNoRw.getText().trim());
