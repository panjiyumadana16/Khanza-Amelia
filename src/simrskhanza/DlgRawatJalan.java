    ...
    */
    ...
    private void setTTVTerakhir(String no_rawat){
        if(koneksiDB.TTVOTOMATIS().equals("yes")){
            TSuhu.setText(Sequel.cariIsi("select pemeriksaan_ralan.suhu_tubuh from pemeriksaan_ralan where pemeriksaan_ralan.no_rawat=? order by pemeriksaan_ralan.tgl_perawatan desc ,pemeriksaan_ralan.jam_rawat desc limit 1"
                    , no_rawat)); 
            TTensi.setText(Sequel.cariIsi("select pemeriksaan_ralan.tensi from pemeriksaan_ralan where pemeriksaan_ralan.no_rawat=? order by pemeriksaan_ralan.tgl_perawatan desc ,pemeriksaan_ralan.jam_rawat desc limit 1"
                    , no_rawat)); 
            TNadi.setText(Sequel.cariIsi("select pemeriksaan_ralan.nadi from pemeriksaan_ralan where pemeriksaan_ralan.no_rawat=? order by pemeriksaan_ralan.tgl_perawatan desc ,pemeriksaan_ralan.jam_rawat desc limit 1"
                    , no_rawat)); 
            TRespirasi.setText(Sequel.cariIsi("select pemeriksaan_ralan.respirasi from pemeriksaan_ralan where pemeriksaan_ralan.no_rawat=? order by pemeriksaan_ralan.tgl_perawatan desc ,pemeriksaan_ralan.jam_rawat desc limit 1"
                    , no_rawat)); 
            TTinggi.setText(Sequel.cariIsi("select pemeriksaan_ralan.tinggi from pemeriksaan_ralan where pemeriksaan_ralan.no_rawat=? order by pemeriksaan_ralan.tgl_perawatan desc ,pemeriksaan_ralan.jam_rawat desc limit 1"
                    , no_rawat)); 
            TBerat.setText(Sequel.cariIsi("select pemeriksaan_ralan.berat from pemeriksaan_ralan where pemeriksaan_ralan.no_rawat=? order by pemeriksaan_ralan.tgl_perawatan desc ,pemeriksaan_ralan.jam_rawat desc limit 1"
                    , no_rawat));  
            SpO2.setText(Sequel.cariIsi("select pemeriksaan_ralan.spo2 from pemeriksaan_ralan where pemeriksaan_ralan.no_rawat=? order by pemeriksaan_ralan.tgl_perawatan desc ,pemeriksaan_ralan.jam_rawat desc limit 1"
                    , no_rawat));  
            TGCS.setText(Sequel.cariIsi("select pemeriksaan_ralan.gcs from pemeriksaan_ralan where pemeriksaan_ralan.no_rawat=? order by pemeriksaan_ralan.tgl_perawatan desc ,pemeriksaan_ralan.jam_rawat desc limit 1"
                    , no_rawat)); 
            cmbKesadaran.setSelectedItem(Sequel.cariIsi("select pemeriksaan_ralan.kesadaran from pemeriksaan_ralan where pemeriksaan_ralan.no_rawat=? order by pemeriksaan_ralan.tgl_perawatan desc ,pemeriksaan_ralan.jam_rawat desc limit 1"
                    , no_rawat)); 
            TAlergi.setText(Sequel.cariIsi("select pemeriksaan_ralan.alergi from pemeriksaan_ralan where pemeriksaan_ralan.no_rawat=? order by pemeriksaan_ralan.tgl_perawatan desc ,pemeriksaan_ralan.jam_rawat desc limit 1"
                    , no_rawat));
            LingkarPerut.setText(Sequel.cariIsi("select pemeriksaan_ralan.lingkar_perut from pemeriksaan_ralan where pemeriksaan_ralan.no_rawat=? order by pemeriksaan_ralan.tgl_perawatan desc ,pemeriksaan_ralan.jam_rawat desc limit 1"
                    , no_rawat));
        }
    }
