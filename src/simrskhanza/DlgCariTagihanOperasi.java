...
public class DlgCariTagihanOperasi extends javax.swing.JDialog {
    ...
    public DlgCariTagihanOperasi(java.awt.Frame parent, boolean modal) {
        ...
        TCariPerawatan.setDocument(new batasInput((byte)100).getKata(TCari)); 
        ...
        if(koneksiDB.CARICEPAT().equals("aktif")){
            ...
            TCariPerawatan.getDocument().addDocumentListener(new javax.swing.event.DocumentListener(){
                @Override
                public void insertUpdate(DocumentEvent e) {
                    if(TCariPerawatan.getText().length()>2){
                        tampil();
                    }
                }
                @Override
    ...
    private void initComponents() {
        ...
        TCariPerawatan = new widget.TextBox();
        ...
        label12.setBounds(10, 60, 200, 23);

        tgl2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "23-07-2025 11:01:48" }));
        tgl2.setDisplayFormat("dd-MM-yyyy HH:mm:ss");
        tgl2.setName("tgl2"); // NOI18N
        panelGlass7.add(tgl2);
        tgl2.setBounds(30, 80, 150, 23);

        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel6.setText("Diagnosis Pre-operatif :");
        jLabel6.setName("jLabel6"); // NOI18N
        panelGlass7.add(jLabel6);
        jLabel6.setBounds(10, 110, 200, 23);
        ...
        Jaringan.setBounds(30, 230, 256, 23);
        ...
        jLabel9.setBounds(10, 260, 200, 23);
        ...
        label16.setText("Perawatan :");
        label16.setName("label16"); // NOI18N
        label16.setPreferredSize(new java.awt.Dimension(70, 23));
        panelisi1.add(label16);

        TCariPerawatan.setName("TCariPerawatan"); // NOI18N
        TCariPerawatan.setPreferredSize(new java.awt.Dimension(170, 23));
        TCariPerawatan.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TCariPerawatanKeyPressed(evt);
            }
        });
        panelisi1.add(TCariPerawatan);
        ...
        BtnAll.setRequestFocusEnabled(false);
...
private void MnHapusObatOperasiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnHapusObatOperasiActionPerformed
            ...
            if(!tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString().equals("")){
                ...
                try {
                    rs2=koneksi.prepareStatement(
                        ...
                        "laporan_operasi.laporan_operasi, laporan_operasi.tanggal from laporan_operasi where laporan_operasi.no_rawat='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),1)+"' and "+
                    ...
                    if(rs2.next()){
                        ...
                        tglselesai = rs2.getString("selesaioperasi").substring(8,10)+"-"+rs2.getString("selesaioperasi").substring(5,7)+"-"+rs2.getString("selesaioperasi").substring(0, 4)+" "
                                +rs2.getString("selesaioperasi").substring(11,13)+":"+rs2.getString("selesaioperasi").substring(14,16)+":"+rs2.getString("selesaioperasi").substring(17,19);
                        tgl2.setSelectedItem(tglselesai);
                        tglmulai = rs2.getString("tanggal").substring(8,10)+"-"+rs2.getString("tanggal").substring(5,7)+"-"+rs2.getString("tanggal").substring(0, 4)+" "
                                +rs2.getString("tanggal").substring(11,13)+":"+rs2.getString("tanggal").substring(14,16)+":"+rs2.getString("tanggal").substring(17,19);
                        tgl3.setSelectedItem(tglmulai);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(!Laporan.getText().equals("")){
            ...
            Sequel.mengedit("operasi", "no_rawat=? and tgl_operasi=?", "tgl_operasi=?", 3, new String[]{
                Valid.SetTgl(tgl3.getSelectedItem()+"")+" "+tgl3.getSelectedItem().toString().substring(11,19), 
                tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString(), tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString()
            });
    ...
    private void TCariPerawatanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TCariPerawatanKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_ENTER){
            BtnCariActionPerformed(null);
        }else if(evt.getKeyCode()==KeyEvent.VK_PAGE_DOWN){
            BtnCari.requestFocus();
    ...
    }//GEN-LAST:event_TCariPerawatanKeyPressed
    ...
    */
    ...
    private widget.TextBox TCariPerawatan;
    ...
    private void tampil() {
        ...
        if(TCari.getText().trim().equals("")&&kdmem.getText().trim().equals("")&&NoRawat.getText().trim().equals("")&&TCariPerawatan.getText().trim().equals("")){
            ...
            */
            ...
            sql="select operasi.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,operasi.jenis_anasthesi,"+
                ...
                " where "+tanggal+mem+norawat+" and paket_operasi.nm_perawatan like '%"+TCariPerawatan.getText()+"%' and operasi.no_rawat like '%"+TCari.getText()+"%' or "+
                tanggal+mem+norawat+" and paket_operasi.nm_perawatan like '%"+TCariPerawatan.getText()+"%' and reg_periksa.no_rkm_medis like '%"+TCari.getText()+"%' or "+
                tanggal+mem+norawat+" and paket_operasi.nm_perawatan like '%"+TCariPerawatan.getText()+"%' and pasien.nm_pasien like '%"+TCari.getText()+"%' or "+
                tanggal+mem+norawat+" and paket_operasi.nm_perawatan like '%"+TCariPerawatan.getText()+"%' and operasi.jenis_anasthesi like '%"+TCari.getText()+"%'  "+                
                " group by operasi.no_rawat,operasi.tgl_operasi order by operasi.tgl_operasi,operasi.no_rawat ";
        }
        ...
        try{
            ...
            while(rs.next()){
                ...
                rs2=koneksi.prepareStatement(
                        ...
                        "on operasi.kode_paket=paket_operasi.kode_paket where operasi.no_rawat='"+rs.getString("no_rawat")+"' and operasi.tgl_operasi='"+rs.getString("tgl_operasi")+"' and paket_operasi.nm_perawatan like '%"+TCariPerawatan.getText()+"%'").executeQuery();
                no=1;
                while(rs2.next()){
