...
public final class RMPerencanaanPemulangan extends javax.swing.JDialog {
    ...
    public RMPerencanaanPemulangan(java.awt.Frame parent, boolean modal) {
        ...
        AlasanMasuk.setDocument(new batasInput((int)250).getKata(AlasanMasuk));
        KeteranganPengaruhRIKeluarga.setDocument(new batasInput((int)1000).getKata(KeteranganPengaruhRIKeluarga));
        KeteranganPengaruhRIPekerjaanSekolah.setDocument(new batasInput((int)1000).getKata(KeteranganPengaruhRIPekerjaanSekolah));
        KeteranganPengaruhRIKeuangan.setDocument(new batasInput((int)1000).getKata(KeteranganPengaruhRIKeuangan));
        KeteranganAntisipasiMasalah.setDocument(new batasInput((int)1000).getKata(KeteranganAntisipasiMasalah));
        KeteranganBantuanDiperlukan.setDocument(new batasInput((int)1000).getKata(KeteranganBantuanDiperlukan));
        KeteranganYangMembantuKeperluan.setDocument(new batasInput((int)1000).getKata(KeteranganYangMembantuKeperluan));
        KeteranganTinggalSendiri.setDocument(new batasInput((int)1000).getKata(KeteranganTinggalSendiri));
        KeteranganPeralatanMedis.setDocument(new batasInput((int)1000).getKata(KeteranganPeralatanMedis));
        KeteranganAlatBantu.setDocument(new batasInput((int)1000).getKata(KeteranganAlatBantu));
        KeteranganPerawatanKhusus.setDocument(new batasInput((int)1000).getKata(KeteranganPerawatanKhusus));
        KeteranganMemenuhiKebutuhan.setDocument(new batasInput((int)1000).getKata(KeteranganMemenuhiKebutuhan));
        KeteranganNyeriKronis.setDocument(new batasInput((int)1000).getKata(KeteranganNyeriKronis));
        KeteranganEdukasiPasien.setDocument(new batasInput((int)1000).getKata(KeteranganEdukasiPasien));
        KeteranganKeterampilanKhusus.setDocument(new batasInput((int)1000).getKata(KeteranganKeterampilanKhusus));
