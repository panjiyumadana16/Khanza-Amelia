        ...
        try{
            if(TCari.getText().toString().trim().equals("")){
                ps=koneksi.prepareStatement(
                    ...
                    "monitoring_reaksi_tranfusi.tgl_perawatan between ? and ? order by monitoring_reaksi_tranfusi.tgl_perawatan, monitoring_reaksi_tranfusi.jam_rawat");
            }else{
                ps=koneksi.prepareStatement(
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,reg_periksa.umurdaftar,reg_periksa.sttsumur,"+
                    "pasien.jk,pasien.tgl_lahir,monitoring_reaksi_tranfusi.tgl_perawatan,monitoring_reaksi_tranfusi.jam_rawat,monitoring_reaksi_tranfusi.produk_darah,"+
                    ...
                    "order by monitoring_reaksi_tranfusi.tgl_perawatan, monitoring_reaksi_tranfusi.jam_rawat");
            }
