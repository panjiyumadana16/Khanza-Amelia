...
public final class RMTransferPasienAntarRuang extends javax.swing.JDialog {
    ...
    public RMTransferPasienAntarRuang(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Obat Yang Telah Diberikan","Pemeriksaan Penunjang Yang Sudah Dilakukan","Peralatan Yang Menyertai","Keterangan Peralatan Menyertai","Menyetujui Pemindahan",
            "Nama Keluarga/Penanggung Jawab","Hubungan","GCS Sbt","Keadaan Umum SbT","TD SbT","Nadi SbT","RR SbT","Suhu Sbt","Spo2 Sbt","BB Sbt","Keluhan Utama Sebelum Transfer",
            "GCS Stt","Keadaan Umum StT","TD StT","Nadi StT","RR StT","Suhu Stt","Spo2 Stt","BB Stt","Keluhan Utama Setelah Transfer","NIP Menyerahkan",
        ...
        DiagnosaUtama.setDocument(new batasInput((int)250).getKata(DiagnosaUtama));
        ...
        KeluhanUtamaSebelumTransfer.setDocument(new batasInput((int)2000).getKata(KeluhanUtamaSebelumTransfer));
        ...
        spo2SebelumTransfer.setDocument(new batasInput((int)5).getKata(spo2SebelumTransfer));
        beratSebelumTransfer.setDocument(new batasInput((int)5).getKata(beratSebelumTransfer));
        gcsSebelumTransfer.setDocument(new batasInput((int)5).getKata(gcsSebelumTransfer));
        KeluhanUtamaSetelahTransfer.setDocument(new batasInput((int)2000).getKata(KeluhanUtamaSetelahTransfer));
        ...
        spo2SetelahTransfer.setDocument(new batasInput((int)5).getKata(spo2SetelahTransfer));
        beratSetelahTransfer.setDocument(new batasInput((int)5).getKata(beratSetelahTransfer));
        gcsSetelahTransfer.setDocument(new batasInput((int)5).getKata(gcsSetelahTransfer));
    ...
    private void initComponents() {
        ...
        beratSebelumTransfer = new widget.TextBox();
        jLabel58 = new widget.Label();
        jLabel61 = new widget.Label();
        jLabel62 = new widget.Label();
        beratSetelahTransfer = new widget.TextBox();
        jLabel63 = new widget.Label();
        jLabel66 = new widget.Label();
        gcsSetelahTransfer = new widget.TextBox();
        jLabel67 = new widget.Label();
        jLabel68 = new widget.Label();
        gcsSebelumTransfer = new widget.TextBox();
        ...
        ppCetak.setText("Cetak Transfer Pasien");
        ...
        TanggalMasuk.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "14-05-2025 08:14:30" }));
        ...
        TanggalPindah.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "14-05-2025 08:14:30" }));
        ...
        jLabel42.setBounds(200, 410, 60, 23);
        ...
        KeadaanUmumSebelumTransfer.setBounds(270, 410, 130, 23);
        ...
        TDSebelumTransfer.setBounds(180, 440, 60, 23);

        jLabel23.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel23.setText("mmHg");
        jLabel23.setName("jLabel23"); // NOI18N
        FormInput.add(jLabel23);
        jLabel23.setBounds(250, 440, 30, 23);

        jLabel17.setText("Nadi :");
        jLabel17.setName("jLabel17"); // NOI18N
        FormInput.add(jLabel17);
        jLabel17.setBounds(0, 440, 40, 23);

        jLabel22.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel22.setText("x/menit");
        jLabel22.setName("jLabel22"); // NOI18N
        FormInput.add(jLabel22);
        jLabel22.setBounds(110, 440, 50, 23);
        ...
        NadiSebelumTransfer.setBounds(40, 440, 60, 23);
        ...
        jLabel24.setBounds(0, 470, 40, 23);
        ...
        SuhuSebelumTransfer.setBounds(40, 470, 60, 23);

        jLabel27.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel27.setText("°C");
        jLabel27.setName("jLabel27"); // NOI18N
        FormInput.add(jLabel27);
        jLabel27.setBounds(110, 470, 30, 23);

        jLabel28.setText("TD :");
        jLabel28.setName("jLabel28"); // NOI18N
        FormInput.add(jLabel28);
        jLabel28.setBounds(150, 440, 30, 23);
        ...
        jLabel44.setBounds(200, 520, 60, 23);
        ...
        KeadaanUmumSetelahTransfer.setBounds(270, 520, 130, 23);

        jLabel29.setText("TD :");
        jLabel29.setName("jLabel29"); // NOI18N
        FormInput.add(jLabel29);
        jLabel29.setBounds(150, 550, 30, 23);
        ...
        TDSetelahTransfer.setBounds(180, 550, 60, 23);

        jLabel45.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel45.setText("mmHg");
        jLabel45.setName("jLabel45"); // NOI18N
        FormInput.add(jLabel45);
        jLabel45.setBounds(250, 550, 30, 23);
        ...
        jLabel47.setBounds(10, 550, 30, 23);
        ...
        NadiSetelahTransfer.setBounds(40, 550, 60, 23);

        jLabel48.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel48.setText("x/menit");
        jLabel48.setName("jLabel48"); // NOI18N
        FormInput.add(jLabel48);
        jLabel48.setBounds(110, 550, 40, 23);
        ...
        jLabel51.setBounds(0, 580, 40, 23);
        ...
        SuhuSetelahTransfer.setBounds(40, 580, 60, 23);

        jLabel52.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel52.setText("°C");
        jLabel52.setName("jLabel52"); // NOI18N
        FormInput.add(jLabel52);
        jLabel52.setBounds(110, 580, 30, 23);
        ...
        jLabel53.setBounds(270, 470, 40, 23);
        ...
        spo2SebelumTransfer.setBounds(320, 470, 60, 23);
        ...
        jLabel55.setBounds(270, 580, 40, 23);
        ...
        spo2SetelahTransfer.setBounds(320, 580, 60, 23);
        ...
        beratSebelumTransfer.setFocusTraversalPolicyProvider(true);
        beratSebelumTransfer.setName("beratSebelumTransfer"); // NOI18N
        beratSebelumTransfer.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                beratSebelumTransferKeyPressed(evt);
            }
        });
        FormInput.add(beratSebelumTransfer);
        beratSebelumTransfer.setBounds(180, 470, 60, 23);

        jLabel58.setText("Berat :");
        jLabel58.setName("jLabel58"); // NOI18N
        FormInput.add(jLabel58);
        jLabel58.setBounds(140, 470, 40, 23);

        jLabel61.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel61.setText("kg");
        jLabel61.setName("jLabel61"); // NOI18N
        FormInput.add(jLabel61);
        jLabel61.setBounds(250, 470, 20, 23);

        jLabel62.setText("Berat :");
        jLabel62.setName("jLabel62"); // NOI18N
        FormInput.add(jLabel62);
        jLabel62.setBounds(140, 580, 40, 23);

        beratSetelahTransfer.setFocusTraversalPolicyProvider(true);
        beratSetelahTransfer.setName("beratSetelahTransfer"); // NOI18N
        beratSetelahTransfer.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                beratSetelahTransferKeyPressed(evt);
            }
        });
        FormInput.add(beratSetelahTransfer);
        beratSetelahTransfer.setBounds(180, 580, 60, 23);

        jLabel63.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel63.setText("kg");
        jLabel63.setName("jLabel63"); // NOI18N
        FormInput.add(jLabel63);
        jLabel63.setBounds(250, 580, 20, 23);

        jLabel66.setText("GCS :");
        jLabel66.setName("jLabel66"); // NOI18N
        FormInput.add(jLabel66);
        jLabel66.setBounds(10, 520, 30, 23);

        gcsSetelahTransfer.setFocusTraversalPolicyProvider(true);
        gcsSetelahTransfer.setName("gcsSetelahTransfer"); // NOI18N
        gcsSetelahTransfer.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                gcsSetelahTransferKeyPressed(evt);
            }
        });
        FormInput.add(gcsSetelahTransfer);
        gcsSetelahTransfer.setBounds(40, 520, 60, 23);

        jLabel67.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel67.setText("E,V,M");
        jLabel67.setName("jLabel67"); // NOI18N
        FormInput.add(jLabel67);
        jLabel67.setBounds(110, 520, 40, 23);

        jLabel68.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel68.setText("E,V,M");
        jLabel68.setName("jLabel68"); // NOI18N
        FormInput.add(jLabel68);
        jLabel68.setBounds(110, 410, 50, 23);

        gcsSebelumTransfer.setFocusTraversalPolicyProvider(true);
        gcsSebelumTransfer.setName("gcsSebelumTransfer"); // NOI18N
        gcsSebelumTransfer.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                gcsSebelumTransferKeyPressed(evt);
            }
        });
        FormInput.add(gcsSebelumTransfer);
        gcsSebelumTransfer.setBounds(40, 410, 60, 23);

        jLabel69.setText("GCS :");
        jLabel69.setName("jLabel69"); // NOI18N
        FormInput.add(jLabel69);
        jLabel69.setBounds(0, 410, 40, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        }else if(spo2SebelumTransfer.getText().trim().equals("")){
            Valid.textKosong(spo2SebelumTransfer,"SpO2 Sebelum Transfer");
        }else if(beratSebelumTransfer.getText().trim().equals("")){
            Valid.textKosong(beratSebelumTransfer,"Berat Sebelum Transfer");
        }else if(gcsSebelumTransfer.getText().trim().equals("")){
            Valid.textKosong(gcsSebelumTransfer,"Gcs Sebelum Transfer");
        ...
        }else if(spo2SetelahTransfer.getText().trim().equals("")){
            Valid.textKosong(spo2SetelahTransfer,"SpO2 Setelah Transfer");
        }else if(beratSetelahTransfer.getText().trim().equals("")){
            Valid.textKosong(beratSetelahTransfer,"Berat Setelah Transfer");
        }else if(gcsSetelahTransfer.getText().trim().equals("")){
            Valid.textKosong(gcsSetelahTransfer,"Gcs Setelah Transfer");
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(tbObat.getSelectedRow()>-1){
            if(akses.getkode().equals("Admin Utama")){
                ...
                if(akses.getkode().equals(tbObat.getValueAt(tbObat.getSelectedRow(),40).toString())||akses.getkode().equals(tbObat.getValueAt(tbObat.getSelectedRow(),42).toString())){
                    hapus();
                }else{
                    JOptionPane.showMessageDialog(null,"Harus salah satu petugas sesuai user login..!!");
                }
            ...
            try{
                if(TCari.getText().trim().equals("")){
                    ps=koneksi.prepareStatement(
                            ...
                            "transfer_pasien_antar_ruang.suhu_sebelum_transfer,transfer_pasien_antar_ruang.spo2_sebelum_transfer,transfer_pasien_antar_ruang.berat_sebelum_transfer,"+
                            "transfer_pasien_antar_ruang.gcs_sesudah_transfer,transfer_pasien_antar_ruang.keluhan_utama_sesudah_transfer,transfer_pasien_antar_ruang.keadaan_umum_sesudah_transfer,"+
                            "transfer_pasien_antar_ruang.td_sesudah_transfer,transfer_pasien_antar_ruang.nadi_sesudah_transfer,transfer_pasien_antar_ruang.rr_sesudah_transfer,transfer_pasien_antar_ruang.suhu_sesudah_transfer,"+
                            "transfer_pasien_antar_ruang.spo2_sesudah_transfer,transfer_pasien_antar_ruang.berat_sesudah_transfer,transfer_pasien_antar_ruang.gcs_sesudah_transfer,transfer_pasien_antar_ruang.nip_menyerahkan,"+
                            "petugasmenyerahkan.nama as petugasmenyerahkan,transfer_pasien_antar_ruang.nip_menerima,petugasmenerima.nama as petugasmenerima "+
                    ...
                    ps=koneksi.prepareStatement(
                            ...
                            "transfer_pasien_antar_ruang.keluhan_utama_sebelum_transfer,transfer_pasien_antar_ruang.keadaan_umum_sebelum_transfer,"+
                            "transfer_pasien_antar_ruang.td_sebelum_transfer,transfer_pasien_antar_ruang.nadi_sebelum_transfer,transfer_pasien_antar_ruang.rr_sebelum_transfer,"+
                            "transfer_pasien_antar_ruang.suhu_sebelum_transfer,transfer_pasien_antar_ruang.spo2_sebelum_transfer,transfer_pasien_antar_ruang.berat_sebelum_transfer,transfer_pasien_antar_ruang.gcs_sebelum_transfer,"+
                            "transfer_pasien_antar_ruang.keluhan_utama_sesudah_transfer,transfer_pasien_antar_ruang.keadaan_umum_sesudah_transfer,transfer_pasien_antar_ruang.td_sesudah_transfer,"+
                    ...
                    htmlContent.append(                             
                        "<tr class='isi'>"+
                           "<td valign='middle' bgcolor='#FFFAF8' align='center'><b>No.Rawat</b></td>"+
                            ...
                            "<td valign='middle' bgcolor='#FFFAF8' align='center'><b>GCS Sbt</b></td>"+
                            ...
                            "<td valign='middle' bgcolor='#FFFAF8' align='center'><b>Spo2 Sbt</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center'><b>BB Sbt</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center'><b>Keluhan Utama Sebelum Transfer</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center'><b>GCS Stt</b></td>"+
                            ...
                            "<td valign='middle' bgcolor='#FFFAF8' align='center'><b>Spo2 Stt</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center'><b>BB Stt</b></td>"+
                    ...
                    while(rs.next()){
                        htmlContent.append(
                            "<tr class='isi'>"+
                               ...
                               "<td valign='top'>"+rs.getString("gcs_sebelum_transfer")+"</td>"+
                               ...
                               "<td valign='top'>"+rs.getString("berat_sebelum_transfer")+"</td>"+
                               "<td valign='top'>"+rs.getString("keluhan_utama_sebelum_transfer")+"</td>"+
                               "<td valign='top'>"+rs.getString("gcs_sesudah_transfer")+"</td>"+
                               ...
                               "<td valign='top'>"+rs.getString("berat_sesudah_transfer")+"</td>"+
    ...
    private void beratSebelumTransferKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_beratSebelumTransferKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_beratSebelumTransferKeyPressed

    private void beratSetelahTransferKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_beratSetelahTransferKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_beratSetelahTransferKeyPressed

    private void gcsSetelahTransferKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_gcsSetelahTransferKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_gcsSetelahTransferKeyPressed

    private void gcsSebelumTransferKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_gcsSebelumTransferKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_gcsSebelumTransferKeyPressed
    ...
    private void ppCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppCetakActionPerformed
        if(tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString().trim().equals("")){
            ...
            if(tbObat.getRowCount()==0){
                ...
                param.put("tglmasuk", tbObat.getValueAt(tbObat.getSelectedRow(),5).toString());
                param.put("petugasmenyerahkan", tbObat.getValueAt(tbObat.getSelectedRow(),41).toString());
                param.put("petugasmenerima", tbObat.getValueAt(tbObat.getSelectedRow(),43).toString());

                Valid.MyReport("rptLaporanTransferPasien.jasper","report","::[ Transfer Pasien Antar Ruang ]::",param);
                this.setCursor(Cursor.getDefaultCursor());
            }
        }
    ...
    */
    ...
    private widget.TextBox beratSebelumTransfer;
    private widget.TextBox beratSetelahTransfer;
    private widget.Button btnAmbil;
    private widget.TextBox gcsSebelumTransfer;
    private widget.TextBox gcsSetelahTransfer;
        ...
        try{
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                        ...
                        "transfer_pasien_antar_ruang.td_sebelum_transfer,transfer_pasien_antar_ruang.nadi_sebelum_transfer,transfer_pasien_antar_ruang.rr_sebelum_transfer,"+
                        "transfer_pasien_antar_ruang.suhu_sebelum_transfer,transfer_pasien_antar_ruang.spo2_sebelum_transfer,transfer_pasien_antar_ruang.berat_sebelum_transfer,"+
                        "transfer_pasien_antar_ruang.gcs_sebelum_transfer,transfer_pasien_antar_ruang.keluhan_utama_sesudah_transfer,transfer_pasien_antar_ruang.keadaan_umum_sesudah_transfer,"+
                        "transfer_pasien_antar_ruang.td_sesudah_transfer,transfer_pasien_antar_ruang.nadi_sesudah_transfer,transfer_pasien_antar_ruang.rr_sesudah_transfer,"+
                        "transfer_pasien_antar_ruang.suhu_sesudah_transfer,transfer_pasien_antar_ruang.spo2_sesudah_transfer,transfer_pasien_antar_ruang.berat_sesudah_transfer,"+
                        "transfer_pasien_antar_ruang.gcs_sesudah_transfer,transfer_pasien_antar_ruang.nip_menyerahkan,petugasmenyerahkan.nama as petugasmenyerahkan,transfer_pasien_antar_ruang.nip_menerima,petugasmenerima.nama as petugasmenerima "+
                        "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        "inner join transfer_pasien_antar_ruang on reg_periksa.no_rawat=transfer_pasien_antar_ruang.no_rawat "+
                        "inner join petugas as petugasmenyerahkan on transfer_pasien_antar_ruang.nip_menyerahkan=petugasmenyerahkan.nip "+
                        "inner join petugas as petugasmenerima on transfer_pasien_antar_ruang.nip_menerima=petugasmenerima.nip where "+
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("nama_menyetujui"),rs.getString("hubungan_menyetujui"),rs.getString("gcs_sebelum_transfer"),rs.getString("keadaan_umum_sebelum_transfer"),rs.getString("td_sebelum_transfer"),rs.getString("nadi_sebelum_transfer"),
                        rs.getString("rr_sebelum_transfer"),rs.getString("suhu_sebelum_transfer"),rs.getString("spo2_sebelum_transfer"),rs.getString("berat_sebelum_transfer"),
                        rs.getString("keluhan_utama_sebelum_transfer"),rs.getString("gcs_sesudah_transfer"),rs.getString("keadaan_umum_sesudah_transfer"),rs.getString("td_sesudah_transfer"),rs.getString("nadi_sesudah_transfer"),rs.getString("rr_sesudah_transfer"),
                        rs.getString("suhu_sesudah_transfer"),rs.getString("spo2_sesudah_transfer"),rs.getString("berat_sesudah_transfer"),rs.getString("keluhan_utama_sesudah_transfer"),
    ...
    public void emptTeks() {
        ...
        beratSebelumTransfer.setText("");
        KeluhanUtamaSebelumTransfer.setText("");
        gcsSetelahTransfer.setText("");
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            gcsSebelumTransfer.setText(tbObat.getValueAt(tbObat.getSelectedRow(),22).toString()); 
            ...
            spo2SebelumTransfer.setText(tbObat.getValueAt(tbObat.getSelectedRow(),28).toString()); 
            beratSebelumTransfer.setText(tbObat.getValueAt(tbObat.getSelectedRow(),29).toString()); 
            KeluhanUtamaSebelumTransfer.setText(tbObat.getValueAt(tbObat.getSelectedRow(),30).toString()); 
            gcsSetelahTransfer.setText(tbObat.getValueAt(tbObat.getSelectedRow(),31).toString()); 
            ...
            spo2SetelahTransfer.setText(tbObat.getValueAt(tbObat.getSelectedRow(),37).toString()); 
            beratSetelahTransfer.setText(tbObat.getValueAt(tbObat.getSelectedRow(),38).toString()); 
            KeluhanUtamaSetelahTransfer.setText(tbObat.getValueAt(tbObat.getSelectedRow(),39).toString()); 
    ...
    private void ganti() {
        if(Sequel.mengedittf("transfer_pasien_antar_ruang","no_rawat=? and tanggal_masuk=?","no_rawat=?,tanggal_masuk=?,tanggal_pindah=?,asal_ruang=?,ruang_selanjutnya=?,diagnosa_utama=?,"+
                ...
                "spo2_sebelum_transfer=?,berat_sebelum_transfer=?,gcs_sebelum_transfer=?,keluhan_utama_sesudah_transfer=?,keadaan_umum_sesudah_transfer=?,td_sesudah_transfer=?,nadi_sesudah_transfer=?,rr_sesudah_transfer=?,"+
                "suhu_sesudah_transfer=?,spo2_sesudah_transfer=?,berat_sesudah_transfer=?,gcs_sesudah_transfer=?,nip_menyerahkan=?,nip_menerima=?",40,new String[]{
                ...
                TDSebelumTransfer.getText(),NadiSebelumTransfer.getText(),RRSebelumTransfer.getText(),SuhuSebelumTransfer.getText(),spo2SebelumTransfer.getText(),beratSebelumTransfer.getText(),gcsSebelumTransfer.getText(),KeluhanUtamaSetelahTransfer.getText(),
                ...
                SuhuSetelahTransfer.getText(),spo2SetelahTransfer.getText(),beratSetelahTransfer.getText(),gcsSetelahTransfer.getText(),KdPetugasMenyerahkan.getText(),KdPetugasMenerima.getText(),tbObat.getValueAt(tbObat.getSelectedRow(),0).toString(),
                ...
                tbObat.setValueAt(spo2SebelumTransfer.getText(),tbObat.getSelectedRow(),27);
                tbObat.setValueAt(beratSebelumTransfer.getText(),tbObat.getSelectedRow(),28);
                tbObat.setValueAt(gcsSebelumTransfer.getText(),tbObat.getSelectedRow(),29);
                tbObat.setValueAt(KeluhanUtamaSebelumTransfer.getText(),tbObat.getSelectedRow(),30);
                tbObat.setValueAt(KeadaanUmumSetelahTransfer.getSelectedItem().toString(),tbObat.getSelectedRow(),31);
                tbObat.setValueAt(TDSetelahTransfer.getText(),tbObat.getSelectedRow(),32);
                tbObat.setValueAt(NadiSetelahTransfer.getText(),tbObat.getSelectedRow(),33);
                tbObat.setValueAt(RRSetelahTransfer.getText(),tbObat.getSelectedRow(),34);
                tbObat.setValueAt(SuhuSetelahTransfer.getText(),tbObat.getSelectedRow(),35);
                tbObat.setValueAt(spo2SetelahTransfer.getText(),tbObat.getSelectedRow(),36);
                tbObat.setValueAt(beratSetelahTransfer.getText(),tbObat.getSelectedRow(),37);
                tbObat.setValueAt(gcsSetelahTransfer.getText(),tbObat.getSelectedRow(),38);
                tbObat.setValueAt(KeluhanUtamaSetelahTransfer.getText(),tbObat.getSelectedRow(),39);
                tbObat.setValueAt(KdPetugasMenyerahkan.getText(),tbObat.getSelectedRow(),40);
                tbObat.setValueAt(NmPetugasMenyerahkan.getText(),tbObat.getSelectedRow(),41);
                tbObat.setValueAt(KdPetugasMenerima.getText(),tbObat.getSelectedRow(),42);
                tbObat.setValueAt(NmPetugasMenerima.getText(),tbObat.getSelectedRow(),43);
                emptTeks();
                TabRawat.setSelectedIndex(1);
        }
    }
    ...
    private void simpan() {
        if(Sequel.menyimpantf("transfer_pasien_antar_ruang","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat & Tanggal Masuk",38,new String[]{
                TNoRw.getText(),Valid.SetTgl(TanggalMasuk.getSelectedItem()+"")+" "+TanggalMasuk.getSelectedItem().toString().substring(11,19),
                Valid.SetTgl(TanggalPindah.getSelectedItem()+"")+" "+TanggalPindah.getSelectedItem().toString().substring(11,19),AsalRuang.getText(), 
                RuangSelanjutnya.getText(),DiagnosaUtama.getText(),DiagnosaSekunder.getText(),IndikasiPindah.getSelectedItem().toString(),KeteranganIndikasiPindahRuang.getText(), 
                ProsedurDilakukan.getText(),ObatYangDiberikan.getText(),MetodePemindahan.getSelectedItem().toString(),PeralatanMenyertai.getSelectedItem().toString(),
                KeteranganPeralatan.getText(),PemeriksaanPenunjang.getText(),MenyetujuiPemindahan.getSelectedItem().toString(),NamaMenyetujui.getText(),
                HubunganMenyetujui.getSelectedItem().toString(),KeluhanUtamaSebelumTransfer.getText(),KeadaanUmumSebelumTransfer.getSelectedItem().toString(),
                TDSebelumTransfer.getText(),NadiSebelumTransfer.getText(),RRSebelumTransfer.getText(),SuhuSebelumTransfer.getText(),spo2SebelumTransfer.getText(),beratSebelumTransfer.getText(),
                gcsSebelumTransfer.getText(),KeluhanUtamaSetelahTransfer.getText(),KeadaanUmumSetelahTransfer.getSelectedItem().toString(),TDSetelahTransfer.getText(),NadiSetelahTransfer.getText(),
                RRSetelahTransfer.getText(),SuhuSetelahTransfer.getText(),spo2SetelahTransfer.getText(),beratSetelahTransfer.getText(),gcsSetelahTransfer.getText(),KdPetugasMenyerahkan.getText(),KdPetugasMenerima.getText()
            })==true){
                emptTeks();
        }
    }
