            ...
            try{
                ...
                while(rs.next()){
                    tabMode.addRow(new String[] {
                        ...
                        " T : " + rs.getString("tensi") + 
                        "\n N : " + rs.getString("nadi") +
                        "\n S : " + rs.getString("suhu_tubuh") +
                        "\n R : " + rs.getString("respirasi") +
                        "\n Tng / Brt : " + rs.getString("tinggi") + " / " + rs.getString("berat") +
                        "\n SPO2 : " + rs.getString("spo2") +
                        "\n GCS : " + rs.getString("gcs")
                    });
                    tabMode.addRow(new String[] {
                        rs.getString("tgl_perawatan"),rs.getString("jam_rawat"),rs.getString("pemeriksaan")
                    });
                }
            }catch(Exception ex){
