...
public final class RMTriaseIGD extends javax.swing.JDialog {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        tampilPemeriksaan2();
        tampil();
        PrimerSuhu.setText(Sequel.cariIsi("select pemeriksaan_ralan.suhu_tubuh from pemeriksaan_ralan where pemeriksaan_ralan.no_rawat=? order by pemeriksaan_ralan.tgl_perawatan asc ,pemeriksaan_ralan.jam_rawat asc limit 1"
                        , TNoRw.getText().trim())); 
        PrimerTensi.setText(Sequel.cariIsi("select pemeriksaan_ralan.tensi from pemeriksaan_ralan where pemeriksaan_ralan.no_rawat=? order by pemeriksaan_ralan.tgl_perawatan asc ,pemeriksaan_ralan.jam_rawat asc limit 1"
                        , TNoRw.getText().trim())); 
        PrimerNadi.setText(Sequel.cariIsi("select pemeriksaan_ralan.nadi from pemeriksaan_ralan where pemeriksaan_ralan.no_rawat=? order by pemeriksaan_ralan.tgl_perawatan asc ,pemeriksaan_ralan.jam_rawat asc limit 1"
                        , TNoRw.getText().trim())); 
        PrimerRespirasi.setText(Sequel.cariIsi("select pemeriksaan_ralan.respirasi from pemeriksaan_ralan where pemeriksaan_ralan.no_rawat=? order by pemeriksaan_ralan.tgl_perawatan asc ,pemeriksaan_ralan.jam_rawat asc limit 1"
                        , TNoRw.getText().trim())); 
        PrimerSaturasi.setText(Sequel.cariIsi("select pemeriksaan_ralan.spo2 from pemeriksaan_ralan where pemeriksaan_ralan.no_rawat=? order by pemeriksaan_ralan.tgl_perawatan asc ,pemeriksaan_ralan.jam_rawat asc limit 1"
                        , TNoRw.getText().trim()));
        
        SekunderSuhu.setText(Sequel.cariIsi("select pemeriksaan_ralan.suhu_tubuh from pemeriksaan_ralan where pemeriksaan_ralan.no_rawat=? order by pemeriksaan_ralan.tgl_perawatan asc ,pemeriksaan_ralan.jam_rawat asc limit 1"
                        , TNoRw.getText().trim())); 
        SekunderTensi.setText(Sequel.cariIsi("select pemeriksaan_ralan.tensi from pemeriksaan_ralan where pemeriksaan_ralan.no_rawat=? order by pemeriksaan_ralan.tgl_perawatan asc ,pemeriksaan_ralan.jam_rawat asc limit 1"
                        , TNoRw.getText().trim())); 
        SekunderNadi.setText(Sequel.cariIsi("select pemeriksaan_ralan.nadi from pemeriksaan_ralan where pemeriksaan_ralan.no_rawat=? order by pemeriksaan_ralan.tgl_perawatan asc ,pemeriksaan_ralan.jam_rawat asc limit 1"
                        , TNoRw.getText().trim())); 
        SekunderRespirasi.setText(Sequel.cariIsi("select pemeriksaan_ralan.respirasi from pemeriksaan_ralan where pemeriksaan_ralan.no_rawat=? order by pemeriksaan_ralan.tgl_perawatan asc ,pemeriksaan_ralan.jam_rawat asc limit 1"
                        , TNoRw.getText().trim())); 
        SekunderSaturasi.setText(Sequel.cariIsi("select pemeriksaan_ralan.spo2 from pemeriksaan_ralan where pemeriksaan_ralan.no_rawat=? order by pemeriksaan_ralan.tgl_perawatan asc ,pemeriksaan_ralan.jam_rawat asc limit 1"
                        , TNoRw.getText().trim()));
