...
public final class RMPenilaianAwalMedisIGD extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Kesadaran.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Compos Mentis", "Apatis", "Delirium", "Somnolen", "Sopor", "Semi Koma", "Koma" }));
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-12-2024 09:38:03" }));
        ...
        jSeparator17.setBounds(0, 1380, 880, 1);

        jLabel104.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel104.setText("VII. KELENGKAPAN S.O.A.P.I.E");
        jLabel104.setName("jLabel104"); // NOI18N
        FormInput.add(jLabel104);
        jLabel104.setBounds(10, 1380, 190, 23);
        ...
        Instruksi.setPreferredSize(new java.awt.Dimension(102, 52));
        scrollPane14.setViewportView(Instruksi);

        FormInput.add(scrollPane14);
        scrollPane14.setBounds(40, 1420, 390, 63);
        ...
        scrollPane15.setViewportView(Evaluasi);

        FormInput.add(scrollPane15);
        scrollPane15.setBounds(470, 1420, 390, 63);

        jLabel83.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel83.setText("Evaluasi :");
        jLabel83.setName("jLabel83"); // NOI18N
        FormInput.add(jLabel83);
        jLabel83.setBounds(470, 1400, 280, 23);

        jLabel84.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel84.setText("Instruksi :");
        jLabel84.setName("jLabel84"); // NOI18N
        FormInput.add(jLabel84);
        jLabel84.setBounds(40, 1400, 280, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            String keluhanSoap = "",pemeriksaanSoap = "";
            if(Sequel.menyimpantf("penilaian_medis_igd","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",36,new String[]{
                    ...
                    keluhanSoap = "\nKeluhan Utama : "+KeluhanUtama.getText()+"\n"
                            + "\nRIWAYAT PENYAKIT \nSekarang : "+RPS.getText()+"\nDulu : "+RPD.getText()+"\nKeluarga : "+RPK.getText()+"\n\n"
                            + "Riwayat Penggunaan Obat : "+RPO.getText();
                    
                    pemeriksaanSoap = "\nKeadaan Umum : "+Keadaan.getSelectedItem().toString()+"\n"
                            + "Kepala ("+Kepala.getSelectedItem().toString()+"), Mata ("+Mata.getSelectedItem().toString()+"), Gigi & Mulut ("+Gigi.getSelectedItem().toString()+"), Leher ("+Leher.getSelectedItem().toString()+"),"
                            + "\nThoraks ("+Thoraks.getSelectedItem().toString()+"), Abdomen ("+Abdomen.getSelectedItem().toString()+"), Genital & Anus ("+Genital.getSelectedItem().toString()+"), Ekstremitas ("+Ekstremitas.getSelectedItem().toString()+")\n"
                            + "Keterangan Fisik : \n"+KetFisik.getText()
                            + "\n\nPENUNJANG\nEKG : "+EKG.getText()+"\nRAD : "+Radiologi.getText()+"\nLAB : "+Laborat.getText();
                    ...
                    if(Sequel.menyimpantf("pemeriksaan_ralan","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Data",21,new String[]{
                        ...
                        Suhu.getText(),TD.getText(),Nadi.getText(),RR.getText(),TB.getText(),BB.getText(),SPO.getText(),GCS.getText(),Kesadaran.getSelectedItem().toString(),
                        keluhanSoap,pemeriksaanSoap,Alergi.getText(),"-",Tatalaksana.getText(),Diagnosis.getText(),Instruksi.getText(),Evaluasi.getText(),
                        KdDokter.getText()})==true){
                        JOptionPane.showMessageDialog(rootPane,"S.O.A.P.I.E Berhasil dibuat bedasarkan Penilaian Awal Medis IGD!!!");
                    }
                    emptTeks();
            }
        }
