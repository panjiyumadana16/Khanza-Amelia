...
public final class RMCariJumlahObat extends javax.swing.JDialog {
    ...
    public RMCariJumlahObat(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"Obat Diberikan","Jumlah","Aturan Pakai"};
    ...
    public void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                    "select databarang.nama_brng, detail_pemberian_obat.jml,resep_dokter.aturan_pakai "+
                    "from detail_pemberian_obat inner join databarang INNER JOIN resep_dokter on" +
                    " detail_pemberian_obat.kode_brng=databarang.kode_brng AND resep_dokter.kode_brng=detail_pemberian_obat.kode_brng where "+
                    "detail_pemberian_obat.no_rawat=? and (detail_pemberian_obat.tgl_perawatan like ? or databarang.nama_brng like ?) "+
                    "group by detail_pemberian_obat.tgl_perawatan,detail_pemberian_obat.jam,detail_pemberian_obat.kode_brng order by detail_pemberian_obat.tgl_perawatan,"+
