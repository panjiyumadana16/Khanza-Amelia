...
public final class RMPenilaianAwalKeperawatanRanapNeonatus extends javax.swing.JDialog {
    ...
    public RMPenilaianAwalKeperawatanRanapNeonatus(java.awt.Frame parent, boolean modal) {
        ...
        AntoBB.getDocument().addDocumentListener(new javax.swing.event.DocumentListener() {
            @Override
            public void insertUpdate(DocumentEvent e) {
                FisikBB.setText(AntoBB.getText());
            }
        ...
        AntoPB.getDocument().addDocumentListener(new javax.swing.event.DocumentListener() {
            @Override
            public void insertUpdate(DocumentEvent e) {
                FisikTB.setText(AntoPB.getText());
            }
        ...
        AntoLK.getDocument().addDocumentListener(new javax.swing.event.DocumentListener() {
            @Override
            public void insertUpdate(DocumentEvent e) {
                FisikLK.setText(AntoLK.getText());
            }
        ...
        AntoLD.getDocument().addDocumentListener(new javax.swing.event.DocumentListener() {
            @Override
            public void insertUpdate(DocumentEvent e) {
                FisikLD.setText(AntoLD.getText());
            }
        ...
        AntoLP.getDocument().addDocumentListener(new javax.swing.event.DocumentListener() {
            @Override
            public void insertUpdate(DocumentEvent e) {
                FisikLP.setText(AntoLP.getText());
            }
...
//        }
    ...
    private void initComponents() {
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-04-2025 10:53:22" }));
        ...
        KondisiSaatLahir.setText("Sehat");
        ...
        BahasaSehari.setText("Indonesia");
        ...
        TanggalPulang.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-04-2025" }));
        ...
        BtnDokter1.setBounds(100, 170, 28, 23);
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-04-2025" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-04-2025" }));
    ...
    private void isRawat() {
        try {
            ps=koneksi.prepareStatement(
                    ...
                    "reg_periksa.tgl_registrasi,reg_periksa.jam_reg,penjab.png_jawab from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
