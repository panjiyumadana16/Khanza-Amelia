...
//            "Jalannya Penyakit Selama Perawatan",
            ...
            "Diagnosa Sekunder 4","ICD10 Sek 4","Diagnosa Sekunder 5","ICD10 Sek 5","Diagnosa Sekunder 6","ICD10 Sek 6","Diagnosa Sekunder 7","ICD10 Sek 7",
            "Prosedur Utama","ICD9 Utama","Prosedur Sekunder 1","ICD9 Sek1","Prosedur Sekunder 2","ICD9 Sek2","Prosedur Sekunder 3","ICD9 Sek3",
            "Prosedur Sekunder 4","ICD9 Sek4","Prosedur Sekunder 5","ICD9 Sek5","Prosedur Sekunder 6","ICD9 Sek6","Prosedur Sekunder 7","ICD9 Sek7",
            "Alergi Obat","Diet","Hasil Lab Yang Belum Selesai (Pending)","Instruksi/Anjuran Dan Edukasi (Follow Up)","Keadaan Pulang","Ket.Keadaan Pulang",
            "Cara Keluar","Ket.Cara Keluar","Dilanjutkan","Ket.Dilanjutkan","Kontrol Kembali","Obat Pulang"
        }){
...
//        JalannyaPenyakit.setDocument(new batasInput((int)2000).getKata(JalannyaPenyakit));
        ...
        cariobat.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(cariobat.getTable().getSelectedRow()!= -1){
                    ObatSelamaDiRS.append(cariobat.getTable().getValueAt(cariobat.getTable().getSelectedRow(),0).toString()+" "+
                            cariobat.getTable().getValueAt(cariobat.getTable().getSelectedRow(),1).toString()+" "+cariobat.getTable().getValueAt(cariobat.getTable().getSelectedRow(),2).toString()+", ");
    ...
    private void initComponents() {
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(100, 1380));
        ...
        jLabel25.setBounds(0, 590, 145, 23);
        ...
        DiagnosaSekunder2.setBounds(160, 590, 520, 23);

        jLabel26.setText("Diagnosa Sekunder 3 :");
        jLabel26.setName("jLabel26"); // NOI18N
        FormInput.add(jLabel26);
        jLabel26.setBounds(0, 620, 145, 23);
        ...
        DiagnosaUtama.setBounds(160, 530, 520, 23);

        jLabel27.setText("Diagnosa Utama :");
        jLabel27.setName("jLabel27"); // NOI18N
        FormInput.add(jLabel27);
        jLabel27.setBounds(0, 530, 145, 23);
        ...
        DiagnosaSekunder3.setBounds(160, 620, 520, 23);

        jLabel28.setText("Diagnosa Sekunder 4 :");
        jLabel28.setName("jLabel28"); // NOI18N
        FormInput.add(jLabel28);
        jLabel28.setBounds(0, 650, 145, 23);

        DiagnosaSekunder4.setHighlighter(null);
        DiagnosaSekunder4.setName("DiagnosaSekunder4"); // NOI18N
        DiagnosaSekunder4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                DiagnosaSekunder4ActionPerformed(evt);
            }
        });
        ...
        DiagnosaSekunder4.setBounds(160, 650, 520, 23);
        ...
        scrollPane2.setBounds(220, 160, 561, 50);
        ...
        jLabel8.setBounds(0, 220, 220, 23);
        ...
        scrollPane3.setBounds(220, 220, 560, 50);

        jLabel9.setText("Pemeriksaan Penunjang Rad Terpenting :");
        jLabel9.setName("jLabel9"); // NOI18N
        FormInput.add(jLabel9);
        jLabel9.setBounds(0, 280, 220, 23);
        ...
        scrollPane4.setBounds(220, 280, 561, 50);

        jLabel10.setText("Pemeriksaan Penunjang Lab Terpenting :");
        jLabel10.setName("jLabel10"); // NOI18N
        FormInput.add(jLabel10);
        jLabel10.setBounds(0, 340, 220, 23);
        ...
        scrollPane5.setBounds(220, 340, 561, 50);

        jLabel29.setText("Diagnosa Akhir :");
        jLabel29.setName("jLabel29"); // NOI18N
        FormInput.add(jLabel29);
        jLabel29.setBounds(0, 510, 100, 23);

        jLabel30.setText("Diagnosa Sekunder 1 :");
        jLabel30.setName("jLabel30"); // NOI18N
        FormInput.add(jLabel30);
        jLabel30.setBounds(0, 560, 145, 23);
        ...
        DiagnosaSekunder1.setBounds(160, 560, 520, 23);

        jLabel31.setText("Kode ICD :");
        jLabel31.setName("jLabel31"); // NOI18N
        FormInput.add(jLabel31);
        jLabel31.setBounds(520, 510, 210, 23);
        ...
        KodeDiagnosaUtama.setBounds(700, 530, 75, 23);
        ...
        KodeDiagnosaSekunder1.setBounds(700, 560, 75, 23);
        ...
        KodeDiagnosaSekunder2.setBounds(700, 590, 75, 23);
        ...
        KodeDiagnosaSekunder3.setBounds(700, 620, 75, 23);
        ...
        KodeDiagnosaSekunder4.setBounds(700, 650, 75, 23);

        jLabel32.setText("Prosedur Utama :");
        jLabel32.setName("jLabel32"); // NOI18N
        FormInput.add(jLabel32);
        jLabel32.setBounds(0, 770, 145, 23);
        ...
        ProsedurUtama.setBounds(160, 770, 520, 23);
        ...
        KodeProsedurUtama.setBounds(700, 770, 75, 23);
        ...
        ProsedurSekunder1.setBounds(160, 800, 520, 23);

        jLabel33.setText("Prosedur Sekunder 1 :");
        jLabel33.setName("jLabel33"); // NOI18N
        FormInput.add(jLabel33);
        jLabel33.setBounds(0, 800, 145, 23);
        ...
        KodeProsedurSekunder1.setBounds(700, 800, 75, 23);

        jLabel34.setText("Prosedur Sekunder 2 :");
        jLabel34.setName("jLabel34"); // NOI18N
        FormInput.add(jLabel34);
        jLabel34.setBounds(0, 830, 145, 23);
        ...
        ProsedurSekunder2.setBounds(160, 830, 520, 23);
        ...
        KodeProsedurSekunder2.setBounds(700, 830, 75, 23);
        ...
        KodeProsedurSekunder3.setBounds(700, 860, 75, 23);
        ...
        ProsedurSekunder3.setBounds(160, 860, 520, 23);

        jLabel35.setText("Prosedur Sekunder 3 :");
        jLabel35.setName("jLabel35"); // NOI18N
        FormInput.add(jLabel35);
        jLabel35.setBounds(0, 860, 145, 23);
        ...
        BtnDokter2.setBounds(180, 310, 28, 23);
        ...
        BtnDokter3.setBounds(180, 370, 28, 23);

        jLabel37.setText("Cara Keluar :");
        jLabel37.setName("jLabel37"); // NOI18N
        FormInput.add(jLabel37);
        jLabel37.setBounds(370, 1220, 70, 23);
        ...
        CaraKeluar.setBounds(440, 1220, 205, 23);

        jLabel36.setText("Keadaan Pulang :");
        jLabel36.setName("jLabel36"); // NOI18N
        FormInput.add(jLabel36);
        jLabel36.setBounds(0, 1220, 100, 23);
        ...
        Keadaan.setBounds(100, 1220, 130, 23);
        ...
        BtnDokter5.setBounds(190, 240, 28, 23);
        ...
        jLabel12.setBounds(0, 400, 220, 23);
        ...
        BtnDokter16.setBounds(180, 420, 28, 23);
        ...
        scrollPane7.setBounds(220, 400, 561, 50);

        jLabel38.setText("Alergi Obat :");
        jLabel38.setName("jLabel38"); // NOI18N
        FormInput.add(jLabel38);
        jLabel38.setBounds(0, 1010, 100, 23);
        ...
        Alergi.setBounds(100, 1010, 681, 23);

        jLabel39.setText("Diet :");
        jLabel39.setName("jLabel39"); // NOI18N
        FormInput.add(jLabel39);
        jLabel39.setBounds(0, 1040, 100, 23);
        ...
        KetKeluar.setBounds(650, 1220, 125, 23);

        jLabel40.setText("Hasil Lab Yang Belum Selesai (Pending) :");
        jLabel40.setName("jLabel40"); // NOI18N
        FormInput.add(jLabel40);
        jLabel40.setBounds(0, 1100, 230, 23);
        ...
        BtnDokter17.setBounds(200, 1130, 28, 23);
        ...
        scrollPane8.setBounds(100, 1040, 681, 50);

        jLabel41.setText("Instruksi/Anjuran Dan Edukasi (Follow Up) :");
        jLabel41.setName("jLabel41"); // NOI18N
        FormInput.add(jLabel41);
        jLabel41.setBounds(0, 1160, 230, 23);
        ...
        scrollPane9.setBounds(230, 1160, 551, 50);
        ...
        KetKeadaanPulang.setBounds(240, 1220, 130, 23);

        jLabel42.setText("Dilanjutkan :");
        jLabel42.setName("jLabel42"); // NOI18N
        FormInput.add(jLabel42);
        jLabel42.setBounds(0, 1250, 100, 23);
        ...
        DIlanjutkan.setBounds(100, 1250, 130, 23);
        ...
        KetDilanjutkan.setBounds(240, 1250, 270, 23);

        Kontrol.setForeground(new java.awt.Color(50, 70, 50));
        Kontrol.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "29-02-2024 11:09:15" }));
        ...
        BtnDokter18.setBounds(70, 1070, 28, 23);
        ...
        scrollPane10.setBounds(230, 1100, 551, 50);
        ...
        scrollPane11.setBounds(100, 1280, 681, 50);
        ...
        BtnDokter19.setBounds(60, 1310, 28, 23);
        ...
        BtnDokter20.setBounds(180, 490, 28, 23);
        ...
        DiagnosaSekunder5.setBounds(160, 680, 520, 23);
        ...
        KodeDiagnosaSekunder5.setBounds(700, 680, 75, 23);
        ...
        KodeDiagnosaSekunder6.setBounds(700, 710, 75, 23);

        DiagnosaSekunder6.setHighlighter(null);
        DiagnosaSekunder6.setName("DiagnosaSekunder6"); // NOI18N
        DiagnosaSekunder6.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                DiagnosaSekunder6ActionPerformed(evt);
            }
        });
        ...
        DiagnosaSekunder6.setBounds(160, 710, 520, 23);

        jLabel44.setText("Diagnosa Sekunder 6 :");
        jLabel44.setName("jLabel44"); // NOI18N
        FormInput.add(jLabel44);
        jLabel44.setBounds(0, 710, 145, 23);

        jLabel45.setText("Diagnosa Sekunder 7 :");
        jLabel45.setName("jLabel45"); // NOI18N
        FormInput.add(jLabel45);
        jLabel45.setBounds(0, 740, 145, 23);
        ...
        DiagnosaSekunder7.setBounds(160, 740, 520, 23);
        ...
        KodeDiagnosaSekunder7.setBounds(700, 740, 75, 23);

        jLabel46.setText("Prosedur Sekunder 4 :");
        jLabel46.setName("jLabel46"); // NOI18N
        FormInput.add(jLabel46);
        jLabel46.setBounds(0, 890, 145, 23);
        ...
        ProsedurSekunder4.setBounds(160, 890, 520, 23);
        ...
        KodeProsedurSekunder4.setBounds(700, 890, 75, 23);
        ...
        ProsedurSekunder5.setBounds(160, 920, 520, 23);
        ...
        KodeProsedurSekunder5.setBounds(700, 920, 75, 23);

        jLabel47.setText("Prosedur Sekunder 5 :");
        jLabel47.setName("jLabel47"); // NOI18N
        FormInput.add(jLabel47);
        jLabel47.setBounds(0, 920, 145, 23);
        ...
        ProsedurSekunder6.setBounds(160, 950, 520, 23);
        ...
        KodeProsedurSekunder6.setBounds(700, 950, 75, 23);

        jLabel48.setText("Prosedur Sekunder 6 :");
        jLabel48.setName("jLabel48"); // NOI18N
        FormInput.add(jLabel48);
        jLabel48.setBounds(0, 950, 145, 23);

        jLabel49.setText("Prosedur Sekunder 7 :");
        jLabel49.setName("jLabel49"); // NOI18N
        FormInput.add(jLabel49);
        jLabel49.setBounds(0, 980, 145, 23);
        ...
        ProsedurSekunder7.setBounds(160, 980, 520, 23);
        ...
        KodeProsedurSekunder7.setBounds(700, 980, 75, 23);
...
//            System.out.println("ini simpan");                    
            if(Sequel.menyimpantf("resume_pasien_ranap","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",55,new String[]{
                    TNoRw.getText(),KodeDokter.getText(),DiagnosaAwal.getText(),Alasan.getText(),KeluhanUtama.getText(),PemeriksaanFisik.getText(),"ini",
//                JalannyaPenyakit.getText(),
                    ...
                    KodeDiagnosaSekunder3.getText(),DiagnosaSekunder4.getText(),KodeDiagnosaSekunder4.getText(),DiagnosaSekunder5.getText(),KodeDiagnosaSekunder5.getText(),
                    DiagnosaSekunder6.getText(),KodeDiagnosaSekunder6.getText(),DiagnosaSekunder7.getText(),KodeDiagnosaSekunder7.getText(),ProsedurUtama.getText(),KodeProsedurUtama.getText(),
                    ...
                    KodeProsedurSekunder3.getText(),ProsedurSekunder4.getText(),KodeProsedurSekunder4.getText(),ProsedurSekunder5.getText(),KodeProsedurSekunder5.getText(),
                    ProsedurSekunder6.getText(),KodeProsedurSekunder6.getText(),ProsedurSekunder7.getText(),KodeProsedurSekunder7.getText(),Alergi.getText(),Diet.getText(),LabBelum.getText(),Edukasi.getText(),CaraKeluar.getSelectedItem().toString(),KetKeluar.getText(),
                    ...
                    tabMode.addRow(new String[]{
                        ...
                        KeluhanUtama.getText(),PemeriksaanFisik.getText(),"ini",
//                        JalannyaPenyakit.getText(),
                        ...
                        DiagnosaSekunder5.getText(),KodeDiagnosaSekunder5.getText(),DiagnosaSekunder6.getText(),KodeDiagnosaSekunder6.getText(),DiagnosaSekunder7.getText(),KodeDiagnosaSekunder7.getText(),
                        ...
                        ProsedurSekunder3.getText(),KodeProsedurSekunder3.getText(),ProsedurSekunder4.getText(),KodeProsedurSekunder4.getText(),ProsedurSekunder5.getText(),KodeProsedurSekunder5.getText(),
                        ProsedurSekunder6.getText(),KodeProsedurSekunder6.getText(),ProsedurSekunder7.getText(),KodeProsedurSekunder7.getText(),Alergi.getText(),Diet.getText(),LabBelum.getText(),Edukasi.getText(),Keadaan.getSelectedItem().toString(),
...
//        }
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReportqry("rptDataResumePasienRanap.jasper","report","::[ Data Resume Pasien ]::",
                    ...
                    "resume_pasien_ranap.kd_diagnosa_sekunder4,resume_pasien_ranap.diagnosa_sekunder5,resume_pasien_ranap.kd_diagnosa_sekunder5,resume_pasien_ranap.diagnosa_sekunder6,resume_pasien_ranap.kd_diagnosa_sekunder6,"+
                    "resume_pasien_ranap.diagnosa_sekunder7,resume_pasien_ranap.kd_diagnosa_sekunder7,resume_pasien_ranap.prosedur_utama,resume_pasien_ranap.kd_prosedur_utama,resume_pasien_ranap.prosedur_sekunder,resume_pasien_ranap.kd_prosedur_sekunder,"+
                    "resume_pasien_ranap.prosedur_sekunder2,resume_pasien_ranap.kd_prosedur_sekunder2,resume_pasien_ranap.prosedur_sekunder3,resume_pasien_ranap.kd_prosedur_sekunder3,resume_pasien_ranap.prosedur_sekunder4,resume_pasien_ranap.kd_prosedur_sekunder4,"+
                    "resume_pasien_ranap.prosedur_sekunder5,resume_pasien_ranap.kd_prosedur_sekunder5,resume_pasien_ranap.prosedur_sekunder6,resume_pasien_ranap.kd_prosedur_sekunder6,resume_pasien_ranap.prosedur_sekunder7,resume_pasien_ranap.kd_prosedur_sekunder7,"+
                    "resume_pasien_ranap.alergi,pasien_ranap.diet,resume_pasien_ranap.lab_belum,resume_pasien_ranap.edukasi,resume_pasien_ranap.cara_keluar,resume_pasien_ranap.ket_keluar,resume_pasien_ranap.keadaan,"+
    ...
    private void KodeProsedurSekunder3KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KodeProsedurSekunder3KeyPressed
        Valid.pindah(evt,ProsedurSekunder3,ProsedurSekunder4);
    ...
    private void PemeriksaanFisikKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PemeriksaanFisikKeyPressed
        Valid.pindah2(evt,KeluhanUtama,HasilLaborat);
    ...
    private void PemeriksaanRadKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PemeriksaanRadKeyPressed
        Valid.pindah2(evt,PemeriksaanFisik,HasilLaborat);
    ...
    private void AlergiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_AlergiKeyPressed
        Valid.pindah(evt,KodeProsedurSekunder7,Diet);
    ...
    private void DiagnosaSekunder5KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_DiagnosaSekunder5KeyPressed
        // TODO add your handling code here:
        Valid.pindah(evt,KodeDiagnosaSekunder4,KodeDiagnosaSekunder5);
    ...
    private void KodeDiagnosaSekunder5KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KodeDiagnosaSekunder5KeyPressed
        // TODO add your handling code here:
        Valid.pindah(evt,DiagnosaSekunder5,DiagnosaSekunder6);
    ...
    private void KodeDiagnosaSekunder6KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KodeDiagnosaSekunder6KeyPressed
        // TODO add your handling code here:
        Valid.pindah(evt,DiagnosaSekunder6,DiagnosaSekunder7);
    ...
    private void DiagnosaSekunder6KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_DiagnosaSekunder6KeyPressed
        // TODO add your handling code here:
        Valid.pindah(evt,KodeDiagnosaSekunder5,KodeDiagnosaSekunder6);
    ...
    private void DiagnosaSekunder7KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_DiagnosaSekunder7KeyPressed
        // TODO add your handling code here:
        Valid.pindah(evt,KodeDiagnosaSekunder6,KodeDiagnosaSekunder7);
    ...
    private void KodeDiagnosaSekunder7KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KodeDiagnosaSekunder7KeyPressed
        // TODO add your handling code here:
        Valid.pindah(evt,DiagnosaSekunder7,ProsedurUtama);
    }//GEN-LAST:event_KodeDiagnosaSekunder7KeyPressed

    private void DiagnosaSekunder6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DiagnosaSekunder6ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_DiagnosaSekunder6ActionPerformed

    private void DiagnosaSekunder4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DiagnosaSekunder4ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_DiagnosaSekunder4ActionPerformed

    private void ProsedurSekunder4KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_ProsedurSekunder4KeyPressed
        // TODO add your handling code here:
        Valid.pindah(evt,KodeProsedurSekunder3,KodeProsedurSekunder4);
    ...
    private void KodeProsedurSekunder4KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KodeProsedurSekunder4KeyPressed
        // TODO add your handling code here:
        Valid.pindah(evt,ProsedurSekunder4,ProsedurSekunder5);
    ...
    private void ProsedurSekunder5KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_ProsedurSekunder5KeyPressed
        // TODO add your handling code here:
        Valid.pindah(evt,KodeProsedurSekunder4,KodeProsedurSekunder5);
    ...
    private void KodeProsedurSekunder5KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KodeProsedurSekunder5KeyPressed
        // TODO add your handling code here:
        Valid.pindah(evt,ProsedurSekunder5,ProsedurSekunder6);
    ...
    private void ProsedurSekunder6KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_ProsedurSekunder6KeyPressed
        // TODO add your handling code here:
        Valid.pindah(evt,KodeProsedurSekunder5,KodeProsedurSekunder6);
    ...
    private void KodeProsedurSekunder6KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KodeProsedurSekunder6KeyPressed
        // TODO add your handling code here:
        Valid.pindah(evt,ProsedurSekunder6,ProsedurSekunder7);
    ...
    private void ProsedurSekunder7KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_ProsedurSekunder7KeyPressed
        // TODO add your handling code here:
        Valid.pindah(evt,KodeProsedurSekunder6,KodeProsedurSekunder7);
    ...
    private void KodeProsedurSekunder7KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KodeProsedurSekunder7KeyPressed
        // TODO add your handling code here:
        Valid.pindah(evt,ProsedurSekunder7,Alergi);
...
//                    "resume_pasien_ranap.jalannya_penyakit,"
                    "resume_pasien_ranap.pemeriksaan_penunjang,resume_pasien_ranap.hasil_laborat,resume_pasien_ranap.tindakan_dan_operasi,resume_pasien_ranap.obat_di_rs,"+
                    "resume_pasien_ranap.diagnosa_utama,resume_pasien_ranap.kd_diagnosa_utama,resume_pasien_ranap.diagnosa_sekunder,resume_pasien_ranap.kd_diagnosa_sekunder,resume_pasien_ranap.diagnosa_sekunder2,"+
                    "resume_pasien_ranap.kd_diagnosa_sekunder2,resume_pasien_ranap.diagnosa_sekunder3,resume_pasien_ranap.kd_diagnosa_sekunder3,resume_pasien_ranap.diagnosa_sekunder4,"+
                    "resume_pasien_ranap.kd_diagnosa_sekunder4,resume_pasien_ranap.diagnosa_sekunder5,resume_pasien_ranap.kd_diagnosa_sekunder5,resume_pasien_ranap.diagnosa_sekunder6,resume_pasien_ranap.kd_diagnosa_sekunder6,"+
                    "resume_pasien_ranap.diagnosa_sekunder7,resume_pasien_ranap.kd_diagnosa_sekunder7,resume_pasien_ranap.prosedur_utama,resume_pasien_ranap.kd_prosedur_utama,resume_pasien_ranap.prosedur_sekunder,resume_pasien_ranap.kd_prosedur_sekunder,"+
                    "resume_pasien_ranap.prosedur_sekunder2,resume_pasien_ranap.kd_prosedur_sekunder2,resume_pasien_ranap.prosedur_sekunder3,resume_pasien_ranap.kd_prosedur_sekunder3,resume_pasien_ranap.prosedur_sekunder4,"+
                    "resume_pasien_ranap.kd_prosedur_sekunder4,resume_pasien_ranap.prosedur_sekunder5,resume_pasien_ranap.kd_prosedur_sekunder5,resume_pasien_ranap.prosedur_sekunder6,resume_pasien_ranap.kd_prosedur_sekunder6,resume_pasien_ranap.prosedur_sekunder7,"+
                    "resume_pasien_ranap.kd_prosedur_sekunder7,resume_pasien_ranap.alergi,resume_pasien_ranap.diet,resume_pasien_ranap.lab_belum,resume_pasien_ranap.edukasi,resume_pasien_ranap.cara_keluar,resume_pasien_ranap.ket_keluar,resume_pasien_ranap.keadaan,"+
...
//                        rs.getString("jalannya_penyakit"),
                        rs.getString("pemeriksaan_penunjang"),rs.getString("hasil_laborat"),rs.getString("tindakan_dan_operasi"),
                        ...
                        rs.getString("kd_diagnosa_sekunder3"),rs.getString("diagnosa_sekunder4"),rs.getString("kd_diagnosa_sekunder4"),rs.getString("diagnosa_sekunder5"),
                        rs.getString("kd_diagnosa_sekunder5"),rs.getString("diagnosa_sekunder6"),rs.getString("kd_diagnosa_sekunder6"),rs.getString("diagnosa_sekunder7"),
                        rs.getString("kd_diagnosa_sekunder7"),rs.getString("prosedur_utama"),rs.getString("kd_prosedur_utama"),rs.getString("prosedur_sekunder"),
                        ...
                        rs.getString("kd_prosedur_sekunder3"),rs.getString("prosedur_sekunder4"),rs.getString("kd_prosedur_sekunder4"),rs.getString("prosedur_sekunder5"),
                        rs.getString("kd_prosedur_sekunder5"),rs.getString("prosedur_sekunder6"),rs.getString("kd_prosedur_sekunder6"),rs.getString("prosedur_sekunder7"),
                        rs.getString("kd_prosedur_sekunder7"),rs.getString("alergi"),rs.getString("diet"),rs.getString("lab_belum"),rs.getString("edukasi"),
                        rs.getString("keadaan"),rs.getString("ket_keadaan"),rs.getString("cara_keluar"),rs.getString("ket_keluar"),rs.getString("dilanjutkan"),
...
//            JalannyaPenyakit.setText(tbObat.getValueAt(tbObat.getSelectedRow(),17).toString());  
            ...
            TindakanSelamaDiRS.setText(tbObat.getValueAt(tbObat.getSelectedRow(),19).toString());  
            ObatSelamaDiRS.setText(tbObat.getValueAt(tbObat.getSelectedRow(),20).toString());  
            DiagnosaUtama.setText(tbObat.getValueAt(tbObat.getSelectedRow(),21).toString());  
            KodeDiagnosaUtama.setText(tbObat.getValueAt(tbObat.getSelectedRow(),22).toString());  
            DiagnosaSekunder1.setText(tbObat.getValueAt(tbObat.getSelectedRow(),23).toString());  
            KodeDiagnosaSekunder1.setText(tbObat.getValueAt(tbObat.getSelectedRow(),24).toString());  
            DiagnosaSekunder2.setText(tbObat.getValueAt(tbObat.getSelectedRow(),25).toString());  
            KodeDiagnosaSekunder2.setText(tbObat.getValueAt(tbObat.getSelectedRow(),26).toString());  
            DiagnosaSekunder3.setText(tbObat.getValueAt(tbObat.getSelectedRow(),27).toString());  
            KodeDiagnosaSekunder3.setText(tbObat.getValueAt(tbObat.getSelectedRow(),28).toString());  
            DiagnosaSekunder4.setText(tbObat.getValueAt(tbObat.getSelectedRow(),29).toString());  
            KodeDiagnosaSekunder4.setText(tbObat.getValueAt(tbObat.getSelectedRow(),30).toString());  
            DiagnosaSekunder5.setText(tbObat.getValueAt(tbObat.getSelectedRow(),31).toString());  
            KodeDiagnosaSekunder5.setText(tbObat.getValueAt(tbObat.getSelectedRow(),32).toString());   
            DiagnosaSekunder6.setText(tbObat.getValueAt(tbObat.getSelectedRow(),33).toString());  
            KodeDiagnosaSekunder6.setText(tbObat.getValueAt(tbObat.getSelectedRow(),34).toString());   
            DiagnosaSekunder7.setText(tbObat.getValueAt(tbObat.getSelectedRow(),35).toString());  
            KodeDiagnosaSekunder7.setText(tbObat.getValueAt(tbObat.getSelectedRow(),36).toString());   
            ProsedurUtama.setText(tbObat.getValueAt(tbObat.getSelectedRow(),37).toString());  
            KodeProsedurUtama.setText(tbObat.getValueAt(tbObat.getSelectedRow(),38).toString());  
            ProsedurSekunder1.setText(tbObat.getValueAt(tbObat.getSelectedRow(),39).toString());  
            KodeProsedurSekunder1.setText(tbObat.getValueAt(tbObat.getSelectedRow(),40).toString());  
            ProsedurSekunder2.setText(tbObat.getValueAt(tbObat.getSelectedRow(),41).toString());  
            KodeProsedurSekunder2.setText(tbObat.getValueAt(tbObat.getSelectedRow(),42).toString());  
            ProsedurSekunder3.setText(tbObat.getValueAt(tbObat.getSelectedRow(),43).toString());  
            KodeProsedurSekunder3.setText(tbObat.getValueAt(tbObat.getSelectedRow(),44).toString());  
            ProsedurSekunder4.setText(tbObat.getValueAt(tbObat.getSelectedRow(),45).toString());  
            KodeProsedurSekunder4.setText(tbObat.getValueAt(tbObat.getSelectedRow(),46).toString());  
            ProsedurSekunder5.setText(tbObat.getValueAt(tbObat.getSelectedRow(),47).toString());  
            KodeProsedurSekunder5.setText(tbObat.getValueAt(tbObat.getSelectedRow(),48).toString());  
            ProsedurSekunder6.setText(tbObat.getValueAt(tbObat.getSelectedRow(),49).toString());  
            KodeProsedurSekunder6.setText(tbObat.getValueAt(tbObat.getSelectedRow(),50).toString());  
            ProsedurSekunder7.setText(tbObat.getValueAt(tbObat.getSelectedRow(),51).toString());  
            KodeProsedurSekunder7.setText(tbObat.getValueAt(tbObat.getSelectedRow(),52).toString());  
            Alergi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),53).toString());  
            Diet.setText(tbObat.getValueAt(tbObat.getSelectedRow(),54).toString());  
            LabBelum.setText(tbObat.getValueAt(tbObat.getSelectedRow(),55).toString());  
            Edukasi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),56).toString());  
            Keadaan.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),57).toString());  
            KetKeadaanPulang.setText(tbObat.getValueAt(tbObat.getSelectedRow(),58).toString()); 
            CaraKeluar.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),59).toString());  
            KetKeluar.setText(tbObat.getValueAt(tbObat.getSelectedRow(),60).toString());  
            DIlanjutkan.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),61).toString());  
            KetDilanjutkan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),62).toString());   
            Valid.SetTgl2(Kontrol,tbObat.getValueAt(tbObat.getSelectedRow(),63).toString());
            ObatPulang.setText(tbObat.getValueAt(tbObat.getSelectedRow(),64).toString());     
//            KdPj.setText(tbObat.getValueAt(tbObat.getSelectedRow(),65).toString());     
//            CaraBayar.setText(tbObat.getValueAt(tbObat.getSelectedRow(),66).toString());  
        }
    }
    ...
    private void ganti() {
        if(Sequel.mengedittf("resume_pasien_ranap","no_rawat=?","no_rawat=?,kd_dokter=?,diagnosa_awal=?,alasan=?,keluhan_utama=?,pemeriksaan_fisik=?,jalannya_penyakit=?,pemeriksaan_penunjang=?,"+
                ...
                "diagnosa_sekunder3=?,kd_diagnosa_sekunder3=?,diagnosa_sekunder4=?,kd_diagnosa_sekunder4=?,diagnosa_sekunder5=?,kd_diagnosa_sekunder5=?,diagnosa_sekunder6=?,kd_diagnosa_sekunder6=?,"+
                "diagnosa_sekunder7=?,kd_diagnosa_sekunder7=?,prosedur_utama=?,kd_prosedur_utama=?,prosedur_sekunder=?,kd_prosedur_sekunder=?,prosedur_sekunder2=?,kd_prosedur_sekunder2=?,"+
                "prosedur_sekunder3=?,kd_prosedur_sekunder3=?,prosedur_sekunder4=?,kd_prosedur_sekunder4=?,prosedur_sekunder5=?,kd_prosedur_sekunder5=?,prosedur_sekunder6=?,kd_prosedur_sekunder6=?,"+
                "prosedur_sekunder7=?,kd_prosedur_sekunder7=?,alergi=?,diet=?,lab_belum=?,edukasi=?,cara_keluar=?,ket_keluar=?,keadaan=?,ket_keadaan=?,dilanjutkan=?,ket_dilanjutkan=?,kontrol=?,obat_pulang=?"+
                "",56,new String[]{
                TNoRw.getText(),KodeDokter.getText(),DiagnosaAwal.getText(),Alasan.getText(),KeluhanUtama.getText(),PemeriksaanFisik.getText(),"-",
//                    JalannyaPenyakit.getText(),
                PemeriksaanRad.getText(),HasilLaborat.getText(),TindakanSelamaDiRS.getText(),ObatSelamaDiRS.getText(),DiagnosaUtama.getText(),KodeDiagnosaUtama.getText(),
                DiagnosaSekunder1.getText(),KodeDiagnosaSekunder1.getText(),DiagnosaSekunder2.getText(),KodeDiagnosaSekunder2.getText(),DiagnosaSekunder3.getText(),
                KodeDiagnosaSekunder3.getText(),DiagnosaSekunder4.getText(),KodeDiagnosaSekunder4.getText(),DiagnosaSekunder5.getText(),KodeDiagnosaSekunder5.getText(),
                ...
                ProsedurSekunder1.getText(),KodeProsedurSekunder1.getText(),ProsedurSekunder2.getText(),KodeProsedurSekunder2.getText(),ProsedurSekunder3.getText(), 
                KodeProsedurSekunder3.getText(),ProsedurSekunder4.getText(),KodeProsedurSekunder4.getText(),ProsedurSekunder5.getText(),KodeProsedurSekunder5.getText(),
                ProsedurSekunder6.getText(),KodeProsedurSekunder6.getText(),ProsedurSekunder7.getText(),KodeProsedurSekunder7.getText(),Alergi.getText(),Diet.getText(),
                LabBelum.getText(),Edukasi.getText(),CaraKeluar.getSelectedItem().toString(),KetKeluar.getText(),
                Keadaan.getSelectedItem().toString(),KetKeadaanPulang.getText(),DIlanjutkan.getSelectedItem().toString(),KetDilanjutkan.getText(),
                Valid.SetTgl(Kontrol.getSelectedItem()+"")+" "+Kontrol.getSelectedItem().toString().substring(11,19),ObatPulang.getText(),
...
//                   tbObat.setValueAt(JalannyaPenyakit.getText(),tbObat.getSelectedRow(),17);
                   ...
                   tbObat.setValueAt(TindakanSelamaDiRS.getText(),tbObat.getSelectedRow(),19);
                   tbObat.setValueAt(ObatSelamaDiRS.getText(),tbObat.getSelectedRow(),20);
                   tbObat.setValueAt(DiagnosaUtama.getText(),tbObat.getSelectedRow(),21);
                   tbObat.setValueAt(KodeDiagnosaUtama.getText(),tbObat.getSelectedRow(),22);
                   tbObat.setValueAt(DiagnosaSekunder1.getText(),tbObat.getSelectedRow(),23);
                   tbObat.setValueAt(KodeDiagnosaSekunder1.getText(),tbObat.getSelectedRow(),24);
                   tbObat.setValueAt(DiagnosaSekunder2.getText(),tbObat.getSelectedRow(),25);
                   tbObat.setValueAt(KodeDiagnosaSekunder2.getText(),tbObat.getSelectedRow(),26);
                   tbObat.setValueAt(DiagnosaSekunder3.getText(),tbObat.getSelectedRow(),27);
                   tbObat.setValueAt(KodeDiagnosaSekunder3.getText(),tbObat.getSelectedRow(),28);
                   tbObat.setValueAt(DiagnosaSekunder4.getText(),tbObat.getSelectedRow(),29);
                   tbObat.setValueAt(KodeDiagnosaSekunder4.getText(),tbObat.getSelectedRow(),30);
                   tbObat.setValueAt(DiagnosaSekunder5.getText(),tbObat.getSelectedRow(),31);
                   tbObat.setValueAt(KodeDiagnosaSekunder5.getText(),tbObat.getSelectedRow(),32);
                   tbObat.setValueAt(DiagnosaSekunder6.getText(),tbObat.getSelectedRow(),33);
                   tbObat.setValueAt(KodeDiagnosaSekunder6.getText(),tbObat.getSelectedRow(),34);
                   tbObat.setValueAt(DiagnosaSekunder7.getText(),tbObat.getSelectedRow(),35);
                   tbObat.setValueAt(KodeDiagnosaSekunder7.getText(),tbObat.getSelectedRow(),36);
                   tbObat.setValueAt(ProsedurUtama.getText(),tbObat.getSelectedRow(),37);
                   tbObat.setValueAt(KodeProsedurUtama.getText(),tbObat.getSelectedRow(),38);
                   tbObat.setValueAt(ProsedurSekunder1.getText(),tbObat.getSelectedRow(),39);
                   tbObat.setValueAt(KodeProsedurSekunder1.getText(),tbObat.getSelectedRow(),40);
                   tbObat.setValueAt(ProsedurSekunder2.getText(),tbObat.getSelectedRow(),41);
                   tbObat.setValueAt(KodeProsedurSekunder2.getText(),tbObat.getSelectedRow(),42);
                   tbObat.setValueAt(ProsedurSekunder3.getText(),tbObat.getSelectedRow(),43);
                   tbObat.setValueAt(KodeProsedurSekunder3.getText(),tbObat.getSelectedRow(),44);
                   tbObat.setValueAt(ProsedurSekunder4.getText(),tbObat.getSelectedRow(),45);
                   tbObat.setValueAt(KodeProsedurSekunder4.getText(),tbObat.getSelectedRow(),46);
                   tbObat.setValueAt(ProsedurSekunder5.getText(),tbObat.getSelectedRow(),47);
                   tbObat.setValueAt(KodeProsedurSekunder5.getText(),tbObat.getSelectedRow(),48);
                   tbObat.setValueAt(ProsedurSekunder6.getText(),tbObat.getSelectedRow(),49);
                   tbObat.setValueAt(KodeProsedurSekunder6.getText(),tbObat.getSelectedRow(),50);
                   tbObat.setValueAt(ProsedurSekunder7.getText(),tbObat.getSelectedRow(),51);
                   tbObat.setValueAt(KodeProsedurSekunder7.getText(),tbObat.getSelectedRow(),52);
                   tbObat.setValueAt(Alergi.getText(),tbObat.getSelectedRow(),53);
                   tbObat.setValueAt(Diet.getText(),tbObat.getSelectedRow(),54);
                   tbObat.setValueAt(LabBelum.getText(),tbObat.getSelectedRow(),55);
                   tbObat.setValueAt(Edukasi.getText(),tbObat.getSelectedRow(),56);
                   tbObat.setValueAt(Keadaan.getSelectedItem().toString(),tbObat.getSelectedRow(),57);
                   tbObat.setValueAt(KetKeadaanPulang.getText(),tbObat.getSelectedRow(),58);
                   tbObat.setValueAt(CaraKeluar.getSelectedItem().toString(),tbObat.getSelectedRow(),59);
                   tbObat.setValueAt(KetKeluar.getText(),tbObat.getSelectedRow(),60);
                   tbObat.setValueAt(DIlanjutkan.getSelectedItem().toString(),tbObat.getSelectedRow(),61);
                   tbObat.setValueAt(KetDilanjutkan.getText(),tbObat.getSelectedRow(),62);
                   tbObat.setValueAt(Valid.SetTgl(Kontrol.getSelectedItem()+"")+" "+Kontrol.getSelectedItem().toString().substring(11,19),tbObat.getSelectedRow(),63);
                   tbObat.setValueAt(ObatPulang.getText(),tbObat.getSelectedRow(),64);
//                   tbObat.setValueAt(KdPj.getText(),tbObat.getSelectedRow(),66);
//                   tbObat.setValueAt(CaraBayar.getText(),tbObat.getSelectedRow(),67);
                   emptTeks();
            }
    }
