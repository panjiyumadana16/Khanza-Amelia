...
public class DlgSetNota extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BesarBiayaVIP = new widget.TextBox();
        ...
        jLabel33.setText("Besar Biaya Kelas VIP :");
        jLabel33.setName("jLabel33"); // NOI18N
        FormInput2.add(jLabel33);
        jLabel33.setBounds(0, 70, 130, 23);
        ...
        BesarBiaya.setBounds(135, 40, 40, 23);

        jLabel34.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel34.setText(")");
        jLabel34.setName("jLabel34"); // NOI18N
        FormInput2.add(jLabel34);
        jLabel34.setBounds(550, 130, 35, 23);
        ...
        jLabel35.setBounds(180, 70, 20, 23);

        jLabel48.setText("Besar Biaya :");
        jLabel48.setName("jLabel48"); // NOI18N
        FormInput2.add(jLabel48);
        jLabel48.setBounds(0, 42, 130, 23);

        BesarBiayaVIP.setHighlighter(null);
        BesarBiayaVIP.setName("BesarBiayaVIP"); // NOI18N
        BesarBiayaVIP.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BesarBiayaVIPActionPerformed(evt);
            }
        });
        BesarBiayaVIP.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BesarBiayaVIPKeyPressed(evt);
            }
        });
        FormInput2.add(BesarBiayaVIP);
        BesarBiayaVIP.setBounds(135, 70, 40, 23);

        jLabel49.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel49.setText("%  ");
        jLabel49.setName("jLabel49"); // NOI18N
        FormInput2.add(jLabel49);
        jLabel49.setBounds(180, 40, 20, 23);
        ...
        jLabel50.setBounds(200, 40, 15, 20);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TabSetting.getSelectedIndex()==0){
            ...
            if(NamaService.getText().trim().equals("")){
                ...
                Valid.textKosong(BesarBiaya,"Besar Biaya");
            }else if(BesarBiayaVIP.getText().trim().equals("")){
                Valid.textKosong(BesarBiayaVIP,"Besar Biaya Kelas VIP");
		    ...
		    laborat="Yes";
                ...
                if(Sequel.menyimpantf("set_service_ranap","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Data",18,new String[]{
                    NamaService.getText(),BesarBiaya.getText(),BesarBiayaVIP.getText(),laborat,radiologi,operasi,obat,ranap_dokter,ranap_paramedis,
...
private void NotaRalanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NotaRalanKeyPressed
    ...
    private void BesarBiayaVIPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BesarBiayaVIPActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_BesarBiayaVIPActionPerformed

    private void BesarBiayaVIPKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BesarBiayaVIPKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BesarBiayaVIPKeyPressed
    ...
    */
    ...
    private widget.TextBox BesarBiayaVIP;
        ...
        try{    
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    tabMode2.addRow(new Object[]{" Besar Biaya Kelas VIP(%)",rs.getString(3)});
                    tabMode2.addRow(new Object[]{" Biaya Diambil Dari :",""});
                    tabMode2.addRow(new Object[]{"    Laborat",rs.getString(4)});
                    tabMode2.addRow(new Object[]{"    Radiologi",rs.getString(5)});
                    tabMode2.addRow(new Object[]{"    Operasi",rs.getString(6)});
                    tabMode2.addRow(new Object[]{"    Obat",rs.getString(7)});
                    tabMode2.addRow(new Object[]{"    Ranap Dokter",rs.getString(8)});
                    tabMode2.addRow(new Object[]{"    Ranap Paramedis",rs.getString(9)});
                    tabMode2.addRow(new Object[]{"    Ralan Dokter",rs.getString(10)});
                    tabMode2.addRow(new Object[]{"    Ralan Paramedis",rs.getString(11)});
                    tabMode2.addRow(new Object[]{"    Tambahan",rs.getString(12)});
                    tabMode2.addRow(new Object[]{"    Potongan",rs.getString(13)});
                    tabMode2.addRow(new Object[]{"    Kamar",rs.getString(14)});
                    tabMode2.addRow(new Object[]{"    Registrasi",rs.getString(15)});
                    tabMode2.addRow(new Object[]{"    Harian",rs.getString(16)});
                    tabMode2.addRow(new Object[]{"    Retur Obat",rs.getString(17)});
                    tabMode2.addRow(new Object[]{"    Resep Pulang",rs.getString(18)});
                }
            } catch (Exception e) {
                System.out.println(e);
            } finally{
    ...
    private void getData2() {
        ...
        if(row!= -1){
            ...
            BesarBiayaVIP.setText(tbAdmin2.getValueAt(2,1).toString());  
