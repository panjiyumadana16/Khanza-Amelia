    ...
    private void tampiltarif() {          
        try{
            ...
            if(cara_bayar_lab.equals("Yes")&&kelas_lab.equals("No")){
                ...
                if(kelas.trim().equals("Kelas VIP") && Penjab.getText().trim().equals("BPJ")){
                    pstindakan=koneksi.prepareStatement(
                        "select jns_perawatan_lab.kd_jenis_prw,jns_perawatan_lab.nm_perawatan,penjab.png_jawab "+
                        "from jns_perawatan_lab inner join penjab on penjab.kd_pj=jns_perawatan_lab.kd_pj where "+
                        " jns_perawatan_lab.kategori='PK' and jns_perawatan_lab.status='1' and (jns_perawatan_lab.kd_pj=? or jns_perawatan_lab.kd_pj='-') and (jns_perawatan_lab.kelas=?) and jns_perawatan_lab.kd_jenis_prw like ? or "+
                        " jns_perawatan_lab.kategori='PK' and jns_perawatan_lab.status='1' and (jns_perawatan_lab.kd_pj=? or jns_perawatan_lab.kd_pj='-') and (jns_perawatan_lab.kelas=?) and jns_perawatan_lab.nm_perawatan like ? "+
                        "order by jns_perawatan_lab.kd_jenis_prw");
                } else {
                    pstindakan=koneksi.prepareStatement(
                        "select jns_perawatan_lab.kd_jenis_prw,jns_perawatan_lab.nm_perawatan,penjab.png_jawab "+
...
//                    " jns_perawatan_lab.kategori='PK' and jns_perawatan_lab.status='1' and (penjab_lab.kd_pj=? or penjab_lab.kd_pj='-') and jns_perawatan_lab.kd_jenis_prw like ? or "+
//                    " jns_perawatan_lab.kategori='PK' and jns_perawatan_lab.status='1' and (penjab_lab.kd_pj=? or penjab_lab.kd_pj='-') and jns_perawatan_lab.nm_perawatan like ? "+
//                    "group by jns_perawatan_lab.kd_jenis_prw order by jns_perawatan_lab.kd_jenis_prw");
//            }else if(cara_bayar_lab.equals("No")&&kelas_lab.equals("No")){
//                pstindakan=koneksi.prepareStatement(
//                    "select jns_perawatan_lab.kd_jenis_prw,jns_perawatan_lab.nm_perawatan,ifnull(group_concat(penjab.png_jawab),'') as png_jawab "+
//                    "from jns_perawatan_lab left join penjab_lab on penjab_lab.kd_jenis_prw = jns_perawatan_lab.kd_jenis_prw " +
//                    "left join penjab on penjab.kd_pj = penjab_lab.kd_pj where "+
//                    " jns_perawatan_lab.kategori='PK' and jns_perawatan_lab.status='1' and jns_perawatan_lab.kd_jenis_prw like ? or "+
//                    " jns_perawatan_lab.kategori='PK' and jns_perawatan_lab.status='1' and jns_perawatan_lab.nm_perawatan like ?  "+
...
//                    "from jns_perawatan_lab left join penjab_lab on penjab_lab.kd_jenis_prw = jns_perawatan_lab.kd_jenis_prw " +
//                    "left join penjab on penjab.kd_pj = penjab_lab.kd_pj where "+
//                    " jns_perawatan_lab.kategori='PK' and jns_perawatan_lab.status='1' and (penjab_lab.kd_pj=? or penjab_lab.kd_pj='-') and (jns_perawatan_lab.kelas=? or jns_perawatan_lab.kelas='-') and jns_perawatan_lab.kd_jenis_prw like ? or "+
//                    " jns_perawatan_lab.kategori='PK' and jns_perawatan_lab.status='1' and (penjab_lab.kd_pj=? or penjab_lab.kd_pj='-') and (jns_perawatan_lab.kelas=? or jns_perawatan_lab.kelas='-') and jns_perawatan_lab.nm_perawatan like ? "+
//                    "group by jns_perawatan_lab.kd_jenis_prw order by jns_perawatan_lab.kd_jenis_prw");
//            }else if(cara_bayar_lab.equals("No")&&kelas_lab.equals("Yes")){
//                pstindakan=koneksi.prepareStatement(
//                    "select jns_perawatan_lab.kd_jenis_prw,jns_perawatan_lab.nm_perawatan,ifnull(group_concat(penjab.png_jawab),'') as png_jawab "+
