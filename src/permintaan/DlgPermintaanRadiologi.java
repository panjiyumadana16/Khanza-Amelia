...
//            pspemeriksaan=koneksi.prepareStatement(
//                    "select jns_perawatan_radiologi.kd_jenis_prw,jns_perawatan_radiologi.nm_perawatan,ifnull(group_concat(penjab_radiologi.kd_pj),'') as kd_pj,jns_perawatan_radiologi.kelas " +
...
//                    "left join penjab on penjab.kd_pj = penjab_radiologi.kd_pj where jns_perawatan_radiologi.status='1' group by jns_perawatan_radiologi.kd_jenis_prw order by jns_perawatan_radiologi.kd_jenis_prw");
            try {
...
//                        if((Arrays.asList(list.path("KodePJ").asText().split(",")).contains(Penjab.getText())||list.path("KodePJ").asText().equals("-"))&&(list.path("KodePeriksa").asText().toLowerCase().contains(TCariPeriksa.getText().toLowerCase())||list.path("NamaPemeriksaan").asText().toLowerCase().contains(TCariPeriksa.getText().toLowerCase()))){
                ...
                if(response.isArray()){
                    for(JsonNode list:response){
//                        if((list.path("Kelas").asText().equals(kelas.trim())||list.path("Kelas").asText().equals("-"))&&(Arrays.asList(list.path("KodePJ").asText().split(",")).contains(Penjab.getText())||list.path("KodePJ").asText().equals("-"))&&(list.path("KodePeriksa").asText().toLowerCase().contains(TCariPeriksa.getText().toLowerCase())||list.path("NamaPemeriksaan").asText().toLowerCase().contains(TCariPeriksa.getText().toLowerCase()))){
