...
public class DlgBookingOperasi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        tbObat.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_INTERVAL_SELECTION);
        ...
        BtnResumeRalan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnResumeRalan.setText("Resume Ralan");
        BtnResumeRalan.setFocusPainted(false);
        BtnResumeRalan.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnResumeRalan.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnResumeRalan.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnResumeRalan.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnResumeRalan.setName("BtnResumeRalan"); // NOI18N
        BtnResumeRalan.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnResumeRalan.setRoundRect(false);
        BtnResumeRalan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnResumeRalanActionPerformed(evt);
            }
        });
        FormMenu.add(BtnResumeRalan);

        BtnResumeRanap.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnResumeRanap.setText("Resume Ranap");
        BtnResumeRanap.setFocusPainted(false);
        BtnResumeRanap.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnResumeRanap.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnResumeRanap.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnResumeRanap.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnResumeRanap.setName("BtnResumeRanap"); // NOI18N
        BtnResumeRanap.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnResumeRanap.setRoundRect(false);
  ...
  isForm();                
    ...
    private void BtnResumeRalanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnResumeRalanActionPerformed
        if(TNoRw.getText().trim().equals("")){
            ...
            if(Sequel.cariIsi("select status_lanjut from reg_periksa where no_rawat=?",TNoRw.getText().trim()).equals("Ralan")){
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                ...
                JOptionPane.showMessageDialog(null,"Status pasien adalah rawat inap, silahkan gunakan Resume Ranap...!!!");
            }
        }
    ...
    private void BtnResumeRanapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnResumeRanapActionPerformed
        if(TNoRw.getText().trim().equals("")){
            ...
            if(Sequel.cariIsi("select status_lanjut from reg_periksa where no_rawat=?",TNoRw.getText().trim()).equals("Ranap")){
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                ...
                JOptionPane.showMessageDialog(null,"Status pasien adalah rawat jalan, silahkan gunakan Resume Ralan...!!!");
            }
        }
