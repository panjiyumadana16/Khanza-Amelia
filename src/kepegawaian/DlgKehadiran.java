...
public final class DlgKehadiran extends javax.swing.JDialog {
    ...
    private String hadir="0",siang="0",malam="0",tepatwaktu="0",toleransi="0",cuti="0",
    ...
    public DlgKehadiran(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
                "NIP","Nama","Departemen","Cuti","Kehadiran","Pagi","Siang","Malam","Tepat Waktu","Toleransi","Terlambat I","Terlambat II","Keterlambatan","Durasi","Wajib Masuk","% Hadir"
            }){
    ...
    private void tampil() {
        ...
        try{
            ...
            try {
                ...
                while(rs.next()){
                    hadir="0";pagi="0";siang="0";malam="0";tepatwaktu="0";toleransi="0";terlambat1="0";terlambat2="0";keterlambatan="0";durasi="0";cuti="0";
                    wajibmasuk=0;
...
//                    awal cuti
                    ps2=koneksi.prepareStatement(
                        "SELECT SUM(pengajuan_cuti.jumlah) FROM pegawai INNER JOIN pengajuan_cuti ON pegawai.nik=pengajuan_cuti.nik "+
                        "WHERE month(pengajuan_cuti.tanggal_awal)=? AND year(pengajuan_cuti.tanggal_awal)=? AND pegawai.id=?");
                    try {
                        ps2.setString(1,BlnCari.getSelectedItem().toString());
...
//                    end cuti
                    ...
                    tabMode.addRow(new Object[]{
                        rs.getString(1),rs.getString(2),rs.getString(3),cuti,hadir,pagi,siang,malam,tepatwaktu,toleransi,terlambat3,terlambat2,keterlambatan,durasi,wajibmasuk,Math.round((Double.parseDouble(hadir)/wajibmasuk)*100)+" %"
                    });
                 }
            } catch (Exception e) {
