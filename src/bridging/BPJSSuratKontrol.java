...
public class BPJSSuratKontrol extends javax.swing.JDialog {
    ...
    public BPJSSuratKontrol(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
                "No.Rawat","No.SEP","No.Kartu","No.RM","Nama Pasien","Tgl.Lahir","J.K.","No.Tlp","Diagnosa","Tgl.Surat",
    ...
    */
        ...
        try {
           if(R1.isSelected()==true){
                ps=koneksi.prepareStatement(
                    ...
                    "bridging_sep.jkel,bridging_sep.diagawal,bridging_sep.nmdiagnosaawal,bridging_surat_kontrol_bpjs.tgl_surat,bridging_surat_kontrol_bpjs.no_surat,"+
                    "bridging_surat_kontrol_bpjs.tgl_rencana,bridging_surat_kontrol_bpjs.kd_dokter_bpjs,bridging_surat_kontrol_bpjs.nm_dokter_bpjs,"+
                    "bridging_surat_kontrol_bpjs.kd_poli_bpjs,bridging_surat_kontrol_bpjs.nm_poli_bpjs,pasien.no_tlp "+
                    "from bridging_sep inner join bridging_surat_kontrol_bpjs "+
                    "on bridging_surat_kontrol_bpjs.no_sep=bridging_sep.no_sep "+
                    "inner join pasien on pasien.no_rkm_medis=bridging_sep.nomr "+
                ...
                try {
                    ...
                    while(rs.next()){
                        tabMode.addRow(new Object[]{
                            ...
                            rs.getString("tanggal_lahir"),rs.getString("jkel"),rs.getString("no_tlp"),rs.getString("nmdiagnosaawal"),rs.getString("tgl_surat"),rs.getString("no_surat"),
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            NoSurat.setText(tbObat.getValueAt(tbObat.getSelectedRow(),10).toString());
            ...
            KdPoli.setText(tbObat.getValueAt(tbObat.getSelectedRow(),14).toString());
            NmPoli.setText(tbObat.getValueAt(tbObat.getSelectedRow(),15).toString());
            Valid.SetTgl(TanggalSurat,tbObat.getValueAt(tbObat.getSelectedRow(),9).toString());
            Valid.SetTgl(TanggalKontrol,tbObat.getValueAt(tbObat.getSelectedRow(),11).toString());
        }
    }
