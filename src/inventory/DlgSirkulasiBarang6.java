...
public class DlgSirkulasiBarang6 extends javax.swing.JDialog {
    ...
    private double jumlahjual=0,jumlahbeli=0,jumlahpesan=0,jumlahpiutang=0,jumlahutd=0,jumlahkeluar=0,jumlahmutasikeluar=0,
                   ...
                   ttljstokawal=0, ttljpengadaan=0, ttljpenerimaan=0,ttljpenjualan=0,ttljkepasien=0,ttljpiutangjual=0,
                   ttljreturbeli=0, ttljreturjual=0, ttljreturpiutang=0, ttljpengambilanutd=0, ttljstokkeluarmedis=0,
                   ttljreseppulang=0, ttljmutasimasuk=0, ttljmutasikeluar=0, ttljhibah=0,ttljstokakhir=0;
        ...
        if(KdGudang.getText().equals("")){
            ...
            try{   
                        ...
                        try {
                            ...
                            while(rs2.next()){
                                ...
                                if((jumlahbeli>0)||(jumlahpesan>0)||(jumlahjual>0)||(jumlahpasin>0)||(jumlahpiutang>0)||(jumlahhibah>0)||(jumlahmutasimasuk>0)||(jumlahmutasikeluar>0)||
                                    ...
                                    ttljstokawal=ttljstokawal+stokawal;
                                    ttljpengadaan=ttljpengadaan+jumlahbeli;
                                    ttljpenerimaan=ttljpenerimaan+jumlahpesan;
                                    ttljpenjualan=ttljpenjualan+jumlahjual;
                                    ttljkepasien=ttljkepasien+jumlahpasin;
                                    ttljpiutangjual=ttljpiutangjual+jumlahpiutang;
                                    ttljreturbeli=ttljreturbeli+jumlahretbeli;
                                    ttljreturjual=ttljreturjual+jumlahretjual;
                                    ttljreturpiutang=ttljreturpiutang+jumlahretpiut;
                                    ttljpengambilanutd=ttljpengambilanutd+jumlahutd;
                                    ttljstokkeluarmedis=ttljstokkeluarmedis+jumlahkeluar;
                                    ttljreseppulang=ttljreseppulang+jumlahrespulang;
                                    ttljmutasimasuk=ttljmutasimasuk+jumlahmutasimasuk;
                                    ttljmutasikeluar=ttljmutasikeluar+jumlahmutasikeluar;
                                    ttljhibah=ttljhibah+jumlahhibah;
                                    ttljstokakhir=ttljstokakhir+stokakhir;
                                }
                ...
                tabMode.addRow(new Object[]{
                    "<>>","Total :","","","","",Valid.SetAngka(ttljstokawal),Valid.SetAngka(ttltotalstokawal),Valid.SetAngka(ttljpengadaan),Valid.SetAngka(ttltotalbeli),
                    Valid.SetAngka(ttljpenerimaan),Valid.SetAngka(ttltotalpesan),Valid.SetAngka(ttljpenjualan),Valid.SetAngka(ttltotaljual),
                    Valid.SetAngka(ttljkepasien),Valid.SetAngka(ttltotalpasin),Valid.SetAngka(ttljpiutangjual),Valid.SetAngka(ttltotalpiutang),
                    Valid.SetAngka(ttljreturbeli),Valid.SetAngka(ttltotalretbeli),Valid.SetAngka(ttljreturjual),Valid.SetAngka(ttltotalretjual),
                    Valid.SetAngka(ttljreturpiutang),Valid.SetAngka(ttltotalretpiut),Valid.SetAngka(ttljpengambilanutd),Valid.SetAngka(ttltotalutd),
                    Valid.SetAngka(ttljstokkeluarmedis),Valid.SetAngka(ttltotalkeluar),Valid.SetAngka(ttljreseppulang),Valid.SetAngka(ttltotalrespulang),
                    Valid.SetAngka(ttljmutasimasuk),Valid.SetAngka(ttltotalmutasimasuk),Valid.SetAngka(ttljmutasikeluar),Valid.SetAngka(ttltotalmutasikeluar),
                    Valid.SetAngka(ttljhibah),Valid.SetAngka(ttltotalhibah),Valid.SetAngka(ttljstokakhir),Valid.SetAngka(ttltotalstokakhir)
                }); 
            }catch(Exception e){
