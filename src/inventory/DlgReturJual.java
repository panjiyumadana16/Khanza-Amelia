...
public class DlgReturJual extends javax.swing.JDialog {
    ...
    private String aktifkanbatch="no",norawat="",kelas;
    ...
    private void initComponents() {
        ...
        panelisiBeli.add(jPanel3);
        jPanel3.setBounds(20, 70, 180, 30);
    ...
    */
    ...
    private void harga(){
        kelas=Sequel.cariIsi(
                    ...
                    "and stts_pulang='-' order by STR_TO_DATE(concat(kamar_inap.tgl_masuk,' ',jam_masuk),'%Y-%m-%d %H:%i:%s') desc limit 1",norawat);
        if(kelas.equals("BPJ")){
            Jenisjual.setSelectedItem("Utama/BPJS");
        }else if(kelas.equals("UMU")){
            Jenisjual.setSelectedItem("Kelas 1");
        }else{
            Jenisjual.setSelectedItem("Kelas 1");
        }
    }
