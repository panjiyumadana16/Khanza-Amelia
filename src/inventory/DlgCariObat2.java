...
public final class DlgCariObat2 extends javax.swing.JDialog {
    ...
    private WarnaTableObat warnaTblObat=new WarnaTableObat();
    private WarnaTableObat warnaTblObat2=new WarnaTableObat();
    private WarnaTableObat warnaTblObat3=new WarnaTableObat();
    ...
    public DlgCariObat2(java.awt.Frame parent, boolean modal) {
        ...
        warnaTblObat.kolom=1;
        tbObat.setDefaultRenderer(Object.class,warnaTblObat);
        ...
        warnaTblObat2.kolom=4;
        tbObatRacikan.setDefaultRenderer(Object.class,warnaTblObat2);
        ...
        warnaTblObat3.kolom=9;
        tbDetailObatRacikan.setDefaultRenderer(Object.class,warnaTblObat3);
    ...
    private void initComponents() {
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "29-04-2025" }));
        ...
        label12.setBounds(390, 10, 80, 23);
        ...
        Jeniskelas.setBounds(480, 10, 130, 23);
        ...
        ChkNoResep.setBounds(390, 40, 85, 23);
        ...
        TNoResep.setPreferredSize(new java.awt.Dimension(207, 23));
        FormInput.add(TNoResep);
        TNoResep.setBounds(480, 40, 130, 23);

        BtnTelaah.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/file-edit-32x32.png"))); // NOI18N
        BtnTelaah.setMnemonic('S');
        BtnTelaah.setText("Telaah");
        BtnTelaah.setToolTipText("");
        BtnTelaah.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        BtnTelaah.setName("BtnTelaah"); // NOI18N
        BtnTelaah.setPreferredSize(new java.awt.Dimension(85, 30));
        ...
        FormInput.add(BtnTelaah);
        BtnTelaah.setBounds(620, 10, 120, 50);
...
private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        if(TNoRw.getText().trim().equals("")){
            ...
            if(TNoResep.isVisible() && Sequel.cariIsi("select no_resep from telaah_farmasi where no_resep = ?", TNoResep.getText()).equals("")){
                JOptionPane.showMessageDialog(null,"Maaf, silahkan lakukan TELAAH terlebih dahulu resep/obat yang mau diberikan...!!!");
                TCari.requestFocus();
            } else {
...
private void ChkJlnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkJlnActionPerformed
    ...
    private void BtnTelaahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnTelaahActionPerformed
        if(TNoRw.getText().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Nomor Rawat tidak boleh kosong..!!");
        }else if(TNoResep.equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Nomor Resep tidak boleh kosong..!!");
        }else{
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            InventoryTelaahResep telaah=new InventoryTelaahResep(null,false);
            telaah.isCek();
            telaah.emptTeks();
            telaah.setNoRm(TNoResep.getText(),TNoRw.getText(),DTPTgl.getDate());
            telaah.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            telaah.setLocationRelativeTo(internalFrame1);
            telaah.setVisible(true);
            this.setCursor(Cursor.getDefaultCursor());
        }
    ...
    */
            ...
            if(kenaikan>0){
                if(aktifkanbatch.equals("yes")){
                    ...
                    psobat=koneksi.prepareStatement(
                        ...
                        " gudangbarang.stok>0 and gudangbarang.kd_bangsal=? and databarang.letak_barang like ? or "+
                    ...
                    try{
                        ...
                        psobat.setString(15,kdgudang.getText());
                        psobat.setString(16,"%"+TCari.getText().trim()+"%");
                    ...
                    psobat=koneksi.prepareStatement(
                        ...
                        " gudangbarang.no_batch='' and gudangbarang.no_faktur='' and gudangbarang.stok>0 and gudangbarang.kd_bangsal=? and databarang.status='1' and databarang.letak_barang like ? or "+
    ...
    public void setNoRm(String norwt,String norm,String pasien,Date tanggal,String jam,String menit,String detik,boolean status) {        
        ...
        boolean isKhusus = Sequel.cariIsiBoolean(
            "SELECT count(*)>0 FROM set_harga_obat_ranap WHERE kd_pj='" + KdPj.getText() + "'"
        );
        
        if (!isKhusus) {
            kenaikan=Sequel.cariIsiAngka("select (set_harga_obat_ranap.hargajual/100) from set_harga_obat_ranap where set_harga_obat_ranap.kd_pj='-' and set_harga_obat_ranap.kelas='"+kelas.getText()+"'");
        } else {
    ...
    public void tampilobat2(String no_resep) { 
        ...
        BtnTelaah.setVisible(true);
        String bpj_dasar = "h_beli";
