...
public class DlgDaftarPermintaanResep extends javax.swing.JDialog {
    ...
    public DlgDaftarPermintaanResep(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
                ...
                "Status","Kode Dokter","Poli/Unit","Kode Poli","Jenis Bayar","Jenis Resep","Tgl.Validasi","Jam Validasi",
                "Tgl.Penyerahan","Jam Penyerahan","Durasi Pelayanan"
            }){
        ...
        tbDetailReturJual.setModel(tabMode9);

        tbDetailReturJual.setPreferredScrollableViewportSize(new Dimension(500,500));
        tbDetailReturJual.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for (i = 0; i < 10; i++) {
            TableColumn column = tbDetailReturJual.getColumnModel().getColumn(i);
            if(i==0){
        ...
        tbDetailReturJual.setDefaultRenderer(Object.class, new WarnaTable());
    ...
    private void initComponents() {
        ...
        TabReturJual = new javax.swing.JTabbedPane();
        scrollPane9 = new widget.ScrollPane();
        tbDetailReturJual = new widget.Table();
        panelGlass10 = new widget.panelisi();
        jLabel18 = new widget.Label();
        LTotalReturJual = new widget.Label();
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "28-01-2025" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "28-01-2025" }));
        ...
        cmbJnsResep.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Semua", "Racikan", "Non Racikan" }));
        cmbJnsResep.setToolTipText("");
        cmbJnsResep.setName("cmbJnsResep"); // NOI18N
        cmbJnsResep.setPreferredSize(new java.awt.Dimension(130, 23));
        panelisi2.add(cmbJnsResep);
        ...
        TabReturJual.setBackground(new java.awt.Color(255, 255, 253));
        TabReturJual.setForeground(new java.awt.Color(50, 50, 50));
        TabReturJual.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        TabReturJual.setName("TabReturJual"); // NOI18N
        TabReturJual.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                TabReturJualMouseClicked(evt);
            }
        });

        scrollPane9.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)));
        scrollPane9.setName("scrollPane9"); // NOI18N
        scrollPane9.setOpaque(true);

        tbDetailReturJual.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {},
                {},
                {},
        ...
        tbDetailReturJual.setName("tbDetailReturJual"); // NOI18N
        scrollPane9.setViewportView(tbDetailReturJual);

        TabReturJual.addTab("Detail Retur Jual", scrollPane9);

        internalFrame4.add(TabReturJual, java.awt.BorderLayout.CENTER);
        ...
        LTotalReturJual.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        LTotalReturJual.setText("0");
        LTotalReturJual.setName("LTotalReturJual"); // NOI18N
        LTotalReturJual.setPreferredSize(new java.awt.Dimension(200, 23));
        panelGlass10.add(LTotalReturJual);

        internalFrame4.add(panelGlass10, java.awt.BorderLayout.PAGE_END);

        TabPilihRawat.addTab("Retur Jual", internalFrame4);
...
*/
    ...
    private void TabReturJualMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabReturJualMouseClicked
        pilihRetur();
    }//GEN-LAST:event_TabReturJualMouseClicked
    ...
    */
    ...
    private widget.Label LTotalReturJual;
    ...
    private javax.swing.JTabbedPane TabReturJual;
    ...
    private widget.Table tbDetailReturJual;
    ...
    public void tampil() {
        ...
        try{  
            ...
            if(DEPOAKTIFOBAT.equals("")){
                if(cmbJnsResep.getSelectedItem().equals("Non Racikan")){
                    ps=koneksi.prepareStatement("select resep_obat.no_resep,resep_obat.tgl_peresepan,resep_obat.jam_peresepan,"+
                            ...
                            " if(TIME_FORMAT( TIMEDIFF( CONCAT( tgl_penyerahan, ' ', jam_penyerahan ), CONCAT( tgl_perawatan, ' ', jam )), '%H:%i:%s' ) <= TIME_FORMAT('00:00:00','%H:%i:%s'),'',"+
                            " TIME_FORMAT( TIMEDIFF( CONCAT( tgl_penyerahan, ' ', jam_penyerahan ), CONCAT( tgl_perawatan, ' ', jam )), '%H:%i:%s' )) AS durasi_pelayanan,"+
                            " IF( resep_dokter_racikan.nama_racik <> '', 'Racikan', 'Non Racikan' ) AS jenis_resep from resep_obat "+
                            ...
                            " LEFT JOIN resep_dokter_racikan ON resep_obat.no_resep = resep_dokter_racikan.no_resep"+
                            " where resep_obat.tgl_peresepan<>'0000-00-00' and resep_obat.status='ralan' and resep_obat.tgl_peresepan between ? and ?"+
                            " and resep_dokter_racikan.nama_racik is null "+
                ...
                } else if(cmbJnsResep.getSelectedItem().equals("Racikan")){
                    ps=koneksi.prepareStatement("select resep_obat.no_resep,resep_obat.tgl_peresepan,resep_obat.jam_peresepan,"+
                            " resep_obat.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,resep_obat.kd_dokter,dokter.nm_dokter,"+
                            " if(resep_obat.tgl_perawatan='0000-00-00','Belum Terlayani','Sudah Terlayani') as status,poliklinik.nm_poli, "+
                            " reg_periksa.kd_poli,penjab.png_jawab,if(resep_obat.tgl_perawatan='0000-00-00','',resep_obat.tgl_perawatan) as tgl_perawatan,"+
                            ...
                            " LEFT JOIN resep_dokter_racikan ON resep_obat.no_resep = resep_dokter_racikan.no_resep"+
                            " where resep_obat.tgl_peresepan<>'0000-00-00' and resep_obat.status='ralan' and resep_obat.tgl_peresepan between ? and ?"+
                            " and resep_dokter_racikan.nama_racik <> '' "+
                            (semua?"":"and dokter.nm_dokter like ? and poliklinik.nm_poli like ? and "+
                            "(resep_obat.no_resep like ? or resep_obat.no_rawat like ? or "+
                            "pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or "+
                            "dokter.nm_dokter like ? or penjab.png_jawab like ?)")+
                ...
                if(cmbStatus.getSelectedItem().toString().equals("Semua")){
                    while(rs.next()){
                        tabMode.addRow(new String[]{
                            ...
                            rs.getString("kd_dokter"),rs.getString("nm_poli"),rs.getString("kd_poli"),rs.getString("png_jawab"),rs.getString("jenis_resep"),
                            rs.getString("tgl_perawatan"),rs.getString("jam"),rs.getString("tgl_penyerahan"),rs.getString("jam_penyerahan"),rs.getString("durasi_pelayanan")
                        });              
                    }  
                }else{
                    while(rs.next()){
        ...
        try{  
            ...
            if(DEPOAKTIFOBAT.equals("")){
                ps=koneksi.prepareStatement("select resep_obat.no_resep,resep_obat.tgl_peresepan,resep_obat.jam_peresepan,"+
                        ...
                        " bangsal.nm_bangsal,kamar.kd_bangsal,penjab.png_jawab,transfer_pasien_antar_ruang.hubungan_menyetujui,"+
                        ...
                        " left join transfer_pasien_antar_ruang ON reg_periksa.no_rawat=transfer_pasien_antar_ruang.no_rawat "+
            ...
            try{
                ...
                if(cmbStatus.getSelectedItem().toString().equals("Semua")){
                    while(rs.next()){
                            if(rs.getString("hubungan_menyetujui")==null || rs.getString("hubungan_menyetujui").equals("Tidak")){
                                tabMode3.addRow(new String[]{
                                    rs.getString("no_resep"),rs.getString("tgl_peresepan"),rs.getString("jam_peresepan"),rs.getString("no_rawat"),
                                    rs.getString("no_rkm_medis"),rs.getString("nm_pasien"),rs.getString("nm_dokter"),rs.getString("status"),
                                    rs.getString("kd_dokter"),"IGD",rs.getString("kd_bangsal"),rs.getString("png_jawab"),
...
//                            });  
        ...
        try{  
            ...
            if(DEPOAKTIFOBAT.equals("")){
                ps=koneksi.prepareStatement("select permintaan_resep_pulang.no_permintaan,permintaan_resep_pulang.tgl_permintaan,permintaan_resep_pulang.jam,"+
                        ...
                        " inner join kamar on kamar_inap.kd_kamar=kamar.kd_kamar "+
                        " inner join bangsal on kamar.kd_bangsal=bangsal.kd_bangsal "+
                        " where kamar_inap.stts_pulang='Kasir' or kamar_inap.stts_pulang='Rencana Pulang' or kamar_inap.stts_pulang='-' and permintaan_resep_pulang.tgl_permintaan between ? and ? "+
                        (semua?"":"and dokter.nm_dokter like ? and bangsal.nm_bangsal like ? and "+
                ...
                ps=koneksi.prepareStatement("select permintaan_resep_pulang.no_permintaan,permintaan_resep_pulang.tgl_permintaan,permintaan_resep_pulang.jam,"+
                        ...
                        " inner join bangsal on kamar.kd_bangsal=bangsal.kd_bangsal "+
                        " inner join set_depo_ranap on set_depo_ranap.kd_bangsal=bangsal.kd_bangsal "+
                        " where set_depo_ranap.kd_depo='"+DEPOAKTIFOBAT+"' and kamar_inap.stts_pulang='Kasir' or kamar_inap.stts_pulang='Rencana Pulang' or kamar_inap.stts_pulang='-' and permintaan_resep_pulang.tgl_permintaan between ? and ? "+
                        (semua?"":"and dokter.nm_dokter like ? and bangsal.nm_bangsal like ? and "+
                        "(permintaan_resep_pulang.no_permintaan like ? or permintaan_resep_pulang.no_rawat like ? or "+
                        "pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or dokter.nm_dokter like ? or penjab.png_jawab like ?)")+
                        " group by permintaan_resep_pulang.no_permintaan order by permintaan_resep_pulang.tgl_permintaan desc,permintaan_resep_pulang.jam desc");
    ...
    public void tampil9() {
        String tgl_retur=" returjual.tgl_retur between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' ";
        ...
        try{
            ps=koneksi.prepareStatement("select returjual.no_retur_jual,returjual.tgl_retur, "+
                    ...
                    " where "+tgl_retur+" and returjual.no_retur_jual like '%"+TCari.getText()+"%' or "+
                    tgl_retur+" and returjual.nip like '%"+TCari.getText()+"%' or "+
                    tgl_retur+" and petugas.nama like '%"+TCari.getText()+"%' or "+
                    tgl_retur+" and detreturjual.kode_brng like '%"+TCari.getText()+"%' or "+
                    tgl_retur+" and databarang.nama_brng like '%"+TCari.getText()+"%' or "+
                    tgl_retur+" and pasien.no_rkm_medis like '%"+TCari.getText()+"%' or "+
                    tgl_retur+" and pasien.nm_pasien like '%"+TCari.getText()+"%' or "+
                    tgl_retur+" and bangsal.nm_bangsal like '%"+TCari.getText()+"%' or "+
                    tgl_retur+" and detreturjual.nota_jual like '%"+TCari.getText()+"%' or "+
                    tgl_retur+" and kodesatuan.satuan like '%"+TCari.getText()+"%' or "+
                    tgl_retur+" and detreturjual.kode_sat like '%"+TCari.getText()+"%' "+
            ...
            try {
                ...
                i=0;
                while(rs.next()){
                    tabMode9.addRow(new Object[]{rs.getString(1),
                                   rs.getString(2),
                    ...
                    ps2=koneksi.prepareStatement("select detreturjual.nota_jual,detreturjual.kode_brng,databarang.nama_brng, "+
                            ...
                            " detreturjual.no_retur_jual='"+rs.getString(1)+"' order by detreturjual.kode_brng");
                    try {
                        subtotal=0;
                        no=1;
                        rs2=ps2.executeQuery();
                        ...
                        tabMode9.addRow(new Object[]{"","","Total Retur :","","","","","","",Valid.SetAngka(subtotal)});                
                    } catch (Exception e) {
                ...
                LCount.setText(""+i++);
                LTotalReturJual.setText(Valid.SetAngka(ttlretur)); 
            } catch (Exception e) {
