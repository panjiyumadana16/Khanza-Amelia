...
public final class DlgPeresepanDokter extends javax.swing.JDialog {
    ...
    public DlgPeresepanDokter(java.awt.Frame parent, boolean modal) {
        ...
        tbResep.setDefaultRenderer(Object.class,warnaTblObat);
        ...
        tbObatResepRacikan.setDefaultRenderer(Object.class,warnaTblObat2);
        ...
        tbDetailResepObatRacikan.setDefaultRenderer(Object.class,warnaTblObat3);
    ...
    private void initComponents() {
        ...
        tbResep.setGridColor(new java.awt.Color(204, 204, 204));
        tbResep.setName("tbResep"); // NOI18N
        tbResep.setSelectionBackground(new java.awt.Color(215, 215, 255));
        tbResep.setShowGrid(false);
        ...
        tbResep.getAccessibleContext().setAccessibleName("");
        tbResep.getAccessibleContext().setAccessibleDescription("Silahkan klik untuk memilih data yang mau diedit ataupun dihapus");
        ...
        tbObatResepRacikan.setSelectionBackground(new java.awt.Color(153, 204, 255));
        ...
        tbDetailResepObatRacikan.setSelectionBackground(new java.awt.Color(153, 204, 255));
    ...
    */
            ...
            if(kenaikan>0){
                if(aktifkanbatch.equals("yes")){
                    ...
                    psresepasuransi=koneksi.prepareStatement(
                        ...
                        "  AND (databarang.kode_brng LIKE ? " +
                        "       OR databarang.nama_brng LIKE ? " +
                        "       OR jenis.nama LIKE ? " +
                        "       OR databarang.letak_barang LIKE ?) " +
        ...
        ActionListener taskPerformer = new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(ChkJln.isSelected()==true){
                    ...
                    nilai_tgl = DTPBeri.getSelectedItem().toString();
                ...
                DTPBeri.setSelectedItem(nilai_tgl);
                cmbJam.setSelectedItem(jam);
                cmbMnt.setSelectedItem(menit);
                cmbDtk.setSelectedItem(detik);
            }
                    ...
                    if(STOKKOSONGRESEP.equals("no")){
                        while(rsobat.next()){
                            if(rsobat.getDouble("jml")>rsobat.getDouble("stok")){
                                JOptionPane.showMessageDialog(rootPane,"Maaf stok tidak mencukupi..!!");
                                tabModeResep.addRow(new Object[] {
                                   false,"HABIS",rsobat.getString("aturan_pakai"),rsobat.getString("kode_brng"),rsobat.getString("nama_brng"),
                                   rsobat.getString("kode_sat"),rsobat.getString("letak_barang"),Valid.roundUp(rsobat.getDouble("harga"),100),
                                   rsobat.getString("nama"),rsobat.getString("nama_industri"),rsobat.getDouble("h_beli"),rsobat.getDouble("stok")
                                });  
                            }else{
    ...
    private void SetHarga() {
        if(status.equals("ranap")){
            ...
            if (!isKhusus) {
                kenaikan=Sequel.cariIsiAngka("select (set_harga_obat_ranap.hargajual/100) from set_harga_obat_ranap where set_harga_obat_ranap.kd_pj='-' and set_harga_obat_ranap.kelas='"+kelas+"'");
            } else {
                kenaikan=Sequel.cariIsiAngka("select (set_harga_obat_ranap.hargajual/100) from set_harga_obat_ranap where set_harga_obat_ranap.kd_pj='"+KdPj.getText()+"' and set_harga_obat_ranap.kelas='"+kelas+"'");
            }
