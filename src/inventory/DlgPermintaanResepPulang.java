...
public class DlgPermintaanResepPulang extends javax.swing.JDialog {
    ...
    public DlgPermintaanResepPulang(java.awt.Frame parent, boolean modal) {
        ...
        warnaTblObat.kolom=0;
        tbDokter.setDefaultRenderer(Object.class,warnaTblObat);
    ...
    private void initComponents() {
        ...
        tbDokter.setSelectionBackground(new java.awt.Color(215, 215, 255));
        ...
        DTPBeri.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "29-04-2025" }));
            ...
            if(kenaikan>0){
                if(aktifkanbatch.equals("yes")){
                    pstampil=koneksi.prepareStatement(
                        ...
                        "  databarang.status='1' and gudangbarang.no_batch<>'' and gudangbarang.no_faktur<>'' and gudangbarang.kd_bangsal=? and databarang.letak_barang like ? or "+
