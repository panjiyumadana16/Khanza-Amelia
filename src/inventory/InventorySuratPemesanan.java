...
public class InventorySuratPemesanan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnPenerimaanObat = new widget.Button();
        BtnStokOpname = new widget.Button();
        ...
        BtnCari.setBounds(690, 60, 100, 30);
        ...
        BtnKeluar.setBounds(790, 60, 100, 30);
        ...
        BtnPenerimaanObat.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Edit.png"))); // NOI18N
        BtnPenerimaanObat.setMnemonic('3');
        BtnPenerimaanObat.setToolTipText("Penerimaan Obat & BHP");
        BtnPenerimaanObat.setName("BtnPenerimaanObat"); // NOI18N
        BtnPenerimaanObat.setPreferredSize(new java.awt.Dimension(28, 23));
        BtnPenerimaanObat.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnPenerimaanObatActionPerformed(evt);
            }
        });
        panelisi1.add(BtnPenerimaanObat);
        BtnPenerimaanObat.setBounds(555, 65, 28, 23);

        BtnStokOpname.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Drug-basket-32.png"))); // NOI18N
        BtnStokOpname.setMnemonic('3');
        BtnStokOpname.setToolTipText("Stok Opname Obat & BHP");
        BtnStokOpname.setName("BtnStokOpname"); // NOI18N
        BtnStokOpname.setPreferredSize(new java.awt.Dimension(28, 23));
        BtnStokOpname.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnStokOpnameActionPerformed(evt);
            }
        });
        panelisi1.add(BtnStokOpname);
        BtnStokOpname.setBounds(585, 65, 28, 23);
...
private void btnPetugasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPetugasActionPerformed
    ...
    private void BtnPrint5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint5ActionPerformed
        if(NoPemesanan.getText().trim().equals("")){
            ...
            for(i=0;i<row;i++){  
                if(Valid.SetAngka(tbDokter.getValueAt(i,0).toString())>0){
                    try {
                        String input = tabMode.getValueAt(i, 0).toString();  // Ganti dengan input yang diinginkan
                        int number = Integer.parseInt(input);  // Mengubah input String ke angka
                        String terbilang =  Terbilang.convert(number);
                    
                        Sequel.menyimpan("temporary","'"+i+"','"+
                        tabMode.getValueAt(i,0).toString()+"','"+ //temp1
                        tabMode.getValueAt(i,1).toString()+"','"+ //temp2
                        tabMode.getValueAt(i,2).toString()+"','"+ //temp3
                        tabMode.getValueAt(i,3).toString()+"','"+ //temp4
                        tabMode.getValueAt(i,4).toString()+"','"+ //temp5
                        Valid.SetAngka(Double.parseDouble(tabMode.getValueAt(i,5).toString()))+"','"+ //temp6
                        Valid.SetAngka(Double.parseDouble(tabMode.getValueAt(i,6).toString()))+"','"+ //temp7
                        tabMode.getValueAt(i,7).toString()+"','"+ //temp8
                        Valid.SetAngka(Double.parseDouble(tabMode.getValueAt(i,8).toString()))+"','"+ //temp9
                        Valid.SetAngka(Double.parseDouble(tabMode.getValueAt(i,9).toString()))+"','( "+ //temp10 
                        terbilang.toUpperCase()+ ") ','','','','','','','','','','','','','','','','','','','','','','','','','','"+akses.getalamatip()+"'","Transaksi Pemesanan");
    ...
    private void BtnPenerimaanObatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPenerimaanObatActionPerformed
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        
        DlgPemesanan penerimaanObat = new DlgPemesanan(null,false);
        penerimaanObat.setSize(internalFrame1.getWidth()-20, internalFrame1.getHeight()-20);
        penerimaanObat.setLocationRelativeTo(internalFrame1);
        penerimaanObat.setAlwaysOnTop(false);
        penerimaanObat.setVisible(true);
        this.setCursor(Cursor.getDefaultCursor());
    }//GEN-LAST:event_BtnPenerimaanObatActionPerformed

    private void BtnStokOpnameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnStokOpnameActionPerformed
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        
        DlgInputStok stokOpname = new DlgInputStok(null,false);
        stokOpname.setSize(internalFrame1.getWidth()-20, internalFrame1.getHeight()-20);
        stokOpname.setLocationRelativeTo(internalFrame1);
        stokOpname.setAlwaysOnTop(false);
