...
public final class DlgPembayaranRanap extends javax.swing.JDialog {
    ...
    public DlgPembayaranRanap(java.awt.Frame parent, boolean modal) {
        ...
        Object[] rowRwJlDr={"Tgl.Masuk","Tgl.Pulang","lama","No.Nota","No.RM","Nama Pasien","Kamar/Bangsal","Diagnosa Awal","Perujuk","DPJP Ranap","Registrasi","Tindakan","Obt+Emb+Tsl","Retur Obat","Resep Pulang",
            ...
            try {            
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                            ...
                            htmlContent.append(                             
                                "<tr class='isi'>"+
                                    "<td valign='middle' bgcolor='#FFFAFA' align='center' width='3%'>Tgl.Masuk</td>"+
                                    "<td valign='middle' bgcolor='#FFFAFA' align='center' width='3%'>Tgl.Pulang</td>"+
                                    "<td valign='middle' bgcolor='#FFFAFA' align='center' width='2%'>Lama</td>"+
                                    ...
                                    "<td valign='middle' bgcolor='#FFFAFA' align='center' width='7%'>Kamar/Bangsal</td>"+
                                    "<td valign='middle' bgcolor='#FFFAFA' align='center' width='7%'>Diagnosa Awal</td>"+
                    ...
                    case "Laporan 3 (CSV)":
                            htmlContent = new StringBuilder();
                            htmlContent.append(                             
                                "\"Tgl.Masuk\";\"Tgl.Pulang\";\"Lama\";\"No.Nota\";\"No.RM\";\"Nama Pasien\";\"Kamar/Bangsal\";\"Diagnosa Awal\";\"Perujuk\";\"Registrasi\";\"Tindakan\";\"Obt+Emb+Tsl\";\"Retur Obat\";\"Resep Pulang\";\"Laborat\";\"Radiologi\";\"Potongan\";\"Tambahan\";\"Kamar+Service\";\"Operasi\";\"Harian\";\"Total\"\n"
                            ); 
                            for(i=0;i<tabMode.getRowCount();i++){  
                                htmlContent.append(                             
                                    ...
                                    "\";\""+tabMode.getValueAt(i,10)+"\";\""+tabMode.getValueAt(i,11)+"\";\""+tabMode.getValueAt(i,12)+"\";\""+tabMode.getValueAt(i,13)+"\";\""+tabMode.getValueAt(i,14)+"\";\""+tabMode.getValueAt(i,15)+"\";\""+tabMode.getValueAt(i,16)+"\";\""+tabMode.getValueAt(i,17)+"\";\""+tabMode.getValueAt(i,18)+"\";\""+tabMode.getValueAt(i, 19)+
                                    "\";\""+tabMode.getValueAt(i, 20)+"\";\""+tabMode.getValueAt(i, 21)+"\"\n"
                                ); 
                            }            
                    ...
                    case "Laporan 4 (Jasper)":
                            ...
                            for(int r=0;r<tabMode.getRowCount();r++){  
                                    Sequel.menyimpan("temporary","'"+r+"','"+
                                                    ...
                                                    tabMode.getValueAt(r,21).toString().replaceAll("'","`")+"','','','','','','','','','','','','','','','"+akses.getalamatip()+"'","Rekap Nota Pembayaran");
                            }
        ...
        try{      
            if(nmbangsal.getText().equals("")&&NmCaraBayar.getText().equals("")){
                ps= koneksi.prepareStatement(
                    "select kamar_inap.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,kamar_inap.tgl_keluar,bangsal.nm_bangsal,kamar_inap.stts_pulang, kamar_inap.diagnosa_awal,"+
                    "kamar.kd_kamar,(select MIN(kamar_inap.tgl_masuk) from kamar_inap where kamar_inap.no_rawat=reg_periksa.no_rawat ) as tgl_masuk,"+
                    "(select sum(kamar_inap.lama) from kamar_inap where kamar_inap.no_rawat=reg_periksa.no_rawat ) as lama ,dokter.nm_dokter as dpjp_ranap "+
                    ...
                    "where kamar_inap.stts_pulang<>'Pindah Kamar' and kamar_inap.tgl_keluar >= ? and kamar_inap.tgl_keluar <= ? and "+
                ...
                ps= koneksi.prepareStatement(
                    ...
                    "left join dpjp_ranap on reg_periksa.no_rawat=dpjp_ranap.no_rawat "+
                    "left join dokter on dpjp_ranap.kd_dokter=dokter.kd_dokter "+
                    "where kamar_inap.stts_pulang<>'Pindah Kamar' and kamar_inap.tgl_keluar >= ? and kamar_inap.tgl_keluar <= ? and concat(kamar.kd_bangsal,bangsal.nm_bangsal) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and "+
                    "reg_periksa.no_rawat not in (select piutang_pasien.no_rawat from piutang_pasien where piutang_pasien.no_rawat=reg_periksa.no_rawat) "+
                    "group by kamar_inap.no_rawat order by kamar_inap.tgl_keluar,kamar_inap.jam_keluar");
            }
                    ...
                    if(!rs.getString("stts_pulang").equals("Pindah Kamar")){
                        ...
                        if(tampilkan.equals("Belum Bayar")&&Keterangan.equals("Belum Bayar")){
                            tabMode.addRow(new Object[]{
                                rs.getString("tgl_masuk"),rs.getString("tgl_keluar"),rs.getString("lama"),Sequel.cariIsi("select no_nota from nota_inap where no_rawat=?",rs.getString("no_rawat")),
                                rs.getString("no_rkm_medis"),rs.getString("nm_pasien"),rs.getString("kd_kamar")+" "+rs.getString("nm_bangsal"),rs.getString("diagnosa_awal"),
                                Sequel.cariIsi("select perujuk from rujuk_masuk where no_rawat=?",rs.getString("no_rawat")),rs.getString("dpjp_ranap"),Valid.SetAngka(Registrasi),
