...
//    public DlgCariCaraBayar2 penjab=new DlgCariCaraBayar2(null,false);
    private int i=0;
...
//                            if(kdcarabayar.equals("")){
//                                kdcarabayar = penjab.getTable().getValueAt(i,1).toString();
//                            } else {
//                                kdcarabayar = kdcarabayar +","+penjab.getTable().getValueAt(i,1).toString();
//                            }
//                        }
//                    } 
//                    kdpnj.setText(kdcarabayar);
//                }catch(Exception ex){
...
//                }
    ...
    private void initComponents() {
        ...
        FormInput.add(nmpnj);
        nmpnj.setBounds(503, 132, 180, 23);
...
//                String[] kd_penjab_radiologi = kdpnj.getText().split(",");
//                for(String kd_pj : kd_penjab_radiologi){
//                    if(kd_pj.equals("-")){
//                        Sequel.meghapus("penjab_radiologi","kd_jenis_prw", TKd.getText());
//                        Sequel.menyimpantf("penjab_radiologi","?,?","Kode Periksa dan Cara Bayar",2,new String[]{TKd.getText(),kd_pj});
//                        break;
//                    } else {
//                        Sequel.menyimpantf("penjab_radiologi","?,?","Kode Periksa dan Cara Bayar",2,new String[]{TKd.getText(),kd_pj});
//                    }
...
//                        "jns_perawatan_radiologi.tarif_perujuk,jns_perawatan_radiologi.tarif_tindakan_dokter,jns_perawatan_radiologi.tarif_tindakan_petugas,"+
//                        "jns_perawatan_radiologi.kso,jns_perawatan_radiologi.menejemen,jns_perawatan_radiologi.total_byr,"+
//                        "ifnull(group_concat(penjab_radiologi.kd_pj),'') as png_jawab,jns_perawatan_radiologi.kelas from jns_perawatan_radiologi "+
//                        "left join penjab_radiologi on penjab_radiologi.kd_jenis_prw = jns_perawatan_radiologi.kd_jenis_prw " +
...
//            kdpnj.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),11).toString());
