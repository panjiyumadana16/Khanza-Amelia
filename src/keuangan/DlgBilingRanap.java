...
public class DlgBilingRanap extends javax.swing.JDialog {
    ...
    private String biaya="",tambahan="",totals="",norawatbayi="",centangdokterranap="",kd_pj="",
            ...
            sqlpsralandokter="select jns_perawatan.nm_perawatan,rawat_jl_dr.biaya_rawat as total_byrdr,count(rawat_jl_dr.kd_jenis_prw) as jml, dokter.nm_dokter,rawat_jl_dr.tgl_perawatan, "+
                    ...
                    "rawat_jl_dr.no_rawat=? and kategori_perawatan.kd_kategori=? group by rawat_jl_dr.kd_jenis_prw,rawat_jl_dr.kd_dokter,rawat_jl_dr.tgl_perawatan",
            ...
            sqlpsranapdokter="select jns_perawatan_inap.nm_perawatan,rawat_inap_dr.biaya_rawat as total_byrdr,count(rawat_inap_dr.kd_jenis_prw) as jml, dokter.nm_dokter, rawat_inap_dr.tgl_perawatan, "+
                    ...
                    "inner join dokter on dokter.kd_dokter=rawat_inap_dr.kd_dokter where "+
                    "rawat_inap_dr.no_rawat=? and kategori_perawatan.kd_kategori=? group by rawat_inap_dr.kd_jenis_prw,rawat_inap_dr.kd_dokter,rawat_inap_dr.tgl_perawatan",
            ...
            sqlpsoperasi="select paket_operasi.nm_perawatan,(operasi.biayaoperator1+operasi.biayaoperator2+"+
                         ...
                         "operasi.bidan2,operasi.bidan3,operasi.perawat_luar,operasi.omloop,operasi.omloop2,operasi.omloop3,operasi.omloop4,operasi.omloop5,operasi.dokter_pjanak,operasi.dokter_umum from "+
                         "operasi inner join paket_operasi on operasi.kode_paket=paket_operasi.kode_paket where operasi.no_rawat=? and operasi.status like ?",
    ...
    private double ttl=0,y=0,subttl=0,lab,ttlobat,ttlretur,ppnobat,piutang=0,kekurangan=0,itembayar=0,itempiutang=0, 
            ...
            kamarserv=0,registrasiserv=0,harianserv=0,retur_Obatserv=0,resep_Pulangserv=0,ttlService=0,besarservice=0,
    ...
    private void initComponents() {
        ...
        jLabel19.setText("Biaya Registrasi :");
        jLabel19.setName("jLabel19"); // NOI18N
        internalFrame8.add(jLabel19);
        jLabel19.setBounds(0, 32, 100, 23);
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "26-12-2024 09:23:11" }));
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    */
    ...
    private void prosesCariObat(String norawat) {    
        ...
        if(subttl>1){
            ttlobat=subttl;
            tabModeRwJlDr.addRow(new Object[]{true,"","Total Obat & BHP i: "+Valid.SetAngka(subttl),"",null,null,null,null,"TtlObat"});
        }
        ...
        try {   
            ...
            try {
                ...
                if(rsservice.next()){
                    ...
                    besarservice = rsservice.getDouble("besar");
                    if(Sequel.cariIsiAngka("select count(kamar_inap.no_rawat) from kamar_inap "
                            + "inner join kamar on kamar.kd_kamar = kamar_inap.kd_kamar "
                            + "where kamar.kelas='Kelas VIP' and kamar_inap.no_rawat=?",TNoRw.getText()) > 0){
                        besarservice = rsservice.getDouble("besarvip");
                    }
                    
                    ttlService=Valid.roundUp((besarservice/100)*
                    ...
                    try {
                        ...
                        if(chkRalan.isSelected()==true){
                            ...
                            while(rsralandokter.next()){
                                ...
                                try {
                                    pstamkur.setString(1,TNoRw.getText());
                                    pstamkur.setString(2,rsralandokter.getString("nm_perawatan")+" ("+rsralandokter.getString("nm_dokter")+" | "+rsralandokter.getString("tgl_perawatan")+")");
                                ...
                                if(rinciandokterranap.equals("Yes")){
                                    ...
                                    tabModeRwJlDr.addRow(new Object[]{true,"",rsralandokter.getString("nm_perawatan")+" ("+rsralandokter.getString("nm_dokter")+" | "+rsralandokter.getString("tgl_perawatan")+")",":",
                        ...
                        if(chkRanap.isSelected()==true){
                            ...
                            while(rsranapdokter.next()){
                                ...
                                try {
                                    pstamkur.setString(1,TNoRw.getText());
                                    pstamkur.setString(2,rsranapdokter.getString("nm_perawatan")+" ("+rsranapdokter.getString("nm_dokter")+" | "+rsranapdokter.getString("tgl_perawatan")+")");
                                ...
                                if(rinciandokterranap.equals("Yes")){
                                    ...
                                    tabModeRwJlDr.addRow(new Object[]{true,"",rsranapdokter.getString("nm_perawatan")+" ("+rsranapdokter.getString("nm_dokter")+" | "+rsranapdokter.getString("tgl_perawatan")+")",":",
