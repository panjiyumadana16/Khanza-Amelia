...
//                String[] kd_penjab_lab = kdpnj.getText().split(",");
//                for(String kd_pj : kd_penjab_lab){
//                    if(kd_pj.equals("-")){
//                        Sequel.meghapus("penjab_lab","kd_jenis_prw", TKd.getText());
//                        Sequel.menyimpantf("penjab_lab","?,?","Kode Periksa dan Cara Bayar",2,new String[]{TKd.getText(),kd_pj});
//                        break;
//                    } else {
//                        Sequel.menyimpantf("penjab_lab","?,?","Kode Periksa dan Cara Bayar",2,new String[]{TKd.getText(),kd_pj});
//                    }
...
//                        "jns_perawatan_lab.tarif_perujuk,jns_perawatan_lab.tarif_tindakan_dokter,jns_perawatan_lab.tarif_tindakan_petugas,"+
//                        "jns_perawatan_lab.kso,jns_perawatan_lab.menejemen,jns_perawatan_lab.total_byr, "+
//                        "ifnull(group_concat(penjab_lab.kd_pj),'') as png_jawab,jns_perawatan_lab.kelas,jns_perawatan_lab.kategori "+
//                        "from jns_perawatan_lab left join penjab_lab on penjab_lab.kd_jenis_prw = jns_perawatan_lab.kd_jenis_prw " +
//                        "left join penjab on penjab.kd_pj = penjab_lab.kd_pj "+
//                        "where jns_perawatan_lab.status='1' and (jns_perawatan_lab.kd_jenis_prw like ? or "+
//                        "jns_perawatan_lab.nm_perawatan like ? or jns_perawatan_lab.kelas like ? or "+
//                        "penjab.png_jawab like ? or jns_perawatan_lab.kategori like ?) "+
...
//            kdpnj.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),11).toString());
    ...
    public void setCariPerawatan(String jns_perawatan) {
        TCari.setText(jns_perawatan);
