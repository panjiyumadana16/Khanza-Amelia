                 ...
                 while(rs.next()){
                    ...
                    if(chkRanap.isSelected()==true){
                         ...
                         psrawatinapdr=koneksi.prepareStatement(
                             "select pasien.nm_pasien,jns_perawatan_inap.nm_perawatan,sum(rawat_inap_dr.tarif_tindakandr) as tarif_tindakandr,"+
                             ...
                             "where kamar_inap.stts_pulang<>'-' and kamar_inap.stts_pulang<>'Pindah Kamar' and concat(kamar_inap.tgl_keluar,' ',kamar_inap.jam_keluar) between ? and ? and rawat_inap_dr.kd_dokter=? "+
                             "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and rawat_inap_dr.tarif_tindakandr>0  GROUP BY reg_periksa.no_rawat,jns_perawatan_inap.nm_perawatan order by pasien.nm_pasien ");
                         psrawatinapdrpr=koneksi.prepareStatement(
                             ...
                             "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj "+
                             "INNER JOIN kamar_inap ON kamar_inap.no_rawat=reg_periksa.no_rawat "+
                             "where kamar_inap.stts_pulang<>'-' and kamar_inap.stts_pulang<>'Pindah Kamar' and concat(rawat_inap_drpr.tgl_perawatan,' ',rawat_inap_drpr.jam_rawat) between ? and ? and rawat_inap_drpr.kd_dokter=? "+
                    ...
                    if(chkOperasi.isSelected()==true){
                         ...
                         psbiayaoperator2=koneksi.prepareStatement(
                             ...
                             "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? order by operasi.tgl_operasi,paket_operasi.nm_perawatan  ");
                 ...
                 while(rs.next()){
                    ...
                    if(chkRanap.isSelected()==true){
                         ...
                         psrawatinapdr=koneksi.prepareStatement(
                             ...
                             "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj "+
                             "INNER JOIN kamar_inap ON kamar_inap.no_rawat=reg_periksa.no_rawat "+
                             "where kamar_inap.stts_pulang<>'-' and kamar_inap.stts_pulang<>'Pindah Kamar' and reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien) and concat(rawat_inap_dr.tgl_perawatan,' ',rawat_inap_dr.jam_rawat) between ? and ? and rawat_inap_dr.kd_dokter=? "+
                             "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and rawat_inap_dr.tarif_tindakandr>0 order by rawat_inap_dr.tgl_perawatan,rawat_inap_dr.jam_rawat,jns_perawatan_inap.nm_perawatan  ");
                         psrawatinapdrpr=koneksi.prepareStatement(
                             "select pasien.nm_pasien,jns_perawatan_inap.nm_perawatan,rawat_inap_drpr.tarif_tindakandr,"+
                             "rawat_inap_drpr.tgl_perawatan,rawat_inap_drpr.jam_rawat,reg_periksa.kd_pj,rawat_inap_drpr.kd_jenis_prw, " +
                             ...
                             "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj "+
                             "INNER JOIN kamar_inap ON kamar_inap.no_rawat=reg_periksa.no_rawat "+
                             "where kamar_inap.stts_pulang<>'-' and kamar_inap.stts_pulang<>'Pindah Kamar' and reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien) and concat(rawat_inap_drpr.tgl_perawatan,' ',rawat_inap_drpr.jam_rawat) between ? and ? and rawat_inap_drpr.kd_dokter=? "+
                             "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and rawat_inap_drpr.tarif_tindakandr>0 order by rawat_inap_drpr.tgl_perawatan,rawat_inap_drpr.jam_rawat,jns_perawatan_inap.nm_perawatan  ");
                         try {                            
                             psrawatinapdr.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+"")+" "+CmbJam.getSelectedItem()+":"+CmbMenit.getSelectedItem()+":"+CmbDetik.getSelectedItem());
                             psrawatinapdr.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+"")+" "+CmbJam2.getSelectedItem()+":"+CmbMenit2.getSelectedItem()+":"+CmbDetik2.getSelectedItem());
