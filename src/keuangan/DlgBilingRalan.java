...
public class DlgBilingRalan extends javax.swing.JDialog {
    ...
    private double ttl=0,y=0,subttl=0,ralanparamedis=0,piutang=0,itembayar=0,itempiutang=0, 
                   ...
                   kekurangan=0,obatlangsung,subrck=0,ttlRacik=0;
    ...
    private String nota_jalan="",dokterrujukan="",polirujukan="",status="",biaya="",tambahan="",totals="",kdptg="",nmptg="",kd_pj="",notaralan="",centangdokterralan="",
            ...
            sqlpscaripoli2="select poliklinik.nm_poli from rujukan_internal_poli "+
                            ...
                            "where rujukan_internal_poli.no_rawat=?",
            sqlpscariralandokter="select jns_perawatan.nm_perawatan,rawat_jl_dr.biaya_rawat as total_byrdr, dokter.nm_dokter, "+
                    ...
                    "from rawat_jl_dr inner join jns_perawatan on jns_perawatan.kd_jenis_prw=rawat_jl_dr.kd_jenis_prw "+
                    "inner join dokter on dokter.kd_dokter=rawat_jl_dr.kd_dokter where "+
                    "rawat_jl_dr.no_rawat=? group by rawat_jl_dr.kd_jenis_prw,rawat_jl_dr.kd_dokter",
            ...
            sqlpscariobat="select databarang.nama_brng,jenis.nama,detail_pemberian_obat.biaya_obat,"+
                          ...
                          "detail_pemberian_obat.no_rawat=? and databarang.kode_brng NOT IN (SELECT detail_obat_racikan.kode_brng FROM detail_obat_racikan "+
                          "WHERE detail_obat_racikan.no_rawat=?) group by detail_pemberian_obat.kode_brng order by jenis.nama",
            sqlpsracikan="SELECT * FROM obat_racikan WHERE no_rawat=?",
            sqlpscariracikan="select databarang.nama_brng,jenis.nama,detail_pemberian_obat.biaya_obat,sum(detail_pemberian_obat.jml) as jml, "+
                            "sum(detail_pemberian_obat.embalase+detail_pemberian_obat.tuslah) as tambahan, "+
                            "(sum(detail_pemberian_obat.total)-sum(detail_pemberian_obat.embalase+detail_pemberian_obat.tuslah)) as total, "+
                            "sum((detail_pemberian_obat.h_beli*detail_pemberian_obat.jml)) as totalbeli from detail_pemberian_obat inner join databarang "+
                            "inner join jenis on detail_pemberian_obat.kode_brng=databarang.kode_brng and databarang.kdjns=jenis.kdjns where "+
                            "detail_pemberian_obat.no_rawat=? AND detail_pemberian_obat.tgl_perawatan=? AND detail_pemberian_obat.jam=? and databarang.kode_brng "+
                            "IN (SELECT detail_obat_racikan.kode_brng FROM detail_obat_racikan WHERE detail_obat_racikan.no_rawat=? AND detail_obat_racikan.tgl_perawatan=? "+
                            "AND detail_obat_racikan.jam=? AND detail_obat_racikan.no_racik=?) group by detail_pemberian_obat.kode_brng order by jenis.nama",
            ...
            sqlpsoperasi="select paket_operasi.nm_perawatan,(operasi.biayaoperator1+operasi.biayaoperator2+"+
                         ...
                         "operasi.biayasarpras,operasi.biaya_dokter_pjanak,operasi.biaya_dokter_umum,operasi.operator1,operasi.operator2,operasi.operator3,operasi.asisten_operator1,operasi.asisten_operator2,"+
                         "operasi.asisten_operator3,operasi.instrumen,operasi.dokter_anak,operasi.perawaat_resusitas,operasi.dokter_anestesi,operasi.asisten_anestesi,operasi.asisten_anestesi2,operasi.bidan,"+
                         "operasi.bidan2,operasi.bidan3,operasi.perawat_luar,operasi.omloop,operasi.omloop2,operasi.omloop3,operasi.omloop4,operasi.omloop5,operasi.dokter_pjanak,operasi.dokter_umum "+
    ...
    private PreparedStatement pscaripoli2,pscekbilling,pscarirm,pscaripasien,psreg,pscaripoli,pscarialamat,psrekening,
            psdokterralan,psdokterralan2,pscariralandokter,pscariralanperawat,pscariralandrpr,pscarilab,pscariobat,psracikan,psdetaillab,
            psobatlangsung,pstambahan,psbiling,pstemporary,pspotongan,psbilling,pscariradiologi,
            pstamkur,psnota,psoperasi,psobatoperasi,psakunbayar,psakunpiutang,pscariracikan;
    private ResultSet rscekbilling,rscarirm,rscaripasien,rsreg,rscaripoli,rscarialamat,rsrekening,rsobatoperasi,
            rsdokterralan,rsdokterralan2,rscariralandokter,rscariralanperawat,rscariralandrpr,rscarilab,rscariobat,rsracikan,rsdetaillab,
            rsobatlangsung,rstambahan,rspotongan,rsbilling,rscariradiologi,rstamkur,rsoperasi,rscariracikan,
    ...
    private void initComponents() {
        ...
        MnBiayaReg = new javax.swing.JMenuItem();
        ...
        WindowUbahRegistrasi = new javax.swing.JDialog();
        internalFrame8 = new widget.InternalFrame();
        BtnCloseIn6 = new widget.Button();
        BtnSimpan6 = new widget.Button();
        jLabel18 = new widget.Label();
        biayaRegistrasi = new widget.TextBox();
        ...
        MnBiayaReg.setBackground(new java.awt.Color(255, 255, 254));
        MnBiayaReg.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnBiayaReg.setForeground(new java.awt.Color(50, 50, 50));
        MnBiayaReg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnBiayaReg.setText("Ubah Biaya Registrasi");
        MnBiayaReg.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnBiayaReg.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnBiayaReg.setName("MnBiayaReg"); // NOI18N
        MnBiayaReg.setPreferredSize(new java.awt.Dimension(250, 25));
        MnBiayaReg.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnBiayaRegActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnBiayaReg);
        ...
        WindowUbahRegistrasi.setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        WindowUbahRegistrasi.setName("WindowUbahRegistrasi"); // NOI18N
        WindowUbahRegistrasi.setUndecorated(true);
        WindowUbahRegistrasi.setResizable(false);
        ...
        jLabel18.setText("Biaya Registrasi :");
        jLabel18.setName("jLabel18"); // NOI18N
        internalFrame8.add(jLabel18);
        jLabel18.setBounds(0, 32, 100, 23);

        biayaRegistrasi.setName("biayaRegistrasi"); // NOI18N
        internalFrame8.add(biayaRegistrasi);
        biayaRegistrasi.setBounds(110, 30, 290, 23);

        WindowUbahRegistrasi.getContentPane().add(internalFrame8, java.awt.BorderLayout.CENTER);
        internalFrame8.getAccessibleContext().setAccessibleName("::[ Ubah Biaya Registrasi ]::");
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-06-2025 10:48:02" }));
...
//                                   pstemporary.setString(8,"ini temporari");  
                                } catch (Exception e) {
...
private void MnPeriksaLabActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPeriksaLabActionPerformed
    ...
    private void BtnSimpan6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpan6ActionPerformed
        if(biayaRegistrasi.getText().trim().equals("")){
            Valid.textKosong(biayaRegistrasi,"Biaya Registrasi");
        }else{
            Sequel.mengedit("reg_periksa","no_rawat=?"," biaya_reg=?",2,new String[]{biayaRegistrasi.getText(),TNoRw.getText()});
            isRawat();
            WindowUbahRegistrasi.dispose();
        }
    }//GEN-LAST:event_BtnSimpan6ActionPerformed

    private void MnBiayaRegActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnBiayaRegActionPerformed
        if(Sequel.cariRegistrasi(TNoRw.getText())>0){
            JOptionPane.showMessageDialog(rootPane,"Data billing sudah terverifikasi ..!!");
        }else{
            biayaRegistrasi.setText(Sequel.cariIsi("select biaya_reg from reg_periksa where no_rawat='"+TNoRw.getText()+"'"));
            WindowUbahRegistrasi.setSize(630,80);
            WindowUbahRegistrasi.setLocationRelativeTo(internalFrame1);
            WindowUbahRegistrasi.setAlwaysOnTop(false);
            WindowUbahRegistrasi.setVisible(true);               
        }
    }//GEN-LAST:event_MnBiayaRegActionPerformed
    ...
    */
    ...
    private javax.swing.JMenuItem MnBiayaReg;
    ...
    private javax.swing.JDialog WindowUbahRegistrasi;
    private widget.TextBox biayaRegistrasi;
            ...
            try {
                ...
                while(rscariralandokter.next()){
                    ...
                    try {
                        ...
                        pstamkur.setString(2,rscariralandokter.getString("nm_perawatan")+" ("+rscariralandokter.getString("nm_dokter")+")");
                    ...
                    if(rinciandokterralan.equals("Yes")){
                        ...
                        tabModeRwJlDr.addRow(new Object[]{true,"",rscariralandokter.getString("nm_perawatan")+" ("+rscariralandokter.getString("nm_dokter")+")",":",
    ...
    private void prosesCariObat() { 
        ...
        try{      
            ...
            try {
                ...
                pscariobat.setString(2,TNoRw.getText());
            ...
            psracikan=koneksi.prepareStatement(sqlpsracikan);
            try {
                psracikan.setString(1,TNoRw.getText());
                rsracikan=psracikan.executeQuery();
                if(centangobatralan.equals("Yes")){
                    while(rsracikan.next()){
                        subrck=0;
                        tabModeRwJlDr.addRow(new Object[]{true,"",rsracikan.getString("nama_racik"),":",null,rsracikan.getDouble("jml_dr"),null,null,"ObatRck"});
//                      rincian racik
                        pscariracikan=koneksi.prepareStatement(sqlpscariracikan);
                        try {
                            pscariracikan.setString(1,rsracikan.getString("no_rawat"));
                            pscariracikan.setString(2,rsracikan.getString("tgl_perawatan"));
                            pscariracikan.setString(3,rsracikan.getString("jam"));
                            pscariracikan.setString(4,rsracikan.getString("no_rawat"));
                            pscariracikan.setString(5,rsracikan.getString("tgl_perawatan"));
                            pscariracikan.setString(6,rsracikan.getString("jam"));
                            pscariracikan.setString(7,rsracikan.getString("no_racik"));
                            rscariracikan=pscariracikan.executeQuery();
                            //embalase=0;
                            if(centangobatralan.equals("Yes")){
                                while(rscariracikan.next()){
                                    tabModeRwJlDr.addRow(new Object[]{false,"",rscariracikan.getString("nama_brng"),":",
                                       rscariracikan.getDouble("biaya_obat"),rscariracikan.getDouble("jml"),rscariracikan.getDouble("tambahan"),
                                       (rscariracikan.getDouble("total")+rscariracikan.getDouble("tambahan")),"Obat"});
                                    subrck=subrck+rscariracikan.getDouble("total")+rscariracikan.getDouble("tambahan");
                                    subttl=subttl+rscariracikan.getDouble("total")+rscariracikan.getDouble("tambahan");
                                }
                            }else{
                                while(rscariracikan.next()){
                                    subrck=subrck+rscariracikan.getDouble("total")+rscariracikan.getDouble("tambahan");
                            ...
                            if(rscariracikan!=null){
                                rscariracikan.close();
                            }
                            if(pscariracikan!=null){
                                pscariracikan.close();
                            }
                        }
//                    end rincian racik   
                        if(subrck>0){
                            tabModeRwJlDr.addRow(new Object[]{true,"","Total "+rsracikan.getString("nama_racik")+" : "+Valid.SetAngka3(subrck),"",null,null,null,null,"TtlRacikan"});
                        }
                    }
                }else{
                        while(rsracikan.next()){
...
//                      rincian racik
                        ...
                        try {
                            ...
                            if(centangobatralan.equals("Yes")){
                                ...
                                if(subrck>0){
                                    tabModeRwJlDr.addRow(new Object[]{true,"","Total "+rsracikan.getString("nama_racik")+" : ","",null,null,null,null,"TtlRacikan"});
                                }
                            }else{
                                subrck=0;
                                while(rscariracikan.next()){
...
//                    end rincian racik
        ...
        if(subttl>0){ 
            if(tampilkan_ppnobat_ralan.equals("Yes")){
                ...
                tabModeRwJlDr.addRow(new Object[]{true,"","Total Obat : "+Valid.SetAngka3(subttl+ppnobat),"",null,null,null,null,"TtlObat"});            
            }else{           
                tabModeRwJlDr.addRow(new Object[]{true,"","Total Obat : "+Valid.SetAngka3(subttl),"",null,null,null,null,"TtlObat"});            
            }                
        }
    }
    ...
    private void isHitung() {   
        ...
        ttlPotongan=0;ttlRegistrasi=0;ttlRalan_Dokter_Param=0;ttlOperasi=0;ttlRacik=0;
                ...
                if(rincianoperasi.equals("Yes")){
                    while(rsoperasi.next()){
                        ...
                        if(rsoperasi.getDouble("biayaoperator1")>0){
                           tabModeRwJlDr.addRow(new Object[]{true,"                           ","  Biaya Operator 1"+'('+Sequel.cariIsi("select dokter.nm_dokter from dokter where dokter.kd_dokter=?",rsoperasi.getString("operator1"))+')',":",rsoperasi.getDouble("biayaoperator1"),1,0,rsoperasi.getDouble("biayaoperator1"),"Operasi"}); 
                        }

                        if(rsoperasi.getDouble("biayaoperator2")>0){
                           tabModeRwJlDr.addRow(new Object[]{true,"                           ","  Biaya Operator 2"+'('+Sequel.cariIsi("select dokter.nm_dokter from dokter where dokter.kd_dokter=?",rsoperasi.getString("operator2"))+')',":",rsoperasi.getDouble("biayaoperator2"),1,0,rsoperasi.getDouble("biayaoperator2"),"Operasi"}); 
                        }

                        if(rsoperasi.getDouble("biayaoperator3")>0){
                           tabModeRwJlDr.addRow(new Object[]{true,"                           ","  Biaya Operator 3"+'('+Sequel.cariIsi("select dokter.nm_dokter from dokter where dokter.kd_dokter=?",rsoperasi.getString("operator3"))+')',":",rsoperasi.getDouble("biayaoperator3"),1,0,rsoperasi.getDouble("biayaoperator3"),"Operasi"}); 
                        }

                        if(rsoperasi.getDouble("biayaasisten_operator1")>0){
                           tabModeRwJlDr.addRow(new Object[]{true,"                           ","  Biaya Asisten Operator 1"+'('+Sequel.cariIsi("select petugas.nama from petugas where petugas.nip=?",rsoperasi.getString("asisten_operator1"))+')',":",rsoperasi.getDouble("biayaasisten_operator1"),1,0,rsoperasi.getDouble("biayaasisten_operator1"),"Operasi"}); 
                        }

                        if(rsoperasi.getDouble("biayaasisten_operator2")>0){
                           tabModeRwJlDr.addRow(new Object[]{true,"                           ","  Biaya Asisten Operator 2"+'('+Sequel.cariIsi("select petugas.nama from petugas where petugas.nip=?",rsoperasi.getString("asisten_operator2"))+')',":",rsoperasi.getDouble("biayaasisten_operator2"),1,0,rsoperasi.getDouble("biayaasisten_operator2"),"Operasi"}); 
                        }
                        
                        if(rsoperasi.getDouble("biayaasisten_operator3")>0){
                           tabModeRwJlDr.addRow(new Object[]{true,"                           ","  Biaya Asisten Operator 3"+'('+Sequel.cariIsi("select petugas.nama from petugas where petugas.nip=?",rsoperasi.getString("asisten_operator3"))+')',":",rsoperasi.getDouble("biayaasisten_operator3"),1,0,rsoperasi.getDouble("biayaasisten_operator3"),"Operasi"}); 
                        }

                        if(rsoperasi.getDouble("biayainstrumen")>0){
                           tabModeRwJlDr.addRow(new Object[]{true,"                           ","  Biaya Instrumen"+'('+Sequel.cariIsi("select petugas.nama from petugas where petugas.nip=?",rsoperasi.getString("instrumen"))+')',":",rsoperasi.getDouble("biayainstrumen"),1,0,rsoperasi.getDouble("biayainstrumen"),"Operasi"}); 
                        }

                        if(rsoperasi.getDouble("biayadokter_anak")>0){
                           tabModeRwJlDr.addRow(new Object[]{true,"                           ","  Biaya Dokter Anak"+'('+Sequel.cariIsi("select dokter.nm_dokter from dokter where dokter.kd_dokter=?",rsoperasi.getString("dokter_anak"))+')',":",rsoperasi.getDouble("biayadokter_anak"),1,0,rsoperasi.getDouble("biayadokter_anak"),"Operasi"}); 
                        }

                        if(rsoperasi.getDouble("biayaperawaat_resusitas")>0){
                           tabModeRwJlDr.addRow(new Object[]{true,"                           ","  Biaya Perawat Resusitas"+'('+Sequel.cariIsi("select petugas.nama from petugas where petugas.nip=?",rsoperasi.getString("perawaat_resusitas"))+')',":",rsoperasi.getDouble("biayaperawaat_resusitas"),1,0,rsoperasi.getDouble("biayaperawaat_resusitas"),"Operasi"}); 
                        }
                        
                        if(rsoperasi.getDouble("biayadokter_anestesi")>0){
                           tabModeRwJlDr.addRow(new Object[]{true,"                           ","  Biaya Dokter Anastesi"+'('+Sequel.cariIsi("select dokter.nm_dokter from dokter where dokter.kd_dokter=?",rsoperasi.getString("dokter_anestesi"))+')',":",rsoperasi.getDouble("biayadokter_anestesi"),1,0,rsoperasi.getDouble("biayadokter_anestesi"),"Operasi"}); 
                        }
                        
                        if(rsoperasi.getDouble("biayaasisten_anestesi")>0){
                           tabModeRwJlDr.addRow(new Object[]{true,"                           ","  Biaya Asisten Anastesi 1"+'('+Sequel.cariIsi("select petugas.nama from petugas where petugas.nip=?",rsoperasi.getString("asisten_anestesi"))+')',":",rsoperasi.getDouble("biayaasisten_anestesi"),1,0,rsoperasi.getDouble("biayaasisten_anestesi"),"Operasi"}); 
                        }
                        
                        if(rsoperasi.getDouble("biayaasisten_anestesi2")>0){
                           tabModeRwJlDr.addRow(new Object[]{true,"                           ","  Biaya Asisten Anastesi 2"+'('+Sequel.cariIsi("select petugas.nama from petugas where petugas.nip=?",rsoperasi.getString("asisten_anestesi2"))+')',":",rsoperasi.getDouble("biayaasisten_anestesi2"),1,0,rsoperasi.getDouble("biayaasisten_anestesi2"),"Operasi"}); 
                        }
                        
                        if(rsoperasi.getDouble("biayabidan")>0){
                           tabModeRwJlDr.addRow(new Object[]{true,"                           ","  Biaya Bidan 1"+'('+Sequel.cariIsi("select petugas.nama from petugas where petugas.nip=?",rsoperasi.getString("bidan"))+')',":",rsoperasi.getDouble("biayabidan"),1,0,rsoperasi.getDouble("biayabidan"),"Operasi"}); 
                        }
                        
                        if(rsoperasi.getDouble("biayabidan2")>0){
                           tabModeRwJlDr.addRow(new Object[]{true,"                           ","  Biaya Bidan 2"+'('+Sequel.cariIsi("select petugas.nama from petugas where petugas.nip=?",rsoperasi.getString("bidan2"))+')',":",rsoperasi.getDouble("biayabidan2"),1,0,rsoperasi.getDouble("biayabidan2"),"Operasi"}); 
                        }
                        
                        if(rsoperasi.getDouble("biayabidan3")>0){
                           tabModeRwJlDr.addRow(new Object[]{true,"                           ","  Biaya Bidan 3"+'('+Sequel.cariIsi("select petugas.nama from petugas where petugas.nip=?",rsoperasi.getString("bidan3"))+')',":",rsoperasi.getDouble("biayabidan3"),1,0,rsoperasi.getDouble("biayabidan3"),"Operasi"}); 
                        }
                        
                        if(rsoperasi.getDouble("biayaperawat_luar")>0){
                           tabModeRwJlDr.addRow(new Object[]{true,"                           ","  Biaya Perawat Luar"+'('+Sequel.cariIsi("select petugas.nama from petugas where petugas.nip=?",rsoperasi.getString("perawat_luar"))+')',":",rsoperasi.getDouble("biayaperawat_luar"),1,0,rsoperasi.getDouble("biayaperawat_luar"),"Operasi"}); 
                        }
                        ...
                        if(rsoperasi.getDouble("biaya_omloop")>0){
                           tabModeRwJlDr.addRow(new Object[]{true,"                           ","  Biaya Onloop 1"+'('+Sequel.cariIsi("select petugas.nama from petugas where petugas.nip=?",rsoperasi.getString("omloop"))+')',":",rsoperasi.getDouble("biaya_omloop"),1,0,rsoperasi.getDouble("biaya_omloop"),"Operasi"}); 
                        }
                        
                        if(rsoperasi.getDouble("biaya_omloop2")>0){
                           tabModeRwJlDr.addRow(new Object[]{true,"                           ","  Biaya Onloop 2"+'('+Sequel.cariIsi("select petugas.nama from petugas where petugas.nip=?",rsoperasi.getString("omloop2"))+')',":",rsoperasi.getDouble("biaya_omloop2"),1,0,rsoperasi.getDouble("biaya_omloop2"),"Operasi"}); 
                        }
                        
                        if(rsoperasi.getDouble("biaya_omloop3")>0){
                           tabModeRwJlDr.addRow(new Object[]{true,"                           ","  Biaya Onloop 3"+'('+Sequel.cariIsi("select petugas.nama from petugas where petugas.nip=?",rsoperasi.getString("omloop3"))+')',":",rsoperasi.getDouble("biaya_omloop3"),1,0,rsoperasi.getDouble("biaya_omloop3"),"Operasi"}); 
                        }
                        
                        if(rsoperasi.getDouble("biaya_omloop4")>0){
                           tabModeRwJlDr.addRow(new Object[]{true,"                           ","  Biaya Onloop 4"+'('+Sequel.cariIsi("select petugas.nama from petugas where petugas.nip=?",rsoperasi.getString("omloop4"))+')',":",rsoperasi.getDouble("biaya_omloop4"),1,0,rsoperasi.getDouble("biaya_omloop4"),"Operasi"}); 
                        }
                        
                        if(rsoperasi.getDouble("biaya_omloop5")>0){
                           tabModeRwJlDr.addRow(new Object[]{true,"                           ","  Biaya Onloop 5"+'('+Sequel.cariIsi("select petugas.nama from petugas where petugas.nip=?",rsoperasi.getString("omloop5"))+')',":",rsoperasi.getDouble("biaya_omloop5"),1,0,rsoperasi.getDouble("biaya_omloop5"),"Operasi"}); 
                        }
                        ...
                        if(rsoperasi.getDouble("biaya_dokter_pjanak")>0){
                           tabModeRwJlDr.addRow(new Object[]{true,"                           ","  Biaya Dokter PJ Anak"+'('+Sequel.cariIsi("select dokter.nm_dokter from dokter where dokter.kd_dokter=?",rsoperasi.getString("dokter_pjanak"))+')',":",rsoperasi.getDouble("biaya_dokter_pjanak"),1,0,rsoperasi.getDouble("biaya_dokter_pjanak"),"Operasi"}); 
                        }
                        
                        if(rsoperasi.getDouble("biaya_dokter_umum")>0){
                           tabModeRwJlDr.addRow(new Object[]{true,"                           ","  Biaya Dokter Umum"+'('+Sequel.cariIsi("select dokter.nm_dokter from dokter where dokter.kd_dokter=?",rsoperasi.getString("dokter_umum"))+')',":",rsoperasi.getDouble("biaya_dokter_umum"),1,0,rsoperasi.getDouble("biaya_dokter_umum"),"Operasi"}); 
                        }
